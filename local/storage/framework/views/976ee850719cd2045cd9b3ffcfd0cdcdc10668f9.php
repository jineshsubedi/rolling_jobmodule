 ...
 <div class="row">
    <div class="col-xs-12">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                <form action="<?php echo e(url('/branchadmin/attendance-handler/save')); ?>" method="post">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-12 form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label"> End Day</label>
                            <div class="col-md-9">
  ...
  <script>
    ...
    $.ajax({
      type: 'GET',
      url: '<?php echo e(url("/branchadmin/attendance-handler/getYear")); ?>',
    ...
    $('#year').on('change', function(){
        ...
        if (year != '') {
            ...
            $.ajax({
              type: 'GET',
              url: '<?php echo e(url("/branchadmin/attendance-handler/getMonth")); ?>',
    ...
    $('#month').on('change', function(){
        ...
        if (month != '') {
            $.ajax({
              type: 'GET',
              url: '<?php echo e(url("/branchadmin/attendance-handler/getDays")); ?>',
