        ...
        <div class="box">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(route('branchadmin.job_level.update', $data->id)); ?>">
                      ...
                      <div class="col-md-10">
                        <div class="form-group<?php echo e($errors->has('sortOrder') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control" name="sortOrder" value="<?php echo e($data->sortOrder); ?>">
