...
<body class="hold-transition skin-blue sidebar-mini ">
              ...
              <ul class="dropdown-menu">
                ...
                <li>
                  ...
                  <ul class="menu">
                    ...
                    <li>
                      <a href="<?php echo e(url('branchadmin/travel/request/waitingApproval')); ?>">
                    ...
                    <li>
                      <a href="<?php echo e(url('branchadmin/travel_expense')); ?>">
            ...
            <div class="box box-success">
              <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool greenclr" id="addDocumentBtn">Add Document</button>
              ...
              <div class="box-body" style="height: 95px; overflow-y: auto;">
                <ul class="nav nav-stacked">
                  ...
                  <li><a href="<?php echo e(url('/branchadmin/documents/view/'.$doc->id)); ?>" target="_blank"><?php echo e($doc->title); ?></a>
                  </li>
                  <?php endforeach; ?>
                </ul>
              </div>
    ...
    <div class="modal fade" id="modal-sub-rating">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form id="kpi-rating-form" method="POST" action="<?php echo e(url('/branchadmin/subrating')); ?>" class="form-horizontal"
  ...
  <div class="modal fade" id="modal-kpi-rating">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form id="kpi-rating-form" method="POST" action="<?php echo e(url('/branchadmin/kpirating')); ?>" class="form-horizontal"
          enctype="multipart/form-data">
          <div class="modal-body">
            <?php echo csrf_field(); ?>
  ...
  <div class="modal fade" id="modal-other-rating">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="kpi-rating-form" method="POST" action="<?php echo e(url('/branchadmin/otherrating')); ?>" class="form-horizontal"
          enctype="multipart/form-data">
          <div class="modal-body">
            <?php echo csrf_field(); ?>
  ...
  <div class="modal fade" id="modal-voting">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form method="POST" action="<?php echo e(url('/branchadmin/vote/save')); ?>" class="form-horizontal"
          enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
  ...
  <script type="text/javascript">
      ...
      if(sup_check == '0')
        ...
        } else if(ocheck > 0 & other_rater > 0 & checko == 0)
        {
          ...
          var token = $('input[name=\'_token\']').val();
           $.ajax({
                type: 'POST',
                url: '<?php echo e(url("/branchadmin/staff-survey/get-popup")); ?>',
    ...
    $('#kpi-staff').on('change', function(){
      ...
      $.ajax({
          type: 'POST',
          url: '<?php echo e(url("/branchadmin/clientdetail/get-kpi")); ?>',
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title" id="rating-title">Add Company Document</h4>
        </div>
        <div class="modal-body">
          <form class="form-horizontal" enctype="multipart/form-data" role="form" id="testform" method="POST"
            action="<?php echo e(route('branchadmin.addDocument')); ?>">
            <?php echo csrf_field(); ?>

            <div class="row">
              <div class="col-md-10">
                <div class="form-group<?php echo e($errors->has('title') ? ' has-error' : ''); ?>">
                  <label class="col-md-3 control-label required">Document Title</label>
                  <div class="col-md-9">
                    <input type="text" id="document_title" name="title" value="<?php echo e(old('title')); ?>"
                ...
                <div class="form-group <?php echo e($errors->has('document_descriptions') ? ' has-error' : ''); ?>">
                  <label class="col-md-3 control-label required">Description</label>
                  <div class="col-md-9">
                    <textarea class="form-control" id="document_descriptions"
                      name="document_descriptions"><?php echo e(old('document_descriptions')); ?></textarea>
                    <?php if($errors->has('document_descriptions')): ?>
                    <span class="help-block">
                      <strong><?php echo e($errors->first('document_descriptions')); ?></strong>
                    </span>
                    <?php endif; ?>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <label class="col-md-3 control-label required">Document Departments</label>
                  <div class="col-md-9">
                    <?php $departments = \App\Department::getAllDepartment(); ?>
                    <label><input type="checkbox" name="departments[]" value="0" />&nbsp;All</label>
                    <?php foreach($departments as $department): ?>
                    <label><input type="checkbox" name="departments[]" value="<?php echo e($department->id); ?>" />&nbsp;
                      <?php echo e($department->title); ?></label>
                    <?php endforeach; ?>
                  </div>
                </div>
                <div class="form-group">
  ...
  <script>
    var token = $("input[name=\"_token\"]").val();
      ...
      function getReminder(){
        $.ajax({
          type: "GET",
          url: "<?php echo e(route('branchadmin.getReminder')); ?>",
          data: {
            _token : token,
          },
          cache: false,
    ...
    function closeReminder(note_id)
    {
      $.ajax({
          type: "POST",
          url: "<?php echo e(route('branchadmin.updateReminder')); ?>",
          data: {
            _token : token,
            note_id : note_id
          },
        ...
        <div class="model-body">
          <div class="row">
            <div class="col-md-10 col-md-offset-1">
              <form method="POST" action="<?php echo e(route('branchadmin.diary.save')); ?>" class="form-horizontal" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php ($period = \App\BranchSetting::getPerformanceRatingTime(auth()->guard('staffs')->user()->branch)); ?>
  ...
  <div class="modal fade" id="modal-subordinate-performance-rating">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="subordinate-performance-rating-form" method="POST" action="<?php echo e(url('branchadmin/performance/save')); ?>" class="form-horizontal" enctype="multipart/form-data">
          <div class="modal-body">
            <?php echo csrf_field(); ?>
  ...
  $(document).ready(function(){
    ...
    $('#cancelPerformanceAll').click(function(){
      ...
      $.ajax({
        url: "<?php echo e(url('/branchadmin/performance/cancelAll')); ?>",
        type: 'POST',
        data:{
            _token: CSRF_TOKEN,
        },
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php if($questions): ?>
        <form action=" <?php echo e(route('branchadmin.survey.saveAction',$survey)); ?>" method="post" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
...
<script>
  $(document).ready(function($) {
    ...
    $(document).on('change', 'select', function () {
        ...
        if(extraValue == value){
            $.ajax({
                url: "<?php echo e(url('/branchadmin/mysurvey/getChildquestion')); ?>",
                type: 'POST',
                data:{
                    _token: CSRF_TOKEN,
          ...
          <div class="col-md-10 col-md-offset-1">
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td>
                  <a href="<?php echo e(url('branchadmin/otstaff/reports'.'/'.$contract->staff_id).'?tab=contract'); ?>" class="btn btn-info">Report</a>
                </td>
              </tr>
              <?php endforeach; ?>
            </table>
...
<script>
    $('#autocompleteStaffSearch').autocomplete({
        source: '<?php echo e(url("branchadmin/getStaffList/")); ?>',
        minlength:1,
        autoFocus:true,
          ...
          <div class="col-md-10 col-md-offset-1">
            ...
            <?php if(count($travel->travel_expense) == 0): ?>
              <li class="list-group-item">
                ...
                <span class="right">
                  <a href="<?php echo e(route('branchadmin.travelExpense.create', $travel->id)); ?>" class="btn btn-info">add Expense</a>
                </span>
              </li>
            <?php endif; ?>
            <?php endforeach; ?>
