...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      ...
      <div class="box-body">
      <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(route('branchadmin.trainer.update', $trainer->id)); ?>">
        <?php echo csrf_field(); ?>
       ...
       <div class="row">
            <div class="col-md-10" id="multiCategory">
                ...
                <div class="form-group<?php echo e($errors->has('rate') ? ' has-error' : ''); ?>" id="newform0">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="rate" name="rate" value="<?php echo e($trainer->rate); ?>" placeholder="0.00">
