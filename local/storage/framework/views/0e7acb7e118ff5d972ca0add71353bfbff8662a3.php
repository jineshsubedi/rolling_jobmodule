    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('staffs.travel.supervisorExpenseApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="approveAccountModel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('staffs.travel.accountExpenseApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="approveHrModel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('staffs.travel.hrExpenseApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="approveChairmanModel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('staffs.travel.chairmanExpenseApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
