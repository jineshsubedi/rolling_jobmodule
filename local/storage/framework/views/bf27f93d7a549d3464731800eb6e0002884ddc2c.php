...
<?php $__env->startSection('content'); ?>
 <div class="row">
    <div class="col-xs-12">
      <div class="row">
        <div class="col-md-12">
        <a href="<?php echo e(url('/staffs/department/addnew')); ?>" class="btn refreshbtn right btm10m"><i class="fa fa-plus-circle"></i> Add New Department</a>
      </div>
      </div>
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <?php $i=1; 
                        ...
                        <td><a href="<?php echo e(url('/staffs/department/edit/'.$row->id)); ?>" class="btn btn-primary left"><i class="fa fa-edit"></i></a>
  ...
  <script type="text/javascript">
    ...
    if(confirm('Do You Want To Delete This Album?')){
      var url= "<?php echo e(url('/staffs/department/delete/')); ?>"+ids;
      location = url;
