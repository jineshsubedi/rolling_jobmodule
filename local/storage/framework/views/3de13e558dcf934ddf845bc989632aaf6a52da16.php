...
<script>
    ...
    $(document).ready(function(){   //save post
        $('#fileUploadForm').submit(function(event){
            ...
            $.ajax({
                url: "<?php echo e(route('branchadmin.newsfeed.savePost')); ?>",
                data: formData,
                type: 'POST',
                dataType: 'JSON',
                processData: false,
    ...
    function loadNewsfeed(page)
    {
        $('#loading').show();
        $.ajax({
            url: "<?php echo e(route('branchadmin.newsfeed.getPosts')); ?>?page="+page,
            data:{
                _token: token,
                page: page
            },
...
<script>
    ...
    $('#eventSubmitBtn').click(function(){
        ...
        $('#mesageError').text('')
        $.ajax({
            url: "<?php echo e(route('branchadmin.newsfeed.event')); ?>",
            data:{
                _token: token,
                category: category,
                staff: staff,
