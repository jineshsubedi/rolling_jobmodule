                ...
                <td>
                  <form action="<?php echo e(route('supervisor.travel.destroy', $travel->id)); ?>" method="post">
                    ...
                    <?php if($travel->assigned_to == auth()->guard('staffs')->user()->id || $travel->assigned_from == auth()->guard('staffs')->user()->id): ?>
                        ...
                        <a href="<?php echo e(route('supervisor.travelExpense.create', $travel->id)); ?>" class="btn btn-info"><i class="fa fa-money"> Add</i></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('supervisor.travel.supervisorExpenseApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="approveAccountModel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('supervisor.travel.accountExpenseApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="approveHrModel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('supervisor.travel.hrExpenseApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="approveChairmanModel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('supervisor.travel.chairmanExpenseApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
