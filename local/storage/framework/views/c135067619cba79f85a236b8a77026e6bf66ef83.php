...
<style type="text/css">
 ...
 <div class="row">
    <div class="col-xs-12">
     <div class="row">
        <a href="<?php echo e(url('/supervisor/tasks/addnew')); ?>" class="btn btn-primary right"><i class="fa fa-fw fa-plus"></i>Add New Task</a>
      </div>
      ...
      <div class="box">
            ...
            <div class="top-links btn-group">
              <a href="<?php echo e(url('/supervisor/tasks')); ?>" class="btn <?php echo e($datas['task_type'] == '' ? 'btn-primary' : 'btn-default'); ?>">All</a>
              <a href="<?php echo e(url('/supervisor/tasks?task_from='.auth()->guard('staffs')->user()->id.'&task_type=2&task_to='.auth()->guard('staffs')->user()->id)); ?>" class="btn <?php echo e($datas['task_type'] == 2 ? 'btn-primary' : 'btn-default'); ?>">To do</a>

              <a href="<?php echo e(url('/supervisor/tasks?task_type=1&task_to='.auth()->guard('staffs')->user()->id)); ?>" class="btn <?php echo e($datas['task_type'] == 1 ? 'btn-primary' : 'btn-default'); ?>">My Task</a>
              <a href="<?php echo e(url('/supervisor/tasks?task_type=3&task_from='.auth()->guard('staffs')->user()->id)); ?>" class="btn <?php echo e($datas['task_type'] == 3 ? 'btn-primary' : 'btn-default'); ?>">Task Given</a>
              ...
              <a href="<?php echo e(url('/supervisor/tasks?task_type=4')); ?>" class="btn <?php echo e($datas['task_type'] == 4 ? 'btn-primary' : 'btn-default'); ?>">Messages
               <?php if($message > 0): ?>
                      <span class="badge label-danger chatbadge"><?php echo e($message); ?></span>
                      <?php endif; ?>
              </a>

              <a href="<?php echo e(url('/supervisor/tasks?task_type=5')); ?>" class="btn <?php echo e($datas['task_type'] == 5 ? 'btn-primary' : 'btn-default'); ?>">Accept
               <?php if($accept > 0): ?>
                      <span class="badge label-danger chatbadge"><?php echo e($accept); ?></span>
                      <?php endif; ?>
              </a>
              <a href="<?php echo e(url('/supervisor/tasks?task_type=6')); ?>" class="btn <?php echo e($datas['task_type'] == 6 ? 'btn-primary' : 'btn-default'); ?>">Approval
               <?php if($approval > 0): ?>
                    ...
                    <tbody>
                      ...
                      <td><input type="text" class="form-control" name="filter_title" id="filter_title" value="<?php echo e($datas['filter_title']); ?>"></td>
                        ...
                        <td>
                           <select class="form-control" id="task_to">
                            <option value="">Select Staff</option>
                          <?php foreach($datas['to_staffs'] as $to_staff): ?>
                            <?php if($datas['task_to'] == $to_staff->id): ?>
                            <option value="<?php echo e($to_staff->id); ?>" selected="selected"><?php echo e($to_staff->name); ?></option>
                            <?php else: ?>
                            <option value="<?php echo e($to_staff->id); ?>"><?php echo e($to_staff->name); ?></option>
                            <?php endif; ?>
                          <?php endforeach; ?>
                        </select>
                        </td>
                     ...
                     <tr>
                      ...
                      <td>
                        ...
                        <button  onclick="approve('modal-approve','<?php echo e($task->id); ?>','<?php echo e($task->self_mark); ?>','<?php echo e(addslashes(htmlspecialchars($task->title))); ?>','<?php echo e($task->finish_time); ?>')" class="badge bg-purple" data-toggle="modal" data-target="#modal-approve" data-original-title="Approve Complete">Approve</button>
                        <?php endif; ?>

                        <?php if($task->accept_status != 0 && $task->complete != 1 && $task->task_to == auth()->guard('staffs')->user()->id): ?>
                        <button  onclick="complete('modal-complete','<?php echo e($task->id); ?>','<?php echo e(addslashes(htmlspecialchars($task->title))); ?>','<?php echo e($task->finish_time); ?>')" class="badge bg-purple" data-toggle="modal" data-target="#modal-complete" data-original-title="Complete">Complete</button>
                        <?php endif; ?>
                    ...
                    <button type="button" class="btn btn-box-tool chat-button" data-toggle="tooltip" title="View Chat" onclick="viewChatModal('modal-message','<?php echo e($task->parent_id ? $task->parent_id :$task->id); ?>')" data-original-title="Contacts"><i class="fa fa-comments"></i>Chat
                      ...
                      <a href="<?php echo e(url('/supervisor/tasks/edit/'.$task->id)); ?>" type="button" class="btn btn-box-tool" data-original-title="Contacts">
  ...
  <div class="modal fade" id="modal-complete">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form id="job-form" method="POST" action="<?php echo e(url('/supervisor/task/complete')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body">
   ...
   <div class="modal fade" id="modal-assign">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form id="job-form" method="POST" action="<?php echo e(url('/supervisor/tasks/assign')); ?>" class="form-horizontal" enctype="multipart/form-data">
  ...
  <div class="modal fade" id="modal-assignjob">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form id="job-form" method="POST" action="<?php echo e(url('/supervisor/job/assign')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body" style="max-height: 500px; overflow-y: scroll;">
  ...
  <div class="modal fade" id="modal-default">
          <div class="modal-dialog" style="width: 900px;">
            <div class="modal-content">
              ...
              <form id="job-form" method="POST" action="<?php echo e(url('/supervisor/tasks/saveJob')); ?>" class="form-horizontal" enctype="multipart/form-data">
...
<div class="modal fade" id="modal-assignUser">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="job-form" method="POST" action="<?php echo e(url('/supervisor/task/addusertochat')); ?>" class="form-horizontal"
...
<script type="text/javascript">
  ...
  function showJobs(id) {
   ...
   function viewAssign(id) {
    ...
    $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/supervisor/tasks/assignedstaff")); ?>',
            data: '_token='+token+'&id='+id,
            cache: false,
            success: function(html){
  ...
  function completeJob(id) {
   if(confirm('Are you sure this job is complete?')){
      var url= "<?php echo e(url('/supervisor/job/complete/')); ?>/"+id;
      location = url;
  ...
  function viewChatModal(div,task_id)  //changed
  {
    ...
    $.ajax({
      type: 'POST',
        url: '<?php echo e(url("/supervisor/task/getmembers")); ?>',
        data: '_token='+token+'&id='+task_id,
        cache: false,
    ...
    $.ajax({
      type: 'POST',
        url: '<?php echo e(url("/supervisor/task/authorizeAssign")); ?>',
        data: '_token='+token+'&id='+task_id,
        cache: false,
        success: function(data){
          if(data==1){
  ...
  function addMember() //changed
  {
    ...
    $.ajax({
        type: 'get',
          url: '<?php echo e(url("/supervisor/task/getUsersListForChat")); ?>',
          data: '_token='+token+'&id='+id,
          cache: false,
          success: function(data){
  ...
  function removeChatMember(taskId, userId) //changed
  {
    ...
    $.ajax({
        type: 'get',
          url: '<?php echo e(url("/supervisor/task/removeMember")); ?>',
...
<script type="text/javascript">
  ...
  function filterData(){
        var url= "<?php echo e(url('/supervisor/tasks/?')); ?>";
...
<script type="text/javascript">
    ...
    function acceptJob(id) {
      ...
      var url= "<?php echo e(url('/supervisor/tasks/accept/')); ?>/"+id;
      location = url;
     ...
     function reopenTask() {
      if(confirm('Are you sure you want re-open this task?')){
          ...
          if(id != ''){
              $.ajax({
                 type: 'POST',
                    url: '<?php echo e(url("/supervisor/tasks/reopen")); ?>',
    ...
    function deleteChat(id) {
      ...
      var token = $('input[name=\'_token\']').val();
        ...
        if (id != '') {
          $.ajax({
             type: 'POST',
                url: '<?php echo e(url("/supervisor/task/deleteChat")); ?>',
                data: '_token='+token+'&id='+id,
                cache: false,
                success: function(html){
                  var datas = html.split('|');
    ...
    function startTask(task_id,kra,title) {
      var token = $('input[name=\'_token\']').val();
        ...
        if (task_id != '') {
          $.ajax({
             type: 'POST',
                url: '<?php echo e(url("/supervisor/daily-routine/tasksave")); ?>',
    ...
    function stopTask(task_id) {
      var token = $('input[name=\'_token\']').val();
        ...
        if (task_id != '') {
          $.ajax({
             type: 'POST',
                url: '<?php echo e(url("/supervisor/daily-routine/taskstop")); ?>',
