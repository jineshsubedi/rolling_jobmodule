...
<li class="active">Edit Exit Interview</li>
<?php $__env->stopSection(); ?>
    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="panel panel-default">
                <div class="panel-heading">Edit Exit Interview</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(url('/supervisor/interview/update')); ?>">
                        <input type="hidden" name="id" value="<?php echo e($datas['interview']->id); ?>"> 
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group<?php echo e($errors->has('staff_id') ? ' has-error' : ''); ?>">
                                    ...
                                    <input type="hidden" name="staff_name" value="<?php echo e($datas['interview']->staffs_name); ?>" id="staff_name">
                                    <div class="col-md-9">
                                        <select class="form-control" id="staff_id" name="staff_id">
                                            <option value="">Select Staff</option>
                                            <?php foreach($datas['staffs'] as $staff): ?>
                                            <?php if($datas['interview']->staffs_id == $staff->id): ?>
                            ...
                            <div class="col-md-5">
                                <div class="form-group<?php echo e($errors->has('interview_date') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" id="interview_date" required name="interview_date" value="<?php echo e($datas['interview']->interview_date); ?>" placeholder="2016-01-01" class="form-control datepicker" />
                                ...
                                <div class="form-group<?php echo e($errors->has('received_by') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="received_by">
                                            ...
                                            <?php if($datas['interview']->received_by == $staff->name): ?>
                            ...
                            <div class="col-md-5">
                                <div class="form-group<?php echo e($errors->has('service_tenure') ? ' has-error' : ''); ?>">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" id="service_tenure" required name="service_tenure" value="<?php echo e($datas['interview']->service_tenure); ?>" placeholder="2016-01-01" class="form-control" />
                        ...
                        <div class="row" >
                            <?php ($des_row = 0); ?>
                            <?php ($questions = json_decode($datas['interview']->description)); ?>
                            <div class="col-md-12" id="descriptions">
                                ...
                                <?php ($des_row++); ?>
                                <?php endforeach; ?>
                                <?php elseif(is_array($questions)): ?>
                                <?php foreach($questions as $question): ?>
                                <div id="desc_row_<?php echo e($des_row); ?>" class="form-group">
                                    <div class="col-xs-10">
                                    <input type="hidden" name="description[<?php echo e($des_row); ?>][question]" value="<?php echo e($question->question); ?>"/>
                                    <label class="col-md-12"><?php echo e($question->question); ?></label>
                                    <div class="col-md-12">
                                        
                                       <textarea class="form-control" name="description[<?php echo e($des_row); ?>][answer]"><?php echo e($question->answer); ?></textarea>
