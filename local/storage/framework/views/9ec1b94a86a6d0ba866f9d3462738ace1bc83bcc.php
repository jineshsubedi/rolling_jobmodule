...
<li><a href="<?php echo e(url('/supervisor/survey')); ?>">Surveys</a></li>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div id="survey_section" class="col-md-12">
                        <div class="col-md-6">
                            <form action="<?php echo e(route('supervisor.surveysetup.update', $survey->id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
<script type="text/javascript">
    ...
    $.ajax({
        url: "<?php echo e(route('supervisor.surveysetup.questions')); ?>",
        type: 'GET',
        data:{
            _token: CSRF_TOKEN,
    ...
    function editSurveyQuestion(id){
        ...
        $.ajax({
            url: "<?php echo e(url('/supervisor/survey-setup/addnew/findSurveyQuestion')); ?>",
            type: 'get',
            data:{
                _token: CSRF_TOKEN,
                question_id: id
        ...
        $('#edit_survey_parent'+id).autocomplete({
            source: function(request, response) {
                $.ajax({
                    url: '<?php echo e(url("/supervisor/survey-setup/addnew/edit/autocomplete")); ?>',
                    dataType: "json",
                    data: {
                        term : request.term,
                        survey_id : $('#survey_id').val(),
    ...
    function updateSurveyQuestion(id)
    {
        ...
        $.ajax({
            url: "<?php echo e(url('/supervisor/survey-setup/addnew/updateSurveyQuestion')); ?>",
            type: 'PUT',
            data:{
                _token: CSRF_TOKEN,
                question_id: id,
