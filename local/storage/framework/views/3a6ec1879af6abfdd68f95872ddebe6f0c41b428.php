        ...
        <div class="box">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(route('googledrive.api.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-10">
                            <div class="form-group<?php echo e($errors->has('refresh_token') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="refresh_token" value="<?php echo e(old('refresh_token')); ?>">
                        ...
                        <div class="row">
                         <div class="col-md-10">
                            <div class="form-group<?php echo e($errors->has('drive_folder_id') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="drive_folder_id" value="<?php echo e(old('drive_folder_id')); ?>">
