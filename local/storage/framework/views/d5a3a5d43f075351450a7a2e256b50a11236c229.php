                        ...
                        <div class="row">
                         <div class="col-md-10">
                            <div class="form-group<?php echo e($errors->has('project_id') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="project_id" value="<?php echo e($data->project_id); ?>">
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-10">
                            <div class="form-group<?php echo e($errors->has('redirect_url') ? ' has-error' : ''); ?>">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="redirect_url" value="<?php echo e($data->redirect_url); ?>">
