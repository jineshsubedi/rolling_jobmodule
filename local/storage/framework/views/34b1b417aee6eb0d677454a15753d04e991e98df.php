...
<div class="row">
  <div class="col-xs-12">
    <div class="row">
      <div class="col-md-12">
        <a href="<?php echo e(route('branchadmin.training.index')); ?>" class="btn refreshbtn right btm10m"><i
    ...
    <div class="box">
      <div class="box-body">
        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <a href="<?php echo e(route('branchadmin.training_feedback.deleteFeedback', $feedback->id)); ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
          </div>
          </div>
          <br>
        <?php endforeach; ?>
