...
<li class="active">Assignment Type Create</li>
<?php $__env->stopSection(); ?>
...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
        <div class="box-title">
            <h3>Assignment Type Create</h3>
        </div>
      <div class="box-body">
      <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(route('branchadmin.assignment_type.update', $type->id)); ?>">
        <?php echo csrf_field(); ?>
