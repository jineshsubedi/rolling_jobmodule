...
<?php $__env->startSection('breadcrubm'); ?>
 <li><a href="<?php echo e(url('/branchadmin')); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
          <li><a href="<?php echo e(url('/branchadmin/otstaff')); ?>"><i class="fa fa-users"></i> Staffs</a></li>  
...
<div class="row">
    <div class="col-xs-12">
      <div class="box">
              ...
              <div class="col-md-4">
                <div class="staff-detail">
                  <ul>
                    ...
                    <?php endif; ?>
                    <li><i class="fa fa-star"></i> Best Employee : <span class="greenclr bold"><?php echo e(\App\Award::countVoting($datas['staff_id'], 'Best')); ?></span> <span class="right"><i class="fa fa-trophy redclr"></i> Achievement : <span class="redclr bold"><?php echo e(count($datas['achievements'])); ?></span></span></li>
                    <li><i class="fa fa-clock-o"></i> <?php echo e($datas['shift']->title); ?> (<?php echo e($datas['shift']->from); ?> - <?php echo e($datas['shift']->to); ?>)</li>                    
            ...
            <div class="nav-tabs-custom staff_tab">
            <ul class="nav nav-tabs">
              ...
              <li class="<?php echo e($datas['tab'] == 'attendance' ? 'active' : ''); ?>"><a href="#attendance" data-toggle="tab" aria-expanded="false">Attendance</a></li>
              <li class="<?php echo e($datas['tab'] == 'sbt' ? 'active' : ''); ?>"><a href="#sbt" data-toggle="tab" aria-expanded="false">Subordinate Note</a></li>
              <li class="<?php echo e($datas['tab'] == 'descipline' ? 'active' : ''); ?>"><a href="#descipline" data-toggle="tab" aria-expanded="false">Warnings</a></li>
              <li class="<?php echo e($datas['tab'] == 'subordinate_rating' ? 'active' : ''); ?>"><a href="#subordinate_rating" data-toggle="tab" aria-expanded="false">Subordinate/Supervisor Rating</a></li>
               <?php if(count($datas['client_ratings']) > 0): ?>
              <li class="<?php echo e($datas['tab'] == 'client_rating' ? 'active' : ''); ?>"><a href="#client_rating" data-toggle="tab" aria-expanded="false">Client Rating</a></li>
               <?php endif; ?>
              ...
              <li class="<?php echo e($datas['tab'] == 'travel' ? 'active' : ''); ?>"><a href="#travel" data-toggle="tab" aria-expanded="false">Approved Travel</a></li>
              <?php endif; ?>
            ...
            <div class="tab-content">
              <div class="tab-pane <?php echo e($datas['tab'] == 'salary' ? 'active' : ''); ?>" id="salary">
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-12">
                    <a href="<?php echo e(url('/branchadmin/otstaff/addsalary/'.$datas['staff_id'])); ?>" class="btn btn-info pull-right" target="_blank"><i class="fa fa-plus"> Add Salary</i></a>
              ...
              <div class="tab-pane <?php echo e($datas['tab'] == 'travel' ? 'active' : ''); ?>" id="travel">
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-12">
                    <a href="<?php echo e(url('/branchadmin/travel/create/')); ?>" class="btn btn-info pull-right" target="_blank"><i class="fa fa-plus">Travel Request</i></a>
                    <h3 class="profilehd">Staff Travel Information</h3>
                    <div class="profile_infolist">
                      <table class="table table-bordered table-striped">
                        <tr>
                          <th>SN</th>
                        ...
                        <?php foreach($datas['travel'] as $k=>$travel): ?>
                        <tr>
                          <td><?php echo e($k+1); ?></td>
                          ...
                          <table class="table table-bordered">
                            ...
                            <?php foreach($datas['contract'] as $k=>$contract): ?>
                              <tr>
                                ...
                                <th>
                                <form action="<?php echo e(url('branchadmin/otstaff/contract'.'/'.$datas['staff_id'].'/delete'.'/'.$contract->id)); ?>" method="post">
                                  <?php echo csrf_field(); ?>

                                  <?php echo method_field('DELETE'); ?>

                                  <!-- <a href="<?php echo e(url('branchadmin/otstaff/contract'.'/'.$datas['staff_id'].'/update')); ?>" class="btn btn-info"><i class="fa fa-edit"></i></a> -->
              ...
              <div class="tab-pane <?php echo e($datas['tab'] == 'appraisal_note' ? 'active' : ''); ?>" id="appraisal_note">
                <div class="row cm10-row btm10m">
                  Appraisal Notes
                  <button class="btn btn-primary addbtn right" data-toggle="modal" data-target="#modal-add-appraisal_note"><i class="fa fa-plus"></i>Add Note</button>
                </div>
              ...
              <div class="tab-pane <?php echo e($datas['tab'] == 'kpi' ? 'active' : ''); ?>" id="kpi">
                <div class="row cm10-row task-header">
                  KPI (Key Performance Indicators)
                <a class="btn btn-primary addbtn float-right" data-toggle="modal" data-target="#modal-add-kpi"><i class="fa fa-plus"></i>Add KPI</a>
                </div>
                ...
                <table id="kpi" class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="kpi_row_<?php echo e($skpi['id']); ?>">
                      ...
                      <td><button class="btn deletebtn" onclick="delKpi('<?php echo e($skpi["id"]); ?>');"><i class="fa fa-trash"></i> Delete</button></td>
                    </tr>
                    <?php ($kpii++); ?>
                    <?php endforeach; ?>
                  </tbody>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="skill_row_<?php echo e($skills->id); ?>">
                      ...
                      <td><button class="btn deletebtn" onclick="deleteSkill('<?php echo e($skills->id); ?>');"><i class="fa fa-trash"></i> Delete</button></td>
                    </tr>
                    <?php ($ski++); ?>
                    <?php endforeach; ?>
                  </tbody>
              ...
              <div class="tab-pane <?php echo e($datas['tab'] == 'kra' ? 'active' : ''); ?>" id="kra">
                <div class="row cm10-row task-header">
                  ...
                  <a class="btn addbtn right" data-toggle="modal" data-target="#modal-add-kra"><i class="fa fa-plus"></i>Add KRA</a>
                </div>
                <?php foreach($datas['staff_kra'] as $kra): ?>
                  <div class="box box-info collapsed-box border_top">
                    <div class="box-header with-border">
                      ...
                      <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i> Add
                        </button>
                        <button type="button" class="btn btn-box-tool greenclr" data-toggle="tooltip" title="Edit KRA" onclick="editKra('<?php echo e($kra["id"]); ?>');"><i class="fa fa-edit"></i> Edit</button>
                        <button type="button" class="btn btn-box-tool redclr" data-widget="remove" onclick="deletekra('<?php echo e($kra["id"]); ?>');"><i class="fa fa-times"></i> Delete</button>
                      </div>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body" >
                        ...
                        <table class="table no-margin" style="width: 95%; float: right;">
                          ...
                          <tr id="kpa-row-<?php echo e($kpa->id); ?>">
                            ...
                            <td width="100">
                              ...
                              <button class="btn whitegradient" onclick="deleteKpa('<?php echo e($kpa->id); ?>');"><i class="fa fa-trash"></i> Delete</button>
                            </td>
                          </tr>
                          <?php endforeach; ?>
                    ...
                    <div class="box-footer clearfix">
                      <a href="javascript:void(0)" class="btn btn-sm btn-info refreshbtn" onclick="addKpa('<?php echo e($kra["id"]); ?>');">Add KPA</a>
        ...
        <div class="tab-pane <?php echo e($datas['tab'] == 'task' ? 'active' : ''); ?>" id="tasks">
                <div class="row cm10-row btm10m">
                  <strong>Tasks</strong>
                <a href="<?php echo e(url('/branchadmin/otstaff/addtask/'.$datas['staff_id'])); ?>" class="btn addbtn float-right">Add Task <i class="fa fa-plus-circle"></i> </a>
              </div>
              <div class="row cm10-row border tb5p btm10m">
                  <div class="col-md-3">
                      <div class="form-group">
                          <label class="label-control col-md-5">Deadline From</label>
                          <div class="col-md-7"><input type="text" class="form-control datepicker" id="filter_task_from" value="<?php echo e($datas['filter_task_from']); ?>"></div>
                      </div>
                  </div>
                  <div class="col-md-3">
                      <div class="form-group">
                          <label class="label-control col-md-5">Deadline To</label>
                          <div class="col-md-7"><input type="text" class="form-control datepicker" id="filter_task_to" value="<?php echo e($datas['filter_task_to']); ?>"></div>
                      </div>
                  </div>
                  <div class="col-md-3">
                      <div class="form-group">
                          <label class="label-control col-md-5">Ratio</label>
                          <div class="col-md-7">
                              <select class="form-control" id="filter_task_ratio">
                                  <?php foreach($datas['filter_tasks'] as $ratio): ?>
                                  <?php if($datas['filter_task_ratio'] == $ratio['value']): ?>
                                  <option value="<?php echo e($ratio['value']); ?>" selected="selected"><?php echo e($ratio['title']); ?></option>
                                  <?php else: ?>
                                  <option value="<?php echo e($ratio['value']); ?>"><?php echo e($ratio['title']); ?></option>
                                  <?php endif; ?>
                                  <?php endforeach; ?>
                              </select>
                          </div>
                  ...
                  <div class="col-md-1"><a href="<?php echo e(url('branchadmin/otstaff/reports')); ?>/<?php echo e($datas['staff_id']); ?>" class="btn btn-primary">All</a></div>
              </div>
          ...
          <table class="table table-hover">
                    ...
                    <?php ($acheck = \App\StaffTask::checkAssign($task->id)); ?>
                     <tr>
                        ...
                        <td><?php echo e($task->supervisor_mark); ?></td>
                    ...
                    <button  onclick="approve('modal-approve','<?php echo e($task->id); ?>','<?php echo e($task->self_mark); ?>','<?php echo e(addslashes(htmlspecialchars($task->title))); ?>','<?php echo e($task->finish_time); ?>','<?php echo e($task->start_time); ?>')" class="badge bg-purple" data-toggle="modal" data-target="#modal-approve" data-original-title="Approve Complete">Approve</button>
                    <?php endif; ?>
                    <?php if($task->accept_status != 0 && $task->complete != 1 && $task->task_to == auth()->guard('staffs')->user()->id): ?>
                        <button  onclick="complete('modal-complete','<?php echo e($task->id); ?>','<?php echo e(addslashes(htmlspecialchars($task->title))); ?>')" class="badge bg-purple" data-toggle="modal" data-target="#modal-complete" data-original-title="Complete">Complete</button>
                        <?php endif; ?>
                    ...
                    <button type="button" class="btn btn-box-tool chat-button" data-toggle="tooltip" title="View Chat" onclick="viewChatModal('modal-message','<?php echo e($task->id); ?>')" data-original-title="Contacts"><i class="fa fa-comments"></i>Chat
                     <?php if($message > 0): ?>
                      ...
                      <a href="<?php echo e(url('/branchadmin/task/edit/'.$task->id)); ?>" type="button" class="btn btn-box-tool" data-original-title="Contacts">
               ...
               <div class="tab-pane <?php echo e($datas['tab'] == 'help' ? 'active' : ''); ?>" id="requests">
                  ...
                  <div class="col-md-3">
                      <div class="form-group">
                          <label class="label-control col-md-5">Deadline From</label>
                          <div class="col-md-7"><input type="text" class="form-control help_datepicker" id="filter_help_from" value="<?php echo e($datas['filter_help_from']); ?>"></div>
                      </div>
                  </div>
                  <div class="col-md-3">
                      <div class="form-group">
                          <label class="label-control col-md-5">Deadline To</label>
                          <div class="col-md-7"><input type="text" class="form-control help_datepicker" id="filter_help_to" value="<?php echo e($datas['filter_help_to']); ?>"></div>
                      </div>
                  </div>
                  <div class="col-md-3">
                      <div class="form-group">
                          <label class="label-control col-md-5">Ratio</label>
                          <div class="col-md-7">
                              <select class="form-control" id="filter_help_ratio">
                                  <?php foreach($datas['filter_tasks'] as $ratio): ?>
                                  <?php if($datas['filter_help_ratio'] == $ratio['value']): ?>
                                  <option value="<?php echo e($ratio['value']); ?>" selected="selected"><?php echo e($ratio['title']); ?></option>
                                  <?php else: ?>
                                  <option value="<?php echo e($ratio['value']); ?>"><?php echo e($ratio['title']); ?></option>
                                  <?php endif; ?>
                  ...
                  <div class="col-md-1"><a href="<?php echo e(url('branchadmin/otstaff/reports')); ?>/<?php echo e($datas['staff_id']); ?>?tab=help" class="btn btn-primary">All</a></div>
              </div>
                 <table class="table table-hover">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      ...
                      <a href="#" onclick="viewHelp('<?php echo e($hdesk->id); ?>')"><?php echo e(\App\library\Settings::getLimitedWords($hdesk->title,0,10)); ?></a>
                      <?php echo \App\TaskJobs::getSpan($hdesk->accept_status,$hdesk->complete_status,$hdesk->finish_time); ?>
                        ...
                        <td><?php echo e($hdesk->supervisor_mark); ?></td>
                        <td>
              ...
              <div class="tab-pane <?php echo e($datas['tab'] == 'leave' ? 'active' : ''); ?>" id="leave">
                 ...
                 <div class="tab-pane <?php echo e($datas['tab'] == 'attendance' ? 'active' : ''); ?>" id="attendance">
      ...
      <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <div class="col-md-3">
                ...
                <div class="col-md-8"><input type="text" id="filter_from" class="form-control attendance_datepicker" value="<?php echo e($datas['filter_task_from']); ?>"></div>
              </div>
              <div class="col-md-3">
                <label class="label-control col-md-4">To</label>
                <div class="col-md-8"><input type="text" id="filter_to" class="form-control attendance_datepicker" value="<?php echo e($datas['filter_task_to']); ?>"></div>
              </div>
              <div class="col-md-2">
                <a class="btn btn-success" href="<?php echo e(url('/branchadmin/otstaff/reports/')); ?>/<?php echo e($datas['staff_id']); ?>?tab=attendance">All </a>
              </div>
            </div>
           ...
           <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><span class="label <?php echo e($attendance['office_in_class']); ?>"><?php echo e($attendance['office_in'] .' '.$attendance['office_in_distance']); ?></span><button onclick="viewMap('<?php echo e($attendance["office_in_location"]); ?>','Duty Started in <?php echo e($attendance["office_in"]); ?>')"><i class="fa fa-map-marker"></i></button></td>
                        <td><span class="label <?php echo e($attendance['lunch_out_class']); ?>"><?php echo e($attendance['lunch_out'] .' '.$attendance['lunch_out_distance']); ?></span><button onclick="viewMap('<?php echo e($attendance["lunch_out_location"]); ?>','Lunch Started in <?php echo e($attendance["lunch_out"]); ?>')"><i class="fa fa-map-marker"></i></button></td>
                         <td><span class="label <?php echo e($attendance['lunch_in_class']); ?>"><?php echo e($attendance['lunch_in'] .' '.$attendance['lunch_in_distance']); ?></span><button onclick="viewMap('<?php echo e($attendance["lunch_in_location"]); ?>','Lunch Ended in <?php echo e($attendance["lunch_in"]); ?>')"><i class="fa fa-map-marker"></i></button></td>
                          <td><span class="label <?php echo e($attendance['office_out_class']); ?>"><?php echo e($attendance['office_out'] .' '.$attendance['office_out_distance']); ?></span><button onclick="viewMap('<?php echo e($attendance["office_out_location"]); ?>','Duty Out in <?php echo e($attendance["office_out"]); ?>')"><i class="fa fa-map-marker"></i></button></td>
    ...
    <div class="col-xs-12">
      <div class="dataTables_paginate paging_simple_numbers right">
          ...
          <div class="tab-pane <?php echo e($datas['tab'] == 'performance' ? 'active' : ''); ?>" id="performance">
            ...
            <div class="row task-header"><button class="btn btn-primary right" onclick="addPerformance()">Add Performance</strong>  </div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button class="btn btn-primary" onclick="editPerformance('<?php echo e($performance->id); ?>','<?php echo e(addslashes(htmlspecialchars($performance->comment))); ?>','<?php echo e($performance->comment_rating); ?>')" ><i class="fa fa-pencil"></i></button>
                    <button class="btn deletebtn" onclick="deletePerformance('<?php echo e($performance->id); ?>')" ><i class="fa fa-remove"></i> Delete</button>
                    <?php endif; ?>
                  </td>
                </tr>
                <?php ($i++); ?>
          ...
          <div class="tab-pane <?php echo e($datas['tab'] == 'subordinate_rating' ? 'active' : ''); ?>" id="subordinate_rating">
           ...
           <?php ($column = 7); ?>
            ...
            <table class="table table-hover">
              <thead>
                <tr>
                  <th>Rate By</th>
                  <?php if($datas['staff_type'] == 1): ?>
                  <?php ($column = 9); ?>
                  <th>Supervisory Ability</th>
                  <th>Leadership</th>
                  <?php endif; ?>
                  <th>Quality of Work</th>
                  <th>Communciation/Coworker Relations</th>
              ...
              <tbody>
                <?php if(count($datas['first_rating']) > 0): ?>
                <tr><td colspan="<?php echo e($column); ?>"><center><strong>First Quarter Rating Detail</strong></center></td></tr>
                <?php foreach($datas['first_rating'] as $first_rating): ?>
                 <tr>
                  <td><?php echo e(\App\Adjustment_staff::getName($first_rating->added_by)); ?></td>
                  <?php if($datas['staff_type'] == 1): ?>
                  
                  <td><?php echo e($first_rating->supervisory); ?></td>
                  <td><?php echo e($first_rating->leadership); ?></td>
                  <?php endif; ?>
                  <td><?php echo e($first_rating->quality); ?></td>
                  <td><?php echo e($first_rating->communication); ?></td>
                  <td><?php echo e($first_rating->consistency); ?></td>
                  <td><?php echo e($first_rating->independent); ?></td>
                  <td><?php echo e($first_rating->proactiveness); ?></td>
                  <td><?php echo e($first_rating->creativity); ?></td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
                
                 <?php if(count($datas['second_rating']) > 0): ?>
                <tr><td colspan="<?php echo e($column); ?>"><center><strong>Second Quarter Rating Detail</strong></center></td></tr>
                <?php foreach($datas['second_rating'] as $second_rating): ?>
                 <tr>
                  <td><?php echo e(\App\Adjustment_staff::getName($second_rating->added_by)); ?></td>
                  <?php if($datas['staff_type'] == 1): ?>
                  
                  <td><?php echo e($second_rating->supervisory); ?></td>
                  <td><?php echo e($second_rating->leadership); ?></td>
                  <?php endif; ?>
                  <td><?php echo e($second_rating->quality); ?></td>
                  <td><?php echo e($second_rating->communication); ?></td>
                  <td><?php echo e($second_rating->consistency); ?></td>
                  <td><?php echo e($second_rating->independent); ?></td>
                  <td><?php echo e($second_rating->proactiveness); ?></td>
                  <td><?php echo e($second_rating->creativity); ?></td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
                
                 <?php if(count($datas['third_rating']) > 0): ?>
                <tr><td colspan="<?php echo e($column); ?>"><center><strong>Third Quarter Rating Detail</strong></center></td></tr>
                <?php foreach($datas['third_rating'] as $third_rating): ?>
                 <tr>
                  <td><?php echo e(\App\Adjustment_staff::getName($third_rating->added_by)); ?></td>
                  <?php if($datas['staff_type'] == 1): ?>
                  
                  <td><?php echo e($third_rating->supervisory); ?></td>
                  <td><?php echo e($third_rating->leadership); ?></td>
                  <?php endif; ?>
                  <td><?php echo e($third_rating->quality); ?></td>
                  <td><?php echo e($third_rating->communication); ?></td>
                  <td><?php echo e($third_rating->consistency); ?></td>
                  <td><?php echo e($third_rating->independent); ?></td>
                  <td><?php echo e($third_rating->proactiveness); ?></td>
                  <td><?php echo e($third_rating->creativity); ?></td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
                <?php if(count($datas['fourth_rating']) > 0): ?>
                <tr><td colspan="<?php echo e($column); ?>"><center><strong>Fourth Quarter Rating Detail</strong></center></td></tr>
                <?php foreach($datas['fourth_rating'] as $fourth_rating): ?>
                 <tr>
                  <td><?php echo e(\App\Adjustment_staff::getName($fourth_rating->added_by)); ?></td>
                  <?php if($datas['staff_type'] == 1): ?>
                  
                  <td><?php echo e($fourth_rating->supervisory); ?></td>
                  <td><?php echo e($fourth_rating->leadership); ?></td>
                  <?php endif; ?>
                  <td><?php echo e($fourth_rating->quality); ?></td>
                  <td><?php echo e($fourth_rating->communication); ?></td>
                  <td><?php echo e($fourth_rating->consistency); ?></td>
                  <td><?php echo e($fourth_rating->independent); ?></td>
                  <td><?php echo e($fourth_rating->proactiveness); ?></td>
                  <td><?php echo e($fourth_rating->creativity); ?></td>
                </tr>
                <?php endforeach; ?>
                <?php endif; ?>
              </tbody>
          ...
          <div class="tab-pane <?php echo e($datas['tab'] == 'sbt' ? 'active' : ''); ?>" id="sbt">
    ...
    <div class="col-md-8">
      <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <div class="col-md-3">
                <label class="label-control col-md-4">From</label>
                <div class="col-md-8"><input type="text" id="filter_sbt_from" class="form-control sbt_datepicker" value="<?php echo e($datas['filter_sbt_from']); ?>"></div>
              </div>
              <div class="col-md-3">
                <label class="label-control col-md-4">To</label>
                <div class="col-md-8"><input type="text" id="filter_sbt_to" class="form-control sbt_datepicker" value="<?php echo e($datas['filter_sbt_to']); ?>"></div>
              </div>
              <div class="col-md-2">
                <a class="btn btn-success" href="<?php echo e(url('/branchadmin/otstaff/reports/')); ?>/<?php echo e($datas['staff_id']); ?>?tab=sbt">All </a>
              </div>
            </div>
           ...
           <table class="table table-hover">
                    ...
                    <tbody>
                      <?php foreach($datas['sbt_comments'] as $sbt_comments): ?>
                      <tr>
                        <td><?php echo e(\App\Adjustment_staff::getName($sbt_comments->comment_by)); ?></td>
                        <td><?php echo e($sbt_comments->comment); ?></td>
                        <td><?php echo e($sbt_comments->comment_rating); ?></td>
                      </tr>
                      <?php endforeach; ?>
                    </tbody>
                    </table>
            <div class="row">
              <div class="col-xs-12">
                <div class="dataTables_paginate paging_simple_numbers right">
                    <?php echo $datas['sbt_comments']->render();?>
                </div>
              </div>
            </div>
          </div>
          <div class="tab-pane <?php echo e($datas['tab'] == 'descipline' ? 'active' : ''); ?>" id="descipline">
            <div class="row"><button class="btn btn-primary right" onclick="addWarning()">Add Warning</strong>  </div>
            <table class="table table-hover">
              <thead>
                <tr>
                  <th>Title</th>
              ...
              <tbody>
                <?php foreach($datas['descipline'] as $descipline): ?>
                <tr>
                  <td><?php echo e($descipline->title); ?></td>
                  <td><?php echo e($descipline->detail); ?></td>
                  <td><?php echo e(\App\Adjustment_staff::getName($descipline->added_by)); ?></td>
                  <td><?php echo e($descipline->created_at); ?></td>
                  <td><a class="btn deletebtn" href="<?php echo e(url('/branchadmin/warning/delete/'.$descipline->id)); ?>">Delete </a></td>
                </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
            <div class="row">
              <div class="col-xs-12">
                <div class="dataTables_paginate paging_simple_numbers right">
                    <?php echo $datas['descipline']->render();?>
                </div>
              </div>
            </div>
          </div>
  <div class="tab-pane <?php echo e($datas['tab'] == 'client_rating' ? 'active' : ''); ?>" id="client_rating">
    <table class="table table-hover">
      <thead>
        <tr>
          <th style="width: 1%;">S.N.</th>
      ...
      <tbody>
        <?php ($i = 1); ?>
        <?php foreach($datas['client_ratings'] as $client_ratings): ?>
        <tr>
          <td><?php echo e($i++); ?></td>
           <td><?php echo e(\App\ClientDetail::getName($client_ratings->client_detail_id)); ?></td>
          <td>Overal</td>
          <td><?php echo e($client_ratings->overal_rating); ?></td>
          <td><?php echo e($client_ratings->overal_remarks); ?></td>
          <td><?php echo e($client_ratings->created_at); ?></td>
        </tr>
          <?php ($others = json_decode($client_ratings->others)); ?>
    ...
    <table class="table table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="<?php echo e(url('/branchadmin/staff-survey/view/'.$survey->id)); ?>" class="btn btn-success left"><i class="fa fa-fw fa-eye"></i></a>
          </td>
        </tr>
        <?php endforeach; ?>
      </tbody>
  ...
  <div class="modal fade " id="modal-performance">
      <div class="modal-dialog" style="width: 900px;">
        <div class="modal-content">
          ...
          <form id="performance-form" method="POST" action="<?php echo e(url('/branchadmin/performance/save')); ?>" class="form-horizontal" enctype="multipart/form-data">
    ...
    <div class="modal fade " id="modal-add-appraisal_note">
      <div class="modal-dialog" style="width: 900px;">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <form id="appraisal-form" method="POST" action="<?php echo e(url('/branchadmin/appraisal-note/save')); ?>" class="form-horizontal" enctype="multipart/form-data">
            <input type="hidden" name="staff_id" value="<?php echo e($datas['staff_id']); ?>">
            
            <?php echo csrf_field(); ?>

            
            <div class="modal-body">
              <?php foreach($datas['appraisal_category'] as $acategory): ?>
              <?php ($dis = ''); ?>
              <?php if($acategory->rating == 2): ?>
                <?php ($dis = 'display:none'); ?>
                <?php endif; ?>
              <div class="form-group">
                <label class="col-md-3"><?php echo e($acategory->title); ?></label>
                <div class="col-md-8"><textarea class="form-control" name="note[<?php echo e($acategory->id); ?>][remarks]" placeholder="Remarks"></textarea></div>
                <div class="col-md-1" style="<?php echo e($dis); ?>">
                  <input type="text" class="form-control" name="note[<?php echo e($acategory->id); ?>][rating]" placeholder="10">
                  <input type="hidden" name="note[<?php echo e($acategory->id); ?>][hide_staff]" value="<?php echo e($acategory->hide_staff); ?>">
                </div>
              </div>
    ...
    <div class="modal fade " id="modal-edit-appraisal_note">
      <div class="modal-dialog" style="width: 900px;">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          ...
          <form id="appraisal-form" method="POST" action="<?php echo e(url('/branchadmin/appraisal-note/update')); ?>" class="form-horizontal" enctype="multipart/form-data">
            <input type="hidden" name="staff_id" value="<?php echo e($datas['staff_id']); ?>">
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                <label class="col-md-3" id="note_category"></label>
                <div class="col-md-8"><textarea class="form-control" id="note_remarks" name="note_remarks" required="required" placeholder="Remarks"></textarea></div>
                <div class="col-md-1" id="rating_note" style="display: none;">
                  <input type="text" class="form-control" id="note_rating" name="note_rating" placeholder="10" value="">
    ...
    <div class="modal fade " id="modal-warning">
      <div class="modal-dialog" style="width: 900px;">
        <div class="modal-content">
          ...
          <form id="performance-form" method="POST" action="<?php echo e(url('/branchadmin/warning/save')); ?>" class="form-horizontal" enctype="multipart/form-data">
            <input type="hidden" name="staff_id" id="warning_staff_id" value="<?php echo e($datas['staff_id']); ?>">
            <input type="hidden" name="warning_id" id="warning" value="">
            <?php echo csrf_field(); ?>

            
            <div class="modal-body">
                 <div class="form-group">
                <label class="col-md-12">Warning Title</label>
                <div class="col-md-12"><input type="text" class="form-control" id="warning_title" name="warning_title" required="reqired"></div>
              </div>
              <div class="form-group">
                <label class="col-md-12">Warning Detail</label>
                <div class="col-md-12"><textarea class="form-control" name="warning_detail" id="warning_detail" required="required"></textarea></div>
              </div>
  ...
  <div class="modal fade" id="modal-helpcomplete">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form id="job-form" method="POST" action="<?php echo e(url('/branchadmin/help_desk/complete')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body">
  ...
  <div class="modal fade" id="modal-default">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form id="job-form" method="POST" action="<?php echo e(url('/branchadmin/task/saveJob')); ?>" class="form-horizontal" enctype="multipart/form-data">
              ...
              <div class="modal-body">
                ...
                <div class="box-footer" style="">
                    ...
                    <div class="input-group">
                      ...
                      <span class="input-group-btn">
                            <button type="button" onClick="sendMessage()" class="btn sendbtn">Send</button>
                          </span>
                    </div>
...
<div class="modal fade" id="modal-add-skill">
          <div class="modal-dialog skill_add">
            <div class="modal-content">
              ...
              <form id="skill_form" method="POST" action="<?php echo e(url('/branchadmin/skill/add')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body">
               ...
               <div id="ad_skills">
                <div class="row mb20" id="row-0">
                 ...
                 <div class="col-md-1"><button class="btn deletebtn" onclick="$('#row-0').remove();" data-toggle="tooltip" title="remove"><i class="fa fa-minus-circle"></i> Delete</button> </div>
  ...
  <div class="modal fade" id="modal-add-kra">
          <div class="modal-dialog kra_add">
            <div class="modal-content">
              ...
              <form id="kra_form" method="POST" action="<?php echo e(url('/branchadmin/kra/add')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body">
               ...
               <div id="ad_kras">
                <div class="row mb20" id="kra_row-0">
                 ...
                 <div class="col-md-2"><button class="btn deletebtn" onclick="$('#kra_row_0').remove();" data-toggle="tooltip" title="remove"><i class="fa fa-minus-circle"></i> Remove</button> </div>
        ...
        <div class="modal fade" id="modal-add-kpi">
          <div class="modal-dialog kpi_add">
            <div class="modal-content">
              ...
              <form id="kpi_form" method="POST" action="<?php echo e(url('/branchadmin/kpi/add')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body">
...
<script type="text/javascript">
  ...
  function approve(div,id,self_mark,task_title,h_date,s_date) {
    $('#'+div+' #task_id').val(id);
...
function addSkill() {
  var html = '<div class="row mb20" id="row-'+skill_add_row+'"><div class="col-md-5"><input class="form-control" name="skill['+skill_add_row+'][title]" type="text" placeholder="Skill title" required="required"></div>';
      ...
      html += '<div class="col-md-1"><button class="btn btn-danger" onclick="$(\'#row-'+skill_add_row+'\').remove();" data-toggle="tooltip" title="remove"><i class="fa fa-minus-circle"></i> Delete</button> </div></div>';
...
function deleteSkill(id) {
  ...
  if (id != '') {
     $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/branchadmin/skill/delete")); ?>',
            data: 'id='+id+'&_token='+token,
            cache: false,
            success: function(html){
              var datas = html.split('|');
...
function addkra() {
  var html = '<div class="row mb20" id="kra_row_'+kra_row+'"><div class="col-md-8"><input class="form-control" name="kra['+kra_row+'][title]" type="text" placeholder="kra title" required="required"></div>';
      ...
      html += '<div class="col-md-2"><button class="btn deletebtn" onclick="$(\'#kra_row_'+kra_row+'\').remove();" data-toggle="tooltip" title="remove"><i class="fa fa-minus-circle"></i> Remove</button> </div></div>';
...
function deletekra(id) {
  ...
  if (id != '') {
     $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/branchadmin/kra/delete")); ?>',
            data: 'id='+id+'&_token='+token,
            cache: false,
            success: function(html){
              var datas = html.split('|');
...
function delKpi(id) {
  ...
  if (id != '') {
     $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/branchadmin/kpi/delete")); ?>',
            data: 'id='+id+'&_token='+token,
            cache: false,
            success: function(html){
              var datas = html.split('|');
...
<script type="text/javascript">
  function acceptHelp(id) {
      ...
      var url= "<?php echo e(url('/branchadmin/help_desk/accept/')); ?>/"+id;
      location = url;
...
<script type="text/javascript">
  function helpChatModal(div,help_id)
    ...
    $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/branchadmin/help_desk/getmessage")); ?>',
...
<script type="text/javascript">
  function sendHelpMessage() {
    ...
    if (message != '') {
      $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/branchadmin/help_desk/message")); ?>',
            data: 'message='+message+'&_token='+token+'&id='+id,
            cache: false,
            success: function(html){
              var datas = html.split('|');
...
<script type="text/javascript">
  ...
  timer = setInterval(function() {
    if ($('#form-upload #file').val() != '') {
      ...
      $.ajax({
        url: '<?php echo e(url("/branchadmin/help_desk/uploadchat/")); ?>',
        type: 'post',
...
<div class="modal fade" id="modal-add-kpa">
          <div class="modal-dialog kpa_add">
            <div class="modal-content">
              ...
              <form id="kpa_form" method="POST" action="<?php echo e(url('/branchadmin/kpa/save')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body">
               ...
               <div id="ad_kpas">
                <div class="row cm10-row mb20" id="kpa_row_0">
                  <div class="col-md-10"><input class="form-control" name="kpa[0][title]" type="text" placeholder="kpa title" required="required"></div>
                 <div class="col-md-2"><button class="btn deletebtn" onclick="$('#kpa_row_0').remove();" data-toggle="tooltip" title="remove"><i class="fa fa-minus-circle"></i> Remove</button> </div>
...
<script type="text/javascript">
  ...
  function addMoreKpa() {
    ...
    var html = '<div class="row mb20" id="kpa_row_'+row_id+'"><div class="col-md-10"><input class="form-control" name="kpa['+row_id+'][title]" type="text" placeholder="kpa title" required="required"></div>';
        html += '<div class="col-md-2"><button class="btn deletebtn" onclick="$(\'#kpa_row_'+row_id+'\').remove();" data-toggle="tooltip" title="remove"><i class="fa fa-minus-circle"></i></button> Remove</div></div>';
  ...
  if (id != '') {
     $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/branchadmin/kpa/delete")); ?>',
            data: 'id='+id+'&_token='+token,
            cache: false,
            success: function(html){
              var datas = html.split('|');
...
<script type="text/javascript">
  function editKra(id) {
    ...
    $('#kpa_edit_form').attr('action', '<?php echo e(url("/branchadmin/kra/update")); ?>');
   ...
   function editKPa(id) {
    ...
    $('#kpa_edit_form').attr('action', '<?php echo e(url("/branchadmin/kpa/update")); ?>');
    $('#modal-edit-kpa').modal('show');
  }
</script>
 <script type="text/javascript">
    ...
    {
    var url = '<?php echo e(url("/branchadmin/performance/save")); ?>';
    $('#performance-form').attr('action', url);
    $('#modal-performance').modal('show');
    }
    function editPerformance(id,comment,rating)
    {
    var url = '<?php echo e(url("/branchadmin/performance/update")); ?>';
    $('#performance-form').attr('action', url);
    ...
    var url= "<?php echo e(url('/branchadmin/performance/delete/')); ?>/"+id;
    location = url;
   ...
   $(function () {
    ...
    $('.datepicker').datepicker({
        onSelect: function(date) {
          ...
          var filter_task_from = $('#filter_task_from').val();
          var filter_task_to = $('#filter_task_to').val();
          var filter_task_ratio = $('#filter_task_ratio').val();
          var url = '<?php echo e(url("branchadmin/otstaff/reports")); ?>/<?php echo e($datas["staff_id"]); ?>?';
          if (filter_task_ratio != '') {
            url += '&filter_task_ratio='+filter_task_ratio;
          }
          if (filter_task_from != '') {
              url += '&filter_task_from='+filter_task_from;
             }
             if (filter_task_to != '') {
              url += '&filter_task_to='+filter_task_to;
             }
            location = url;
    ...
    $('.help_datepicker').datepicker({
        onSelect: function(date) {
            
          var filter_help_from = $('#filter_help_from').val();
          var filter_help_to = $('#filter_help_to').val();
          var filter_help_ratio = $('#filter_help_ratio').val();
          var url = '<?php echo e(url("branchadmin/otstaff/reports")); ?>/<?php echo e($datas["staff_id"]); ?>?tab=help';
          if (filter_help_ratio != '') {
            url += '&filter_help_ratio='+filter_help_ratio;
          }
          if (filter_task_from != '') {
              url += '&filter_help_from='+filter_help_from;
             }
             if (filter_task_to != '') {
              url += '&filter_help_to='+filter_help_to;
             }
            location = url;
...
$('#filter_help_ratio').on('change', function(){
            var filter_help_from = $('#filter_help_from').val();
          var filter_help_to = $('#filter_help_to').val();
          var filter_help_ratio = $('#filter_help_ratio').val();
          var url = '<?php echo e(url("branchadmin/otstaff/reports")); ?>/<?php echo e($datas["staff_id"]); ?>?tab=help';
...
$('#filter_task_ratio').on('change', function(){
            var filter_task_from = $('#filter_task_from').val();
          var filter_task_to = $('#filter_task_to').val();
          var filter_task_ratio = $('#filter_task_ratio').val();
          var url = '<?php echo e(url("branchadmin/otstaff/reports")); ?>/<?php echo e($datas["staff_id"]); ?>?tab=task';
          if (filter_task_ratio != '') {
            url += '&filter_task_ratio='+filter_task_ratio;
          }
          if (filter_help_from != '') {
  ...
  $(function() {
   ...
   $('.attendance_datepicker').datepicker({
        onSelect: function(date) {
          ...
          var filter_attendance_from = $('#filter_attendance_from').val();
          var filter_attendance_to = $('#filter_attendance_to').val();
         
          
          var url= "<?php echo e(url('/branchadmin/otstaff/reports/')); ?>/<?php echo e($datas['staff_id']); ?>?tab=attendance";
          
          if (filter_attendance_from != '') {
              url += '&filter_attendance_from='+filter_attendance_from;
             }
             if (filter_attendance_to != '') {
              url += '&filter_attendance_to='+filter_attendance_to;
             }
            
            location = url;
        }
    });
    $('.sbt_datepicker').datepicker({
        onSelect: function(date) {
          var filter_sbt_from = $('#filter_sbt_from').val();
          var filter_sbt_to = $('#filter_sbt_to').val();
          var url= "<?php echo e(url('/branchadmin/otstaff/reports/')); ?>/<?php echo e($datas['staff_id']); ?>?tab=sbt";
          
          if (filter_sbt_from != '') {
              url += '&filter_sbt_from='+filter_sbt_from;
             }
             if (filter_sbt_to != '') {
              url += '&filter_sbt_to='+filter_sbt_to;
             }
...
<script type="text/javascript">
  function viewMeeting(meeting_date,staff_id) {
    var token = $('input[name=\'_token\']').val();
    $.ajax({
      type: 'POST',
      url: '<?php echo e(url("/branchadmin/attendance/view-meeting")); ?>',
      data: '_token='+token+'&meeting_date='+meeting_date+'&staff_id='+staff_id,
      cache: false,
      success: function(html){
       $('#meeting-body').html(html);
...
<script type="text/javascript">
    ...
    $(element).popover({
      ...
      trigger: 'manual',
      content: function() {
        return '<span class="label label-block label-danger">Deadline Crossed 0.2/day</span><br><span class="label label-block label-primary">Early Bonus 0.2/day</span><br><span class="label label-block label-success">Task Bonus 0.05/Task</span>';
      }
    });
...
<script type="text/javascript">
  function editNote(title,rating,shide,note,id) {
    $('#note_category').html(title);
    $('#note_rating').val(rating);
    $('#note_remarks').val(note);
    $('#note_id').val(id);
    if (rating > 0) {
      $('#rating_note').fadeIn();
    } else{
    ...
    $('#modal-edit-appraisal_note').modal('show');
  }

  $(document).delegate('#best_employee', 'click', function(e) {
    e.preventDefault();
    ...
    $(element).popover({
      ...
      trigger: 'manual',
      content: function() {
        return '<?php foreach($datas["voting"] as $voting): ?> <p><?php echo e($voting["name"]); ?></p> <?php endforeach; ?>';
      }
    });
...
<script>
  $('select#filter_productivity_month').change(function(){
    ...
    var staff_id = '<?php echo e($datas["staff_id"]); ?>'
    var url = '<?php echo e(url("/branchadmin/otstaff/reports")); ?>'+'/'+staff_id+'?tab=productivity&filter_productivity_month='+filter_productivity_month+'&filter_productivity_year='+filter_productivity_year;
    location = url;
  });
  ...
  $('#exportProductivityBtn').click(function(){
    ...
    var filter_productivity_month = $('#filter_productivity_month').val();
    var staff_id = '<?php echo e($datas["staff_id"]); ?>'
    var url = '<?php echo e(url("/branchadmin/otstaff/reports/export")); ?>'+'/'+staff_id+'?tab=productivity&filter_productivity_month='+filter_productivity_month+'&filter_productivity_year='+filter_productivity_year;
    location = url;
  })
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body" id="contract-body">
          <form action="<?php echo e(url('/branchadmin/otstaff/contract/'.$datas['staff_id'])); ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body" id="contract-body">
          <form action="<?php echo e(url('/branchadmin/otstaff/contract/'.$datas['staff_id'].'/update')); ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
...
<script>
  ...
  $('#terminationSubmit').click(function(){
    ...
    $.ajax({
      type: 'POST',
      url: '<?php echo e(url("/branchadmin/ajaxStaffTermination")); ?>',
      data: {
        _token : token,
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body" id="contract-body">
          <form action="<?php echo e(url('/branchadmin/saveServiceHistory')); ?>" method="post">
            <?php echo csrf_field(); ?>
