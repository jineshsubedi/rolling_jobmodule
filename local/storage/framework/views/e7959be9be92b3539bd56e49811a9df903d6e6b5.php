...
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            ...
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo e(route('branchadmin.emp_history.update', [$adjustment_staff->id, $history->id])); ?>"
                    method="post">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group <?php echo e($errors->has('type') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" id="type" name="type">
                                    ...
                                    <option value="5" <?php if($history->type==5): ?> selected <?php endif; ?>>Salary Increment</option>
                                    <option value="6" <?php if($history->type==6): ?> selected <?php endif; ?>>Salary Revised</option>
                                </select>
    ...
    $(document).ready(function(){
        ...
        function typeChange(type)
        {
            ...
            if(type == 3)
            {
                ...
                var previousHtml = '<select id="previous_select" name="previous" class="form-control"><option value="<?php echo e($history->previous); ?>"><b><?php echo e($history->previous); ?></b></option>';
                for(var i=0; i<=designations.length; i++){
                    previousHtml += '<option value="'+designations[i]+'" >'+designations[i]+'</option>';
                }
                previousHtml += '</select>';
                var currentHtml = '<select id="current_select" name="current" class="form-control"><option value="<?php echo e($history->previous); ?>"><b><?php echo e($history->current); ?></b></option>';
                for(var i=0; i<=designations.length; i++){
