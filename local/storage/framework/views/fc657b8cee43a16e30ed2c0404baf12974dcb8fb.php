    ...
    <div class="col-xs-12">
        ...
        <div class="box">
            <div class="box-header with-border">
                ...
                <a href="<?php echo e(route('staffs.emp_history.create',Request::segment(4))); ?>" class="btn refreshbtn right btm10m"><i
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form
                                    action="<?php echo e(route('staffs.emp_history.delete',[$staff->id,$history->id])); ?>"
                                    method="post">
                                    <?php echo csrf_field(); ?>

                                    <?php echo e(method_field('DELETE')); ?>

                                    <a href="<?php echo e(route('staffs.emp_history.edit',[$staff->id,$history->id])); ?>"
