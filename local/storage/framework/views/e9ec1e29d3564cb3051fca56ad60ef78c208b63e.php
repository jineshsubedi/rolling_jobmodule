...
<?php $__env->startSection('breadcrubm'); ?>
 <li><a href="<?php echo e(url('/staffs')); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="<?php echo e(url('/staffs/department')); ?>">Department</a></li>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Edit Department</div>
                  <div class="panel-body">
                    <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(url('/staffs/department/update')); ?>" enctype="multipart/form-data">
...
<script type="text/javascript">
  ...
  function removeData(id,row){
    ...
    if (id != '') {
       $.ajax({
            type: "POST",
            url: "<?php echo e(url('staffs/department/removedesignation')); ?> ",
