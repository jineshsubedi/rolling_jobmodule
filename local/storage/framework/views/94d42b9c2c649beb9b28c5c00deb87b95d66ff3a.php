...
<div class="row">
  <div class="col-xs-12">
    <div class="row">
      <div class="col-md-12">
        <a href="<?php echo e(route('staffs.training-setup.create')); ?>" class="btn refreshbtn right btm10m"><i
      ...
      <div class="box-body">
        <table class="table table-borderd">
            ...
            <tr>
                ...
                <td>
                    <form action="<?php echo e(route('staffs.training-setup.destroy', $t->id)); ?>" method="post">
                    <?php echo csrf_field(); ?>

                    <?php echo method_field('DELETE'); ?>

                        <a href="<?php echo e(route('staffs.training-setup.show', $t->id)); ?>" class="btn btn-info"><i class="fa fa-eye"></i></a>
                        <a href="<?php echo e(route('staffs.training-setup.edit', $t->id)); ?>" class="btn btn-info"><i class="fa fa-edit"></i></a>
    ...
    $(function() {
      $('#start_date').datepicker({
        onSelect: function(date) {
          ...
          var url = '<?php echo e(url("staffs/training-setup/")); ?>?';
          if (page != '') {
            url += '&page='+page;
          }
          if (start_date != '') {
