                ...
                <form method="post" id="fileUploadForm" enctype="multipart/form-data">
                    ...
                    <div id="post_status">
                        <div class="col-sm-12" id="new_status">
                            <ul class="navbar-nav col-lg-12" id="post_header" role="navigation">
                                <li><a href="#"><span class="glyphicon glyphicon-pencil"></span>New Status</a>
                                </li>
                                <li><a href="#" id="uploadPictureBtn"><span class="glyphicon glyphicon-picture"></span>Add Photos</a>
                                </li>
...
<script>
    ...
    $(document).ready(function(){   //save post
        $('form').submit(function(event){
            ...
            $.ajax({
                url: "<?php echo e(route('staffs.newsfeed.savePost')); ?>",
                data: formData,
                type: 'POST',
                dataType: 'JSON',
                processData: false,
    ...
    function loadNewsfeed(page)
    {
        $('#loading').show();
        $.ajax({
            url: "<?php echo e(route('staffs.newsfeed.getPosts')); ?>?page="+page,
            data:{
                _token: token,
                page: page
            },
    ...
    function togglePostLike(id){
        $.ajax({
            url: "<?php echo e(route('staffs.newsfeed.togglePostLike')); ?>",
            data:{
                _token: token,
                id: id
            },
    ...
    {
        $.ajax({  
            url: "<?php echo e(route('staffs.newsfeed.getPostStat')); ?>",
            data:{
                _token: token,
                id: id
            },
    ...
    {
        $.ajax({
            url: "<?php echo e(route('staffs.newsfeed.submitComment')); ?>",
            data:{
                _token: token,
                id: id,
    ...
    {
        $.ajax({
            url: "<?php echo e(route('staffs.newsfeed.getCommentByUser')); ?>",
            data:{
                _token: token,
                id: id,
            },
    ...
    {
        $.ajax({
            url: "<?php echo e(route('staffs.newsfeed.getAllCommentByUser')); ?>",
            data:{
                _token: token,
                id: id,
            },
    ...
    function deleteNewsFeed(id)
    {
        ...
        if(check == true){
            $.ajax({
                url: "<?php echo e(route('staffs.newsfeed.deleteNewsFeedPost')); ?>",
                data:{
                    _token: token,
                    id: id,
                },
    ...
    function deleteComment(id)
    {
        ...
        if(check == true){
            $.ajax({
                url: "<?php echo e(route('staffs.newsfeed.deleteComment')); ?>",
                data:{
                    _token: token,
                    id: id,
                },
    ...
    {
       $.ajax({
            url: "<?php echo e(route('staffs.newsfeed.postCommentByUser')); ?>",  //post edit
            data:{
                _token: token,
                id: id,
...
<script>
    ...
    $('#eventSubmitBtn').click(function(){
        ...
        $('#mesageError').text('')
        $.ajax({
            url: "<?php echo e(route('staffs.newsfeed.event')); ?>",
            data:{
                _token: token,
                category: category,
                staff: staff,
