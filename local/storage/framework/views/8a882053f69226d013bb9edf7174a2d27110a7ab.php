    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('branchadmin.travel.supervisorApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="approveAccountModel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('branchadmin.travel.accountApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="approveHrModel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('branchadmin.travel.hrApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="approveChairmanModel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('branchadmin.travel.chairmanApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
