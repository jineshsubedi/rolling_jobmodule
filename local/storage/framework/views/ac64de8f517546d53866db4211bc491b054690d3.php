...
Dashboard
<span class="blueclr">Detail of <span class="bold"> <?php echo e($data['user']->name); ?></span></span>
...
<?php if(\App\BranchSetting::getCanteen(auth()->guard('staffs')->user()->branch) != auth()->guard('staffs')->user()->department): ?>
<style>
    #box-body{
        max-height:200px;
        overflow-y:scroll;
            ...
            <div class="col-md-12">
              ...
              <script>
                $(document).ready(function(){
                  ...
                  $.ajax({
                    type: "GET",
                    url: "<?php echo e(route('staffs.checkReminderForSticky')); ?>",
                    data: {
                      _token : token,
...
<div class="tp10m comnbg eventsupdate">
        ...
        <div class="row cm10-row">
          ...
          <div class="col-lg-3 col-xs-6">
            <div class="common_block">
              ...
              <div class="listpadding">
                <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="#" data-toggle="modal" data-target="#modal-absent">Abscent: <span class="bold"><?php echo e(count($data['absent_staff'])); ?></span></a></span>
              </div>
              <div class="listpadding">
          ...
          <div class="col-md-6">
            <div class="common_block">
                ...
                <div class="listpadding">
                  <span>
                    <icon class="fa  fa-check-square-o greenclr"></icon> 
                    <a href="<?php echo e(url('/staffs/tasks')); ?>"> Not Accepted: <span class="bold"><?php echo e($data['notaccepted_task']); ?></span></a>
                  </span>
                </div>
                <div class="listpadding">
                  <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('/staffs/tasks?status=0')); ?>">In Process: <span class="bold"><?php echo e($data['inprocess_task']); ?></span></a></span>
                </div>
                <div class="listpadding">
                  <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('/staffs/tasks?status=2')); ?>">Deadline Crossed: <span class="bold"><?php echo e($data['crossed_task']); ?></span></a></span>
                </div>
                <div class="listpadding">
                  <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('/staffs/tasks?status=1')); ?>">Completed: <span class="bold"><?php echo e($data['completed_task']); ?></span></a></span>
                </div>
              </div>
          </div>
          <div class="col-md-6">
            <div class="common_block">
              ...
              <div class="listpadding">
                  <span>
                    <icon class="fa  fa-check-square-o greenclr"></icon> 
                    <a href="<?php echo e(url('/staffs/tasks')); ?>"> Not Accepted: <span class="bold"><?php echo e($data['notaccepted_help']); ?></span></a>
                  </span>
                </div>
                <div class="listpadding">
                  <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('/staffs/tasks?status=0')); ?>">In Process: <span class="bold"><?php echo e($data['inprocess_help']); ?></span></a></span>
                </div>
                <div class="listpadding">
                  <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('/staffs/tasks?status=2')); ?>">Deadline Crossed: <span class="bold"><?php echo e($data['crossed_help']); ?></span></a></span>
                </div>
                <div class="listpadding">
                  <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('/staffs/tasks?status=1')); ?>">Completed: <span class="bold"><?php echo e($data['completed_help']); ?></span></a></span>
                </div>
            </div>
          </div>
        </div>
    ...
    <div class="modal fade" id="modal-meeting">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form id="decline_form" method="POST" action="<?php echo e(url('/staffs/attendance/meeting')); ?>" class="form-horizontal" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<script type="text/javascript">
    ...
    if(confirm('Do You Want To Delete This data?')){
      var url= "<?php echo e(url('/staffs/adjustment/delete/')); ?>"+ids;
      location = url;
    ...
    if(confirm('Do You Want To Approve This Request?')){
      var url= "<?php echo e(url('/staffs/adjustment/approve/')); ?>"+ids;
      location = url;
    ...
    if(confirm('Do You Want To Dismiss This Request?')){
      var url= "<?php echo e(url('/staffs/adjustment/dismiss/')); ?>"+ids;
      location = url;
  ...
  <script type="text/javascript">
    ...
    if(confirm('Do You Want To Delete This data?')){
      var url= "<?php echo e(url('/staffs/otrequest/delete/')); ?>"+ids;
      location = url;
  ...
  function confirmApprove(ids){
    if(confirm('Do You Want To Approve This Request?')){
      var url= "<?php echo e(url('/staffs/otrequest/approve/')); ?>"+ids;
      location = url;
    ...
    if(confirm('Do You Want To Dismiss This Request?')){
      var url= "<?php echo e(url('/staffs/otrequest/dismiss/')); ?>"+ids;
      location = url;
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
   function viewLeave(id) {
     var token = $('input[name=\'_token\']').val();
        $.ajax({
             type: 'POST',
                url: '<?php echo e(url("/staffs/leaverequest/getDetail")); ?>',
   ...
   function SUApprove(id){
    if(confirm('Are you sure you want to Approve this?')){
      var url= "<?php echo e(url('/staffs/leaverequest/supervisor_approve/')); ?>"+id;
      location = url;
    ...
    if(confirm('Are you sure you want to Approve this?')){
      var url= "<?php echo e(url('/staffs/leaverequest/hr_approve/')); ?>"+id;
      location = url;
    ...
    if(confirm('Are you sure you want to decline this?')){
      $('#decline_id').val(id);
      $('#decline_form').attr('action','<?php echo e(url("/staffs/leaverequest/supervisor_decline")); ?>')
    ...
    if(confirm('Are you sure you want to decline this?')){
      $('#decline_id').val(id);
      $('#decline_form').attr('action','<?php echo e(url("/staffs/leaverequest/hr_decline")); ?>')
      $('#modal-decline').modal('show');
 ...
 <script type="text/javascript">
    ...
    $.ajax({
    type: 'POST',
    url: '<?php echo e(url("/staffs/attendance/intime")); ?>',
    ...
    $.ajax({
    type: 'POST',
    url: '<?php echo e(url("/staffs/attendance/lunch-start")); ?>',
    data: '_token='+token+'&location='+location,
    cache: false,
    success: function(html){
    if (html == 'Success') {
    ...
    function submitLunchIn() {
        if(confirm('Are you sure you are back from lunch?')){
    var token = $('input[name=\'_token\']').val();
    var location = $('#geo_location').val();
    $.ajax({
    type: 'POST',
    url: '<?php echo e(url("/staffs/attendance/lunch-end")); ?>',
    data: '_token='+token+'&location='+location,
    cache: false,
    success: function(html){
    if (html == 'Success') {
    ...
    function submitOuttime() {
        if(confirm('Are you sure your duty is finish?')){
      var token = $('input[name=\'_token\']').val();
      var location = $('#geo_location').val();
      $.ajax({
        type: 'POST',
        url: '<?php echo e(url("/staffs/attendance/outtime")); ?>',
        data: '_token='+token+'&location='+location,
        cache: false,
        success: function(html){
        if (html == 'Success') {
     ...
     function submitOutMeeting() {
        ...
        var location = $('#geo_location').val();
          $.ajax({
            type: 'POST',
            url: '<?php echo e(url("/staffs/attendance/meeting-out")); ?>',
            data: '_token='+token+'&location='+location,
            cache: false,
            success: function(html){
              if (html == 'Success') {
    ...
    function submitInMeeting(id) {
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo e(url("/staffs/attendance/meeting-back")); ?>',
    ...
    function addSticker() {
      var token = $('input[name=\'_token\']').val(); 
            ...
            $.ajax({
              type: 'POST',
              url: '<?php echo e(url("/staffs/stikynote/save")); ?>',
    ...
    function removeSticker(id) {
      if(confirm('Do You Want To Delete This Sticker Note?')){
         ...
         $.ajax({
              type: 'POST',
              url: '<?php echo e(url("/staffs/stikynote/delete")); ?>',
              data: '_token='+token+'&id='+id,
              cache: false,
              success: function(id){
                $('#mydiv_'+id).remove();
    ...
    function updateSticker(id) {
       var token = $('input[name=\'_token\']').val();
        ...
        var detail = $('#sticker_'+id).val();
         $.ajax({
              type: 'POST',
              url: '<?php echo e(url("/staffs/stikynote/update")); ?>',
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
               ...
               <form id="time-edit-form" method="POST" action="<?php echo e(url('/staffs/daily-routine/save')); ?>" class="form-horizontal" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<script type="text/javascript">
  ...
  $('.time-bar').on('click', function()
  {
    ...
    var from_date = '<?php echo e(date("Y-m-d")); ?>'
     ...
     $('#time-edit-form').attr('action','<?php echo e(url("/staffs/daily-routine/save")); ?>');
     $('#to_time').val('');
     $('#description').val('');
...
<script type="text/javascript">
  function deleteTimeData(id,type) {
    if(confirm('Do You Want To Delete This Work Plan?')){
     ...
     $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/staffs/daily-routine/task-delete/")); ?>',
  ...
  $('.time-box').on('click', function(){
    ...
    if (type == 'Daily') {
     ...
     $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/staffs/daily-routine/edit/")); ?>',
            data: '_token='+token+'&id='+id,
            cache: false,
            success: function(html){
             if (html != '') {
              ...
              $('#time-edit-form').attr('action','<?php echo e(url("/staffs/daily-routine/update")); ?>');
              $('#to_time').val(datas[3]);
...
<div class="modal fade bd-example-modal-lg" id="in_time_reason_model">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body" id="attendance-body">
        <form action="<?php echo e(url('/staffs/attendance/intimereason')); ?>" method="post">
          <?php echo csrf_field(); ?>
...
<div class="modal fade bd-example-modal-lg" id="out_time_reason_model">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body" id="attendance-body">
        <form action="<?php echo e(url('/staffs/attendance/outtimereason')); ?>" method="post">
          <?php echo csrf_field(); ?>
...
<script type="text/javascript">
 ...
 <?php /* subordinate section */ ?>
  ...
  <footer class="tp10p">
        ...
        <span>Copyright &copy; 2014-<?php echo e(date('Y')); ?> <a target="_blank" class="greenclr" href="http://www.rollingplans.com.np">Rolling Plans Pvt. Ltd.</a>. All rights reserved.</span>
  ...
  <script>
    ...
    $.ajax({
        type: 'GET',
        url: '<?php echo e(route("staffgetStaffsTask")); ?>',
        data: '_token='+token,
        cache: false,
        success: function(data){
          var users = data.msg
  ...
  <script>
    var token = $("input[name=\"_token\"]").val();
      ...
      function staffgetMessageAjax(id){
        $.ajax({
          type: "GET",
          url: "<?php echo e(route('staffgetMessageOnDailyTask')); ?>",
      ...
      function staffdeletemessageBtn(id)
      {
        $.ajax({
          type: "POST",
          url: "<?php echo e(route('staffdeleteMessageOnDailyTask')); ?>",
          data: "_token="+token+"&task_id="+id,
          cache: false,
          success: function(data){
            console.log(data)
  ...
  <script>
    $(document).ready(function(){
      ...
      $.ajax({
          type: 'GET',
          url: '<?php echo e(route("supervisor.getSupervisorStaffs")); ?>',
          data: '_token='+token,
          cache: false,
          success: function(data){
            var users = data.msg
  ...
  <script>
    var token = $("input[name=\"_token\"]").val();
      ...
      function getMessageAjax(id){
        $.ajax({
          type: "GET",
          url: "<?php echo e(route('supervisor.getMessageOnDailyTask')); ?>",
          data: "_token="+token+"&task_id="+id,
          cache: false,
          success: function(data){
            var tasks = data.msg;
      ...
      function deletemessageBtn(id)
      {
        $.ajax({
          type: "POST",
          url: "<?php echo e(route('supervisor.deleteMessageOnDailyTask')); ?>",
          data: "_token="+token+"&task_id="+id,
          cache: false,
          success: function(data){
            console.log(data)
      ...
      function approveTask(staff_id)
      {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo e(route('supervisor.approveSelectedDailyTask')); ?>",
          ...
          success: function(data){
            ...
            $.ajax({
            type: "GET",
            url: "<?php echo e(route('supervisor.checkStaffsTask')); ?>",
            data: "_token="+token+"&staff_id="+staff_id,
            cache: false,
            success: function(data){
              console.log(data.msg)
  ...
  <script>
    ...
    function saveReminder()
    {
      $.ajax({
        type: "POST",
        url: "<?php echo e(route('staffs.saveReminder')); ?>",
        data: {
          _token : token,
          note_id : $('#note_id').val(),
    ...
    function stickyUpdateTitle(id)
    {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo e(route('staffs.saveStickyTitle')); ?>",
        data: {
          _token : token,
          id : id,
  ...
  <div class="modal fade bd-example-modal-lg" id="in_away_location_model">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body" id="attendance-body">
          <form action="<?php echo e(url('/staffs/attendance/clockin/away')); ?>" method="post">
            <?php echo csrf_field(); ?>
  ...
  <div class="modal fade bd-example-modal-lg" id="out_away_location_model">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body" id="attendance-body">
          <form action="<?php echo e(url('/staffs/attendance/clockout/away')); ?>" method="post">
            <?php echo csrf_field(); ?>
  ...
  $(document).ready(function(){
    ...
    $('#task_to').on('change', function () {
      ...
      if (id != '') {
        $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/staffs/tasks/getKra")); ?>',
            data: '_token='+token+'&id='+id,
            cache: false,
            success: function(html){
             $('#kra').html(html);
    ...
    $('#task_form').click(function(){
      $.ajax({
        type: 'POST',
          url: '<?php echo e(url("staffs/dashboard/tasks/savetask")); ?>',
          data: {
            _token : token,
            task_to : $('#task_to').val(),
            kra : $('#kra').val(),
    ...
    <div class="modal-content">
      ...
      <div class="model-body">
        <div class="row">
          ...
          <form action="<?php echo e(url('/staffs/probation_evaluation/'.$staff->id.'/reply')); ?>" method="post">
          <?php echo csrf_field(); ?>
...
<?php ($newsfeed = \App\NewsFeed::checkToStaff($nstaff->id)); ?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" id="welcome-staff-body">
          <form action="<?php echo e(url('/staffs/newstaff/welcome/comment')); ?>" method="post">
            <?php echo csrf_field(); ?>
...
<script>
  ...
  function cancelGreeting(id)
  {
    ...
    var url = "<?php echo e(url('staffs/newsfeed')); ?>"+'/'+id;
...
<script>
  function submitGreeting(id)
  {
    ...
    $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/staffs/newstaff/welcome/comment")); ?>',
            data: {
              _token: token,
