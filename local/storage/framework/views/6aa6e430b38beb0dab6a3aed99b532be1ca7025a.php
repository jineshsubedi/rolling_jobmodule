        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="<?php echo e(route('staffs.survey.action', $survey->survey_id)); ?>" class="btn btn-sm btn-info"> <i
                    class="fa fa-eye"></i></a>
                <a href="<?php echo e(route('staffs.survey.delete', $survey->survey_id)); ?>" class="btn btn-sm btn-warning" onclick="return confirm('Are you sure you want to delete?');"> <i class="fa fa-trash"></i></a>
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
