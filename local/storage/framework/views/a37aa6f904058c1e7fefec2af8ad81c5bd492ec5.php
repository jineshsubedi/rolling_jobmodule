...
<style type="text/css">
 ...
 <div class="row">
    <div class="col-xs-12">
      <div class="row">
        <a href="<?php echo e(url('/staffs/leaverequest/addnew')); ?>" class="btn refreshbtn right btm10m rt15m"><i class="fa fa-fw fa-plus"></i> Add Leave Request</a>
      </div>
                ...
                <?php endif; ?>
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td><a href="javascript:void(0);" onClick="filterData()" class="btn refreshbtn right btm10m rt15m">Filter <i class="fa fa-search"></i></a></td>
                        <?php endif; ?>
                    </tr>
                      <?php if(count($data['your_request']) > 0): ?>
                      <?php $i=1; 
  ...
  <div class="modal fade" id="modal-otherstaff">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form id="job-form" method="POST" action="<?php echo e(url('/staffs/leaverequest/updatehandover')); ?>" class="form-horizontal" enctype="multipart/form-data">
                 <?php echo csrf_field(); ?>
  ...
  <script type="text/javascript">
    ...
    if(confirm('Do You Want To Delete This Album?')){
      var url= "<?php echo e(url('/staffs/leaverequest/delete/')); ?>"+ids;
      location = url;
    ...
    function addHandover(id) {
       var token = $('input[name=\'_token\']').val();
        $.ajax({
             type: 'POST',
                url: '<?php echo e(url("/staffs/leaverequest/getStaffs")); ?>',
    ...
    if(confirm('Are you sure you want to Approve this?')){
      var url= "<?php echo e(url('/staffs/leaverequest/ch_approve/')); ?>/"+id;
      location = url;
    ...
    if(confirm('Are you sure you want to decline this?')){
      $('#decline_id').val(id);
      $('#decline_form').attr('action','<?php echo e(url("/staffs/leaverequest/ch_decline")); ?>')
      $('#modal-decline').modal('show');
    ...
    source: '<?php echo e(url("staffs/staffs/autocomplete/")); ?>',
          minlength:1,
          autoFocus:true,
          select:function(e,ui){
            var filter_from = $('#filter_from').val();
            var filter_to = $('#filter_to').val();
            var url = '<?php echo e(url("staffs/leaverequest/")); ?>?';
 ...
 <script>
  ...
  $('#supervisorApproveBtn').click(function(){
    ...
    if (r == true) {
      ...
      $.ajax({
          type: "POST",
          url: "<?php echo e(url('staffs/leaverequest/approveAll')); ?>",
  ...
  $('#supervisorCancelBtn').click(function(){
    ...
    if (r == true) {
      ...
      $.ajax({
          type: "POST",
          url: "<?php echo e(url('staffs/leaverequest/cancelAll')); ?>",
          data: "_token="+token+"&ids="+ids,
          cache: false,
          success: function(data){
            console.log(data)
 ...
 <script>
  ...
  function submitReply(id){
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo e(url('staffs/leaverequest/leavereply')); ?>",
  ...
  function deleteReply(id){
    $.ajax({
        type: "POST",
        url: "<?php echo e(url('staffs/leaverequest/leavereply/delete')); ?>",
        data: "_token="+token+"&id="+id,
        cache: false,
        success: function(data){
          console.log(data)
