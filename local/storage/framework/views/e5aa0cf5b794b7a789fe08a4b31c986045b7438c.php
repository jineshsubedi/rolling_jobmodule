    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Create Termination of Staff</h3>
            </div>
            <div class="box-body">
                <form class="form-horizontal" action="<?php echo e(route('supervisor.termination.storeTermination')); ?>"
                    method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <div id="termination_detail"
                        ...
                        <div class="input-form">
                            <div class="col-md-9">
                                <textarea id="description_termination" name="termination_detail"
                                    class="form-control @error('branch') is-invalid @enderror"
                                    value="<?php echo e(old('termination_detail')); ?>"></textarea>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
        ...
        // CKEDITOR.replace('description_termination');
    })
</script>
<?php $__env->stopSection(); ?>
