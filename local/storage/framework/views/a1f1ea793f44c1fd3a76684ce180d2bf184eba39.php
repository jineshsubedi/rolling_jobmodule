...
<style type="text/css">
 ...
 <div class="row">
    <div class="col-xs-12">
      <div class="row">
        <a href="<?php echo e(url('/supervisor/leaverequest/addnew')); ?>" class="btn btn-primary right"><i class="fa fa-fw fa-plus"></i>Add New Leave Request</a>
      </div>
      ...
      <div class="box">
            ...
            <?php $ts = count($data['waiting_sapproval']); $th = count($data['waiting_approval']); $total = $ts + $th; ?>
                ...
                <li class="active"><a href="#tab-your" data-toggle="tab">Your Requests</a></li>
            ...
            <div class="tab-pane active" id="tab-your">
         ...
         <div class="tab-pane" id="tab-supervisor">
                 <?php if(count($data['waiting_approval']) > 0 || count($data['waiting_sapproval']) > 0): ?>
                  <table class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th>S.N.</th>
                    ...
                    <tbody>
                      ...
                      <?php $i=1; 
                        ...
                        <td>
                            <?php echo $i++ ;?>
                            <input type="checkbox" class="checkItem" name="request_ids[]" value="<?php echo e($wap->id); ?>">
                            <input type="hidden" id="detail_<?php echo e($wap->id); ?>" value="<?php echo e($wap->description); ?>">
                        </td>
                        ...
                        <td>
                          ...
                          <?php endif; ?>
                          <?php if($wap->start_date >= date('Y-m-d')): ?>
                          <a href="javascript:void(0);" onClick="HRApprove('<?php echo e($wap->id); ?>')" class="btn btn-success left"><i class="fa fa-thumbs-up"></i></a>
                          <a href="javascript:void(0);" onClick="HRdecline('<?php echo e($wap->id); ?>')" class="btn btn-warning left"><i class="fa fa-thumbs-down"></i></a>
                          <?php endif; ?>
                      ...
                      <?php foreach ($data['waiting_chapproval'] as $waiting_chapproval) { 
                        ...
                        <td>
                            <?php echo $i++ ;?>
                            <input type="checkbox" class="checkItem" name="request_ids[]" value="<?php echo e($waiting_chapproval->id); ?>">
                            <input type="hidden" id="detail_<?php echo e($waiting_chapproval->id); ?>" value="<?php echo e($waiting_chapproval->description); ?>">
                        </td>
                        ...
                        <td>
                          ...
                          <a href="javascript:void(0);" onClick="CHdecline('<?php echo e($waiting_chapproval->id); ?>')" class="btn btn-warning left"><i class="fa fa-thumbs-down"></i></a>
                      ...
                      <?php foreach ($data['waiting_sapproval'] as $wsap) { 
                        ...
                        <td>
                            <?php echo $i++ ;?>
                            <input type="checkbox" class="checkItem" name="request_ids[]" value="<?php echo e($wsap->id); ?>">
                            <input type="hidden" id="detail_<?php echo e($wsap->id); ?>" value="<?php echo e($wsap->description); ?>">
                        </td>
                        ...
                        <td>
                          ...
                          <a href="javascript:void(0);" onClick="SUdecline('<?php echo e($wsap->id); ?>')" class="btn btn-warning left"><i class="fa fa-thumbs-down"></i></a>
  ...
  <div class="modal fade" id="modal-otherstaff">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form id="job-form" method="POST" action="<?php echo e(url('/supervisor/leaverequest/updatehandover')); ?>" class="form-horizontal" enctype="multipart/form-data">
                 <?php echo csrf_field(); ?>
  ...
  <script type="text/javascript">
    ...
    if(confirm('Do You Want To Delete This Album?')){
      var url= "<?php echo e(url('/supervisor/leaverequest/delete/')); ?>"+ids;
      location = url;
    ...
    function addHandover(id) {
       var token = $('input[name=\'_token\']').val();
        $.ajax({
             type: 'POST',
                url: '<?php echo e(url("/supervisor/leaverequest/getStaffs")); ?>',
    ...
    if(confirm('Are you sure you want to Approve this?')){
      var url= "<?php echo e(url('/supervisor/leaverequest/ch_approve/')); ?>/"+id;
      location = url;
    ...
    if(confirm('Are you sure you want to decline this?')){
      $('#decline_id').val(id);
      $('#decline_form').attr('action','<?php echo e(url("/supervisor/leaverequest/ch_decline")); ?>')
      $('#modal-decline').modal('show');
    ...
    source: '<?php echo e(url("supervisor/staffs/autocomplete/")); ?>',
          ...
          select:function(e,ui){
            ...
            var url = '<?php echo e(url("supervisor/leaverequest/")); ?>?';
...
<script>
  ...
  $('#supervisorApproveBtn').click(function(){
    ...
    if (r == true) {
      ...
      $.ajax({
          type: "POST",
          url: "<?php echo e(url('supervisor/leaverequest/approveAll')); ?>",
  ...
  $('#supervisorCancelBtn').click(function(){
    ...
    if (r == true) {
      ...
      $.ajax({
          type: "POST",
          url: "<?php echo e(url('supervisor/leaverequest/cancelAll')); ?>",
          data: "_token="+token+"&ids="+ids,
          cache: false,
          success: function(data){
            console.log(data)
...
<script>
  ...
  function submitReply(id){
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo e(url('supervisor/leaverequest/leavereply')); ?>",
  ...
  function deleteReply(id){
    $.ajax({
        type: "POST",
        url: "<?php echo e(url('supervisor/leaverequest/leavereply/delete')); ?>",
        data: "_token="+token+"&id="+id,
        cache: false,
        success: function(data){
          console.log(data)
