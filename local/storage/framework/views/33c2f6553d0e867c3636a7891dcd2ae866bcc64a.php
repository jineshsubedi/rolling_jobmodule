...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      ...
      <div class="box-body">
      <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(route('branchadmin.obstaff.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
  ...
  <script>
      ...
      $('#obType').change(function(){
        ...
        $.ajax({
            type: 'get',
            url: '<?php echo e(route("branchadmin.obstaff.getParticularByType")); ?>',
