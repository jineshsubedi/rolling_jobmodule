...
<?php $__env->startSection('content'); ?>
 <div class="row">
    <div class="col-xs-12">
      <div class="row">
          <a href="<?php echo e(url('/staffs/adjustment_staff/addnew')); ?>" class="btn addnew right"><i class="fa fa-fw fa-plus"></i>Add New Staff</a>
      </div>
      <div class="box">
            <div class="box-body">
                    ...
                    <tbody>
                      ...
                      <?php $i=1; 
                       ...
                       <td><?php echo \App\Adjustment_staff::getStatus($row->status);?></td>
                        <td>
                        <a href="<?php echo e(url('/staffs/adjustment_staff/edit/'.$row->id)); ?>" title="View or Edit" class="btn btn-primary left"><i class="fa fa-eye"></i> / <i class="fa fa-edit"></i></a>
                        ...
                        <a href="<?php echo e(url('/staffs/report?staff='.$row->id)); ?>" title="View or Edit" class="btn btn-primary left">Report</a>
                        <a href="<?php echo e(url('/staffs/adjustment_staff/history/'.$row->id)); ?>" class="btn btn-success left">History</a>
                        <a href="<?php echo e(url('/staffs/probation/'.$row->id.'/view')); ?>" title="View or Edit" class="btn btn-default left">Probation</a>
                        </td>
                      </tr>
                      <?php  }
                      ?>
  ...
  <script type="text/javascript">
    ...
    if(confirm('Do You Want To Delete This Staff?')){
      var url= "<?php echo e(url('/staffs/adjustment_staff/delete/')); ?>"+ids;
      location = url;
      
      }
    }
  function filterData(){
        var url= "<?php echo e(url('/staffs/adjustment_staff/?')); ?>";
