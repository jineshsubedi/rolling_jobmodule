...
<div class="row">
  <div class="col-xs-12">
    <div class="row">
      <div class="col-md-12">
        <a href="<?php echo e(route('supervisor.travel.planner.create')); ?>" class="btn refreshbtn right btm10m"><i
          ...
          <div class="tab-pane" id="planner">
            <table class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <td>
                  <form action="<?php echo e(route('supervisor.travel.planner.delete', $planner->id)); ?>" method="post">
                    <?php echo csrf_field(); ?>

                    <?php echo method_field('DELETE'); ?>

                    <a href="<?php echo e(route('supervisor.travel.planner.show', $planner->id)); ?>" class="btn btn-info"><i class="fa fa-eye"></i></a>
                    <a href="<?php echo e(route('supervisor.travel.planner.edit', $planner->id)); ?>" class="btn bg-orange"><i class="fa fa-edit"></i></a>
          ...
          <div class="tab-pane" id="approval">
            ...
            <tr>
              ...
              <td>
                ...
                <td>
                  <form action="<?php echo e(route('supervisor.travel.planner.supervisorApprove')); ?>" method="post">
                    <?php echo csrf_field(); ?>
