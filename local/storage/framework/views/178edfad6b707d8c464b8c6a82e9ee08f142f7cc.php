...
<div class="row">
  <div class="col-xs-12">
    <div class="row">
      <div class="col-md-12">
      <a href="<?php echo e(url('/supervisor/interview/addnew')); ?>" class="btn refreshbtn right btm10m"><i class="fa fa-plus-circle"></i> New Exit Interview</a>
    </div>
    </div>
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="<?php echo e(url('/supervisor/interview/edit/'.$row->id)); ?>" class="btn btn-primary left"><i class="fa fa-edit"></i></a>
                <a href="<?php echo e(url('/supervisor/interview/view/'.$row->id)); ?>" target="_blank" class="btn btn-success left"><i class="fa fa-eye"></i></a>
    ...
    <div>
      ...
      var url= "<?php echo e(url('/supervisor/interview/delete/')); ?>"+ids;
      location = url;
