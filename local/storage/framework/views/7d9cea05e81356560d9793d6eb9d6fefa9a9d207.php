                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <?php echo csrf_field(); ?>
                        ...
                        <td></td>
                        <td style="width:15%">
                        <a href="<?php echo e(url('/branchadmin/salary_sheet')); ?>" class="btn btn-success">All </a>
                      ...
                      <?php $i=1; 
                        ...
                        <td>
                          <a href="<?php echo e(url('/branchadmin/salary_sheet/'. $row->id)); ?>" class="btn btn-success left"><i class="fa fa-eye"></i>View</a>
                        </td>
                      </tr>
                      <?php  }
                      ?>
...
<script>
    $('select#filter_year').change(function(){
        ...
        var url= "<?php echo e(url('/branchadmin/salary_sheet?')); ?>";
        if (filter_year != '') {
