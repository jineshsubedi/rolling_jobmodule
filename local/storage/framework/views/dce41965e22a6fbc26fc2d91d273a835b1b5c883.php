...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      ...
      <div class="box-body">
      <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(route('supervisor.obstaff.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
       ...
       <div class="row">
            <div class="col-md-6" id="multiCategory">
                ...
                <div class="form-group<?php echo e($errors->has('from') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control datepicker" id="from" name="from" value="<?php echo e(old('from')); ?>" autocomplete="off">
                ...
                <div class="form-group<?php echo e($errors->has('to') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control datepicker" id="to" name="to" value="<?php echo e(old('to')); ?>" autocomplete="off">
