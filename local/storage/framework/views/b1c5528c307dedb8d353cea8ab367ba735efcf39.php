            ...
            <div class="box-header">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="<?php echo e(route('supervisor.termination.createTermination')); ?>" class="btn addnew right"><i
            ...
            <div class="box-body">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr <?php if($staff->staff_id==$setting->approve_person): ?> style="background-color:
                            #ddd6d6;"
                            <?php endif; ?>
                            <?php if(\App\DepartmentApproval::departmentApproval($staff->id,
                            'termination') && $staff->offBoarding_date!=NULL): ?>
                            ...
                            <td>
                                <form action="<?php echo e(route('supervisor.termination.deleteTermination',$staff->id)); ?>"
                                    method="post">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <a href="<?php echo e(route('supervisor.termination.editTermination',$staff->id)); ?>"
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?php echo e(route('supervisor.termination.justify',$staff->id)); ?>"
                                            method="post">
                                            <?php echo csrf_field(); ?>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <?php if($staff->status=='unprocess' && $staff->justification_date &&
                                        $setting->approve_person==auth()->guard('staffs')->user()->id): ?>
                                        <form action="<?php echo e(route('supervisor.termination.approval')); ?>" method="post">
                                            <?php echo csrf_field(); ?>
