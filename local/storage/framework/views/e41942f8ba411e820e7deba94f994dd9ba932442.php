      ...
      <div class="col-md-12">
          <div class="box">
              <div class="box-header">
                ...
                <a href="<?php echo e(url('/staffs/on-boarding/addnew')); ?>" class="btn btn-primary">Add OnBoardingStaff</a>
                </div>
              </div>
              <div class="box-body">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <td>
                          ...
                          <a href="<?php echo e(url('/staffs/on-boarding/edit/'.$staff->id)); ?>" class="btn btn-primary left"><i class="fa fa-edit"></i></a>

                          <a href="<?php echo e(route('staffs.onBoardStaff.sendmail', $staff->id)); ?>" class="btn btn-info left"><i class="fa fa-paper-plane"></i></a>
                  ...
                  <div class="modal fade bd-example-modal-lg" id="approval-modal">
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                        <form action="<?php echo e(url('/staffs/on-boarding/approve')); ?>" method="post">
                          <?php echo csrf_field(); ?>
...
<script type="text/javascript">
 ...
 function confirm_delete(ids){
    if(confirm('Do You Want To Delete onboarding staff?')){
      var url= "<?php echo e(url('/staffs/on-boarding/delete/')); ?>"+ids;
      location = url;
