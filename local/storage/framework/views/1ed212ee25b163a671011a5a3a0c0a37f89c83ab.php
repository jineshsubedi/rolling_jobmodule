...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      ...
      <div class="box-body">
        <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(route('branchadmin.travel.store')); ?>">
        <div class="col-md-10" style="border:1px solid #e6e6e6; border-radius: 5px; padding: 20px;">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="radio" name="type" value="domestic" <?php if(old('type') == 'domestic'): ?> checked <?php endif; ?>> Domestic &nbsp;
                    <input type="radio" name="type" value="international" <?php if(old('type') == 'international'): ?> checked <?php endif; ?>> International &nbsp;
               ...
               <label class="col-md-2 control-label required">Assigned To</label>
                <div class="col-md-10">
                    <select name="assigned_to" id="assigned_to" class="form-control select2">
                        ...
                        <?php if(old('assigned_to') == $staff->id): ?>
            ...
            <div class="form-group">
               <label class="col-md-2 control-label required">From</label>
                <div class="col-md-10">
                    <input type="text" name="travel_from" class="form-control datepicker" value="<?php echo e(old('travel_from')); ?>">
                    <?php if($errors->has('travel_from')): ?>
                        <span class="text-danger">
                            <strong><?php echo e($errors->first('travel_from')); ?></strong>
                        </span>
                    <?php endif; ?>
                </div>
            </div>
            <div class="form-group">
               <label class="col-md-2 control-label required">To</label>
                <div class="col-md-10">
                    <input type="text" name="travel_to" class="form-control datepicker" value="<?php echo e(old('travel_to')); ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <select name="assignment_type" id="assignment_type" class="form-control select2">
                        ...
                        <option value="<?php echo e($type->id); ?>" <?php if(old('assignment_type')==$type->id): ?> selected <?php endif; ?>><?php echo e($type->title); ?></option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="col-md-5">
                    <select name="assignment_category" id="assignment_category" class="form-control select2">
                        ...
                        <option value="<?php echo e($category->id); ?>" <?php if(old('assignment_category')==$category->id): ?> selected <?php endif; ?>><?php echo e($category->title); ?></option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                   <textarea name="purpose" id="purpose" class="form-control" rows="5"><?php echo e(old('purpose')); ?></textarea>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <input type="radio" name="mode_of_transport" value="road" <?php if(old('mode_of_transport')=='road'): ?> checked <?php endif; ?>> Road &nbsp;
                    <input type="radio" name="mode_of_transport" value="air" <?php if(old('mode_of_transport')=='air'): ?> checked <?php endif; ?>> Air &nbsp;
            ...
            <div id="transport_detail">
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <div class="col-md-10">
                            <input type="checkbox" name="road_sub" value="1" <?php if(old('road_sub')==1): ?> checked <?php endif; ?>> Self-Owned Vehicle 
                        </div>
                        <div class="col-md-10">
                            <input type="checkbox" name="road_sub" value="2" <?php if(old('road_sub')==2): ?> checked <?php endif; ?>> Company-Owned Vehicle 
                        </div>
                        <div class="col-md-10">
                            <input type="checkbox" name="road_sub" value="3" <?php if(old('road_sub')==3): ?> checked <?php endif; ?>> Rental Vehicle 
                        </div>
                        <div class="col-md-10">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <label class="switch">
                        <input type="checkbox" name="advance_required" id="advance_required" value="1" <?php if(old('advane_required')==1): ?> checked <?php endif; ?>>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <select name="payment_mode" id="payment_mode" class="form-control">
                        ...
                        <option value="1" <?php if(old('payment_mode')==1): ?> selected <?php endif; ?>>Reimbursement Mode</option>
                        <option value="2" <?php if(old('payment_mode')==2): ?> selected <?php endif; ?>>Pre Diem Reimbursement</option>
                    </select>
                ...
                <div class="col-md-6">
                    <div id="mode_1">
                        ...
                        <input type="radio" name="reimbursement" value="1" <?php if(old('reimbursement')==1): ?> checked <?php endif; ?>> Pre-Paid 70% <br>
                        <input type="radio" name="reimbursement" value="2"  <?php if(old('reimbursement')==2): ?> checked <?php endif; ?>> Post-Paid 30%
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select name="position" class="form-control">
                                    ...
                                    <option value="<?php echo e($position->id); ?>" <?php if(old('position')==$position->id): ?> selected <?php endif; ?>><?php echo e($position->title); ?></option>
                                    <?php endforeach; ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="grade" class="form-control">
                                    ...
                                    <option value="<?php echo e($grade->id); ?>" <?php if(old('grade')==$grade->id): ?> selected <?php endif; ?>><?php echo e($grade->title); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="per_diem_amount" class="form-control" value="<?php echo e(old('per_diem_amount')); ?>" placeholder="0.0">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="account_name" class="form-control" value="<?php echo e(old('account_name')); ?>">
                    </div>
                    <div class="col-md-4">
                        <label class="">Account Number</label>
                        <input type="number" name="account_number" class="form-control" value="<?php echo e(old('account_number')); ?>">
                    </div>
                    <div class="col-md-4">
