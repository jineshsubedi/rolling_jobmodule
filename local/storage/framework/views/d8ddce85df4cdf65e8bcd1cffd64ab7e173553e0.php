                            ...
                            <tbody>
                              <tr>
                               ...
                               <?php if($datas['employee']->home_phone != ''): ?>
                                  ...
                                  <?php endif; ?>
                                   <?php if($datas['employee']->district != ''): ?>
                                  <tr>
                                    <td><b><?php echo e($datas['location_title']); ?></b></td>
                                    <td><?php echo e($datas['employee']->district.', '.$datas['employee']->municipality.', '.$datas['employee']->ward); ?></td>
                                </tr>
                                  <?php endif; ?>
                                  ...
                                  <?php foreach($datas['form_data'] as $formdata): ?>
                                    ...
                                    <?php else: ?>
                                    <td><?php echo e($formdata->f_description); ?></td>
                                    <?php endif; ?>
