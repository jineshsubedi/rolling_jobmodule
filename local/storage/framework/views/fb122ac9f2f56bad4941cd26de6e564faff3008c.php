...
<li><a href="<?php echo e(url('/supervisor/adjustment_staff')); ?>">Staffs</a></li>
    ...
    <div class="box">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form method="POST" action="<?php echo e(url('/supervisor/adjustment_staff/update')); ?>" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group <?php echo e($errors->has('joindate') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-3">
                                                ...
                                                <input class="form-control datepicker" name="joindate" value="<?php echo e($datas['staff']->joindate); ?>" type="text">
...
<script type="text/javascript">
  $('#department').on('change', function(){
        ...
        if (data != '') {
            $.ajax({
        type: 'POST',
        url: '<?php echo e(url("/supervisor/adjustment_staff/department/get_designation")); ?>',
        data: 'id='+data+'&_token='+token,
        cache: false,
        success: function(data){
                console.log(data)
...
<script type="text/javascript">
    function deleteFile(id,title)
    {
        ...
        if (id != '' && title != '') {
             $.ajax({
                type: 'POST',
                url: '<?php echo e(url("/supervisor/adjustment_staff/deleteFile")); ?>',
...
function removeDataForm(index, staff_id)
{
    ...
    $.ajax({
        url: "<?php echo e(url('/supervisor/adjustment_staff/edit/removeDynamicFile')); ?>",
        type: 'POST',
        data:{
            _token: CSRF_TOKEN,
            index: index,
