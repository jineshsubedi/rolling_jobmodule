            ...
            <tr>
                ...
                <td>
                    ...
                    <?php echo method_field('DELETE'); ?>
                        ...
                        <?php /* <a href="<?php echo e(route('staffs.travel.edit', $travel->id)); ?>" class="btn btn-info"><i class="fa fa-edit"></i></a> */ ?>
                        <a href="<?php echo e(route('staffs.travelExpense.create', $travel->id)); ?>" class="btn btn-info"><i class="fa fa-money"> Add</i></a>
                        <?php /* <button type="submit" class="btn btn-warning" onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></button> */ ?>
                    ...
                    <?php else: ?>
                    <a href="<?php echo e(route('staffs.travel.acceptTravelRequest', $travel->id)); ?>" class="btn btn-info">Approve</a>
                    <?php endif; ?>
                </td>
            </tr>
            </tr>
...
<script>
  $('#filter_travel').click(function(){
    ...
    var url = '<?php echo e(url("staffs/mytravel?")); ?>'
    if(type != ''){
      url += '&type='+type
    }
    if(departure_date != ''){
