...
<style type="text/css">
 ...
 <div class="row">
    <div class="col-xs-12">
     <div class="row">
        <a href="<?php echo e(url('/staffs/tasks/addnew')); ?>" class="btn refreshbtn right btm10m rt15m"><i class="fa fa-fw fa-plus"></i>Add New Task</a>
      </div>
      ...
      <div class="box">
            ...
            <div class="top-links btn-group">
              <a href="<?php echo e(url('/staffs/tasks')); ?>" class="btn <?php echo e($datas['task_type'] == '' ? 'btn-primary' : 'btn-default'); ?>">All</a>
              <a href="<?php echo e(url('/staffs/tasks?task_from='.auth()->guard('staffs')->user()->id.'&task_type=2&task_to='.auth()->guard('staffs')->user()->id)); ?>" class="btn <?php echo e($datas['task_type'] == 2 ? 'btn-primary' : 'btn-default'); ?>">To do</a>
              <a href="<?php echo e(url('/staffs/tasks?task_type=1&task_to='.auth()->guard('staffs')->user()->id)); ?>" class="btn <?php echo e($datas['task_type'] == 1 ? 'btn-primary' : 'btn-default'); ?>">My Task</a>
              <a href="<?php echo e(url('/staffs/tasks?task_type=3&task_from='.auth()->guard('staffs')->user()->id)); ?>" class="btn <?php echo e($datas['task_type'] == 3 ? 'btn-primary' : 'btn-default'); ?>">Task Given</a>
            </div>
              ...
              <a href="<?php echo e(url('/staffs/tasks?task_type=4')); ?>" class="btn <?php echo e($datas['task_type'] == 4 ? 'btn-primary' : 'btn-default'); ?>">Messages
               <?php if($message > 0): ?>
                    <span class="badge label-danger chatbadge"><?php echo e($message); ?></span>
                    <?php endif; ?>
              </a>

              <a href="<?php echo e(url('/staffs/tasks?task_type=5')); ?>" class="btn <?php echo e($datas['task_type'] == 5 ? 'btn-primary' : 'btn-default'); ?>">Accept
               <?php if($accept > 0): ?>
                      <span class="badge label-danger chatbadge"><?php echo e($accept); ?></span>
                      <?php endif; ?>
              </a>
              <a href="<?php echo e(url('/staffs/tasks?task_type=6')); ?>" class="btn <?php echo e($datas['task_type'] == 6 ? 'btn-primary' : 'btn-default'); ?>">Approval
               <?php if($approval > 0): ?>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <td><a class="btn btn-primary" onClick="filterData()">Filter <i class="fa fa-search"></i> </a></td>
                      </tr>
                      <?php ($i = 1); ?>
                    ...
                    <?php ($acheck = \App\StaffTask::checkAssign($task->id)); ?>
                     <tr>
                      ...
                      <td>
                        ...
                        <button  onclick="approve('modal-approve','<?php echo e($task->id); ?>','<?php echo e($task->self_mark); ?>','<?php echo e(addslashes(htmlspecialchars($task->title))); ?>','<?php echo e($task->finish_date); ?>')" class="badge bg-purple" data-toggle="modal" data-target="#modal-approve" data-original-title="Approve Complete">Approve</button>
                        <?php endif; ?>

                        <?php if($task->accept_status != 0 && $task->complete != 1 && $task->task_to == auth()->guard('staffs')->user()->id): ?>
                        <button  onclick="complete('modal-complete','<?php echo e($task->id); ?>','<?php echo e(addslashes(htmlspecialchars($task->title))); ?>','<?php echo e($task->finish_date); ?>')" class="badge bg-purple" data-toggle="modal" data-target="#modal-complete" data-original-title="Complete">Complete</button>
                        <?php endif; ?>
                    
                    <button type="button" class="btn btn-box-tool chat-button" data-toggle="tooltip" onclick="showJobs('<?php echo e($task->id); ?>')"><i class="fa fa-plus"></i>
                     <?php if($rem_job > 0): ?>
                    ...
                    <button type="button" class="btn btn-box-tool chat-button" data-toggle="tooltip" title="View Chat" onclick="viewChatModal('modal-message','<?php echo e($task->parent_id ? $task->parent_id :$task->id); ?>')" data-original-title="Contacts"><i class="fa fa-comments"></i> Chat
                      ...
                      <?php endif; ?>
                       ...
                       <?php if($task->complete_status != 1 && $task->task_from == auth()->guard('staffs')->user()->id): ?>
                        
                      <a href="<?php echo e(url('/staffs/tasks/edit/'.$task->id)); ?>" type="button" class="btn btn-box-tool" data-original-title="Contacts">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row mb20">
                                  ...
                                  <div class="col-md-8">
                                    <?php echo \App\StaffTask::taskDetail($task->id); ?>
                                  </div>
                              ...
                              <?php endif; ?>
                               <?php if($task->staffs_mark > 0): ?>
                              <div class="row mb20">
                                  <label class="col-md-4 control-label">
                                   Task Giver Rating
                                  </label>
                                  <div class="col-md-8">
                                    <?php echo e($task->staffs_mark); ?>
                              ...
                              <?php if($task->staffs_remarks != ''): ?>
                              <div class="row mb20">
                                  <label class="col-md-4 control-label">
                                   Task Giver Remarks
                                  </label>
                                  <div class="col-md-8">
                                    <?php echo e($task->staffs_remarks); ?>
  ...
  <div class="modal fade" id="modal-assign">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form id="job-form" method="POST" action="<?php echo e(url('/staffs/tasks/assign')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body">
        ...
        <div class="modal fade" id="modal-assignjob">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form id="job-form" method="POST" action="<?php echo e(url('/staffs/job/assign')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body">
  ...
  <div class="modal fade" id="modal-complete">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form id="job-form" method="POST" action="<?php echo e(url('/staffs/task/complete')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body">
                
                  <?php echo csrf_field(); ?>

               <input type="hidden" name="task_id" id="task_id" value="">
               <div class="form-group"><div id="help_status" class="col-md-12"></div></div>
               <div class="form-group">
  ...
  <div class="modal fade" id="modal-approve">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form id="job-form" method="POST" action="<?php echo e(url('/staffs/task/approve')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body">
                
                  <?php echo csrf_field(); ?>

               <input type="hidden" name="task_id" id="task_id" value="">
               <div class="form-group"><div id="approve_status" class="col-md-12"></div></div>
               <div class="form-group">
               ...
               <div class="form-group">
                <label class="control-label col-md-4 ">Your Rating (Out of 10)</label>         
                <div class="col-md-6">
                  <input class="form-control" name="staffs_mark" required="required" placeholder="10" value="" type="text">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <textarea class="form-control" name="staffs_remarks" required="required" placeholder="Remarks"></textarea>
  ...
  <div class="modal fade" id="modal-default">
          <div class="modal-dialog" style="width: 900px;">
            <div class="modal-content">
              ...
              <form id="job-form" method="POST" action="<?php echo e(url('/staffs/tasks/saveJob')); ?>" class="form-horizontal" enctype="multipart/form-data">
...
<div class="modal fade" id="modal-assignUser">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="job-form" method="POST" action="<?php echo e(url('/staffs/task/addusertochat')); ?>" class="form-horizontal"
...
<script type="text/javascript">
  ...
  function showJobs(id) {
    ...
    $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/staffs/task/jobs")); ?>',
   ...
   function viewAssign(id) {
    ...
    $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/staffs/tasks/assignedstaff")); ?>',
            data: '_token='+token+'&id='+id,
            cache: false,
            success: function(html){
  ...
  function viewChatModal(div,task_id)  //changed
  {
    ...
    $.ajax({
        type: 'POST',
          url: '<?php echo e(url("/staffs/task/getmessage")); ?>',
    ...
    $.ajax({
      type: 'POST',
        url: '<?php echo e(url("/staffs/task/getmembers")); ?>',
        data: '_token='+token+'&id='+task_id,
        cache: false,
    ...
    $.ajax({
      type: 'POST',
        url: '<?php echo e(url("/staffs/task/authorizeAssign")); ?>',
        data: '_token='+token+'&id='+task_id,
        cache: false,
        success: function(data){
          if(data==1){
  ...
  function addMember() //changed
  {
    ...
    $.ajax({
        type: 'get',
          url: '<?php echo e(url("/staffs/task/getUsersListForChat")); ?>',
          data: '_token='+token+'&id='+id,
          cache: false,
          success: function(data){
  ...
  function removeChatMember(taskId, userId) //changed
  {
    ...
    $.ajax({
        type: 'get',
          url: '<?php echo e(url("/staffs/task/removeMember")); ?>',
  ...
  function complete(div,id,task_title,h_date) {
    $('#'+div+' #task_id').val(id);
    $('#'+div+' #self_mark').val(self_mark);
  ...
  {  
    ...
    if (message != '') {
      $.ajax({
          type: 'POST',
              url: '<?php echo e(url("/staffs/task/message")); ?>',
...
<script type="text/javascript">
    ...
    if(confirm('Do You Want To Delete This Task?')){
      var url= "<?php echo e(url('/staffs/task/delete/')); ?>/"+ids;
      location = url;
...
<script type="text/javascript">
  ...
  function filterData(){
        var url= "<?php echo e(url('/staffs/tasks/?')); ?>";
      ...
      $('#button-upload').on('click', function()  //changed
      {
        ...
        timer = setInterval(function() {
          if ($('#form-upload #file').val() != '') {
            ...
            $.ajax({
              url: '<?php echo e(url("/staffs/task/uploadchat/")); ?>',
              type: 'post',
...
<div class="modal fade " id="modal-jobs-edit">
          <div class="modal-dialog" style="width: 900px;">
            <div class="modal-content">
              ...
              <form id="job-edit-form" method="POST" action="<?php echo e(url('/staffs/tasks/updateJob')); ?>" class="form-horizontal" enctype="multipart/form-data">
...
<script type="text/javascript">
    $('.project').autocomplete({
        source: '<?php echo e(url("staffs/getProject/")); ?>',
        minlength:1,
        autoFocus:true,
    ...
    function acceptJob(id) {
      ...
      var url= "<?php echo e(url('/staffs/tasks/accept/')); ?>/"+id;
      location = url;
     ...
     function deleteJob(id) {
      ...
      var url= "<?php echo e(url('/staffs/tasks/deletejob/')); ?>/"+id;
      location = url;
     ...
     function editJob(id) {
      if(confirm('Are you sure you want to edit this job?')){
        ...
        $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/staffs/task/getJob")); ?>',
    ...
    function deleteChat(id) {
      ...
      var token = $('input[name=\'_token\']').val();
        ...
        if (id != '') {
          $.ajax({
             type: 'POST',
                url: '<?php echo e(url("/staffs/task/deleteChat")); ?>',
                data: '_token='+token+'&id='+id,
                cache: false,
                success: function(html){
                  var datas = html.split('|');
    ...
    function startTask(task_id,kra,title) {
      var token = $('input[name=\'_token\']').val();
        ...
        if (task_id != '') {
          $.ajax({
             type: 'POST',
                url: '<?php echo e(url("/staffs/daily-routine/tasksave")); ?>',
    ...
    function stopTask(task_id) {
      var token = $('input[name=\'_token\']').val();
        ...
        if (task_id != '') {
          $.ajax({
             type: 'POST',
                url: '<?php echo e(url("/staffs/daily-routine/taskstop")); ?>',
