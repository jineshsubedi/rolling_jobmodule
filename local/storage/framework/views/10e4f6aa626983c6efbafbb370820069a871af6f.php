            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div id="survey_section" class="col-md-12">
                        <div class="col-md-6">
                            <form action="<?php echo e(route('survey.update', $survey->id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
<script type="text/javascript">
    ...
    $.ajax({
        url: "<?php echo e(route('survey.questions')); ?>",
        type: 'GET',
        data:{
            _token: CSRF_TOKEN,
    ...
    $('#surveyQuestionBtn').click(function() {
        ...
        $('.parent-error').html('');
        $.ajax({
            url: "<?php echo e(url('/branchadmin/survey/addnew/surveyQuestion')); ?>",
            type: 'POST',
            data:{
                _token: CSRF_TOKEN,
                survey_id: $('#survey_id').val(),
    ...
    function deleteSurveyQuestion(id){
        $.ajax({
            url: "<?php echo e(url('/branchadmin/survey/addnew/deleteSurveyQuestion')); ?>",
            type: 'POST',
            data:{
                _token: CSRF_TOKEN,
                survey_id: id
    ...
    function editSurveyQuestion(id){
        ...
        $.ajax({
            url: "<?php echo e(url('/branchadmin/survey/addnew/findSurveyQuestion')); ?>",
            type: 'get',
            data:{
                _token: CSRF_TOKEN,
                question_id: id
        ...
        $('#edit_survey_parent'+id).autocomplete({
            source: function(request, response) {
                $.ajax({
                    url: '<?php echo e(url("/branchadmin/survey/addnew/edit/autocomplete")); ?>',
                    dataType: "json",
                    data: {
                        term : request.term,
                        survey_id : $('#survey_id').val(),
    ...
    function updateSurveyQuestion(id)
    {
        ...
        $.ajax({
            url: "<?php echo e(url('/branchadmin/survey/addnew/updateSurveyQuestion')); ?>",
            type: 'PUT',
            data:{
                _token: CSRF_TOKEN,
                question_id: id,
    ...
    $('#survey_parent').autocomplete({
        source: function(request, response) {
            $.ajax({
                url: '<?php echo e(url("/branchadmin/survey/addnew/autocomplete")); ?>',
                dataType: "json",
                data: {
                    term : request.term,
                    survey_id : $('#survey_id').val()
