...
<div class="row">
  <div class="col-xs-12">
    <div class="row">
      <a href="<?php echo e(url('/staffs/clientdetail/addnew')); ?>" class="btn btn-primary right"><i class="fa fa-fw fa-plus"></i>New Client Detail</a>
    </div>
      ...
      <div class="box-body">
        <div class="panel-heading">
          <div class="top-links btn-group col-md-5">
            ...
            <a href="<?php echo e(url('/staffs/clientdetail?filter_status=1')); ?>" class="btn <?php echo e($datas['filter_status'] == 1 ? 'btn-primary' : 'btn-default'); ?>">Active Client</a>
            <a href="<?php echo e(url('/staffs/clientdetail?filter_status=4')); ?>" class="btn <?php echo e($datas['filter_status'] == 4 ? 'btn-primary' : 'btn-default'); ?>">Passed</a>
            <a href="<?php echo e(url('/staffs/clientdetail?filter_status=2')); ?>" class="btn <?php echo e($datas['filter_status'] == 2 ? 'btn-primary' : 'btn-default'); ?>">On Process</a>
            <a href="<?php echo e(url('/staffs/clientdetail?filter_status=3')); ?>" class="btn <?php echo e($datas['filter_status'] == 3 ? 'btn-primary' : 'btn-default'); ?>">Closed</a>
            
            <a href="<?php echo e(url('/staffs/clientdetail')); ?>" class="btn <?php echo e($datas['filter_status'] == '' ? 'btn-primary' : 'btn-default'); ?>">All</a>
          </div>
          <div class="col-md-7">
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            <tr>
              ...
              <td><a href="<?php echo e(url('/staffs/clientdetail')); ?>" class="btn btn-primary">All</a></td>
            </tr>
              ...
              <td>
                <div class="dropdown mobile-options">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="<?php echo e(url('/staffs/clientdetail/client_contact?client_id='.$client->id)); ?>" target="_blank" class="btn btn-default "><i class="fa fa-fw fa-users"></i> Contacts</a></li>
                    <li><a href="<?php echo e(url('/staffs/clientdetail/client_history/'.$client->id)); ?>" target="_blank" class="btn btn-default"><i class="fa fa-fw fa-eye"></i> History</a></li>
                    <!-- <li><a href="javascript:void(0);" onClick="confirm_delete('/<?php echo e($client->id); ?>')" class="btn btn-danger "><i class="fa fa-fw fa-remove"></i> Delete</a></li> -->
                    
                    <li><a href="<?php echo e(url('/staffs/clientdetail/edit/'.$client->id)); ?>" class="btn btn-default "><i class="fa fa-edit"></i> Edit</a></li>
                    <?php if($total_r > 0): ?>
                    <!-- <li><a href="<?php echo e(url('/staffs/clientdetail/view-rating/'.$client->id)); ?>" class="btn btn-default "><i class="fa fa-eye"></i> View Rating</a></li> -->
                    <?php endif; ?>
                    
                    <!-- <li><a href="<?php echo e(url('/staffs/clientdetail/send_comment/'.$client->id)); ?>" title="Client Review Email to Client" class="btn btn-default "><i class="fa fa-envelope"></i> Review Email</a></li> -->
  ...
  <div>
    ...
    var url= "<?php echo e(url('/staffs/clientdetail/delete/')); ?>"+ids;
    location = url;
    ...
    source: '<?php echo e(url("staffs/clientdetail/autocomplete_name/")); ?>',
    minlength:1,
    autoFocus:true,
    ...
    var url = '<?php echo e(url("staffs/clientdetail/")); ?>?';
    ...
    source: '<?php echo e(url("staffs/clientdetail/autocomplete_nature/")); ?>',
    minlength:1,
    autoFocus:true,
    select:function(e,ui){
    ...
    source: '<?php echo e(url("staffs/clientdetail/autocomplete_email/")); ?>',
    minlength:1,
    autoFocus:true,
    select:function(e,ui){
    var filter_name = $('#filter_name').val();
    ...
    source: '<?php echo e(url("staffs/clientdetail/autocomplete_phone/")); ?>',
    minlength:1,
    autoFocus:true,
    select:function(e,ui){
    var filter_name = $('#filter_name').val();
    ...
    source: '<?php echo e(url("staffs/clientdetail/autocomplete_person/")); ?>',
    minlength:1,
    autoFocus:true,
    select:function(e,ui){
    var filter_name = $('#filter_name').val();
    ...
    source: '<?php echo e(url("staffs/clientdetail/autocomplete_type/")); ?>',
    minlength:1,
    autoFocus:true,
    select:function(e,ui){
    var filter_name = $('#filter_name').val();
    ...
    source: '<?php echo e(url("staffs/clientdetail/autocomplete_person_name/")); ?>',
    minlength:1,
    autoFocus:true,
    select:function(e,ui){
    ...
    var url = '<?php echo e(url("staffs/clientdetail/client_contact")); ?>?';
    url += 'filter_name='+ui.item.id;
    ...
    source: '<?php echo e(url("staffs/clientdetail/autocomplete_person_email/")); ?>',
    minlength:1,
    autoFocus:true,
    select:function(e,ui){
    ...
    source: '<?php echo e(url("staffs/clientdetail/autocomplete_person_phone/")); ?>',
    minlength:1,
    autoFocus:true,
    select:function(e,ui){
