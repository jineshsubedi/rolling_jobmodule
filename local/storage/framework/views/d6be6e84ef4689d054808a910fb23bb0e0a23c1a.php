...
<div class="row">
    <div class="col-xs-12">
        <div class="row">
            <a href="<?php echo e(url('/staffs/survey-setup/addnew')); ?>" class="btn btn-primary right"><i
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="<?php echo e(route('staffs.surveysetup.delete', $survey->id)); ?>" method="post">
                                    <?php echo csrf_field(); ?>

                                    <?php echo e(method_field('DELETE')); ?>

                                    <a href="<?php echo e(route('staffs.surveysetup.showSurveyGivenList', $survey->id)); ?>"
                                        class="btn btn-sm btn-info"><i
                                            class="fa fa-eye"></i><?php echo e(count(\App\SurveyAnswer::countSurveyDone($survey->id))); ?></a>
                                    <a href="<?php echo e(route('staffs.surveysetup.edit', $survey->id)); ?>" class="btn btn-sm btn-warning"><i
