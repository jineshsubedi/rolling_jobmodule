...
<li class="active">Assignment Edit Create</li>
<?php $__env->stopSection(); ?>
...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
        <div class="box-title">
            <h3>Assignment Edit Create</h3>
        </div>
      <div class="box-body">
      <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(route('branchadmin.assignment_category.store')); ?>">
        <?php echo csrf_field(); ?>
