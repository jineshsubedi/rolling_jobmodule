...
<?php $__env->startSection('breadcrubm'); ?>
 <li><a href="<?php echo e(url('/staffs')); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="<?php echo e(url('/staffs/leaverequest')); ?>">Leave Request</a></li>
...
<div class="row">
        ...
        <div class="box">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" id="testform" enctype="multipart/form-data" method="POST" action="<?php echo e(url('/staffs/leaverequest/save')); ?>">
                        <?php echo csrf_field(); ?>
 ...
 <script type="text/javascript">
   $('#leave_type').on('change', function(){
       var accrual_require = '<?php echo e($datas["accrual_require"]); ?>';
    var id = $(this).val();
   ...
   $('#ltype #lmessage').remove();
    ...
    if (id == 3) {
      ...
      $('#comp').fadeOut();
      if(accrual_require == 1){
       if (Number(accrual) < 1) {
        var html = '<div id="lmessage" class="alert alert-danger" style="padding:5px; margin-bottom:5px;">Your accrual is not sufficient if you will request this leave it will go to unpaid leave.</div>';
        $('#ltype #lmessage').remove();
        $('#ltype').append(html);
      }

      if (Number(join_duration) < Number(eligible)) {
        var html = '<div id="lmessage" class="alert alert-danger" style="padding:5px; margin-bottom:5px;">You are not eligible for this leave it will go to unpaid leave.</div>';
        $('#ltype #lmessage').remove();
        $('#ltype').append(html);
      }
      }
    ...
    $('.datepicker').datepicker({
        onSelect: function(date) {
            ...
            if (start_date != '') {
               ...
               $.ajax({
                    type: 'POST',
                    url: '<?php echo e(url("/staffs/leaverequest/check_available")); ?>',
