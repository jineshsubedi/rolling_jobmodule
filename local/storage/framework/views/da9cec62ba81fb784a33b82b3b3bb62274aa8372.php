...
Supervisor
<small>Detail of Supervisor</small>
    ...
    <div class="box">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form method="POST" action="<?php echo e(url('/supervisor/updateprofile')); ?>" class="form-horizontal" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?php echo e($datas['supervisor']->id); ?>">
                            ...
                            <div class="portlet-body p-10">
                                <div class="form-body">
                                    ...
                                    <div class="form-group <?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" name="name" placeholder="Employee Name" value="<?php echo e($datas['supervisor']->name); ?>" type="text">
                                    ...
                                    <div class="form-group <?php echo e($errors->has('f_name') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" name="f_name" placeholder="Father Name" type="text" value="<?php echo e($datas['supervisor']->f_name); ?>">
                                    ...
                                    <div class="form-group <?php echo e($errors->has('dob') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-9">
                                                ...
                                                <input class="form-control datepicker" name="dob" value="<?php echo e($datas['supervisor']->dob); ?>" type="text">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" id="education_level" name="education_level">
                                              ...
                                              <?php foreach($datas['education_level'] as $education_level): ?>
                                                <?php if($education_level->id == $datas['supervisor']->education_level): ?>
                                    ...
                                    <div class="form-group <?php echo e($errors->has('faculty') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" name="faculty" id="faculty">
                                              ...
                                              <?php if($faculty->id == $datas['supervisor']->faculty): ?>
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" name="gender">
                                              <?php foreach($datas['gender'] as $gender): ?>
                                                <?php if($gender['value'] == $datas['supervisor']->gender): ?>
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" name="marital_status">
                                              <?php foreach($datas['marital_status'] as $marital_status): ?>
                                                <?php if($marital_status['value'] == $datas['supervisor']->marital_status): ?>
                                    ...
                                    <div class="form-group <?php echo e($errors->has('contact_person') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="contact_person" id="contact_person" value="<?php echo e($datas['supervisor']->contact_person); ?>">
                                    ...
                                    <div class="form-group <?php echo e($errors->has('contact_person_number') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" name="contact_person_number" id="contact_person_number" value="<?php echo e($datas['supervisor']->contact_person_number); ?>">
                                    ...
                                    <div class="form-group <?php echo e($errors->has('home_location') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input type="hidden" name="home_location" id="home_location" value="<?php echo e($datas['supervisor']->home_location); ?>">
                                    ...
                                    <div class="form-group <?php echo e($errors->has('phone') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" name="phone" placeholder="Contact Number" value="<?php echo e($datas['supervisor']->phone); ?>" type="text">
                                    ...
                                    <div class="form-group <?php echo e($errors->has('temporary_address') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" name="temporary_address" id="temporary_address"><?php echo e($datas['supervisor']->temporary_address); ?></textarea>
                                    ...
                                    <div class="form-group <?php echo e($errors->has('permanent_address') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" name="permanent_address" id="permanent_address"><?php echo e($datas['supervisor']->permanent_address); ?></textarea>
                            ...
                            <div class="portlet-body p-10">
                                <div class="form-body">
                                    ...
                                    <div class="form-group <?php echo e($errors->has('bank_name') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" name="bank_name" placeholder="Current bank_name" value="<?php echo e($datas['supervisor']->bank_name); ?>" type="text">
                                    ...
                                    <div class="form-group <?php echo e($errors->has('account_number') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" name="account_number" placeholder="Current account_number" value="<?php echo e($datas['supervisor']->account_number); ?>" type="text">
                                ...
                                <div class="form-body">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-md-5" id="resume_row">
                                            <?php if($datas['supervisor']->resume != ''): ?>
                                            
                                            <a href="<?php echo e(asset('/image/'.$datas['supervisor']->resume)); ?>" target="_blank" class="btn btn-primary" download="download">Download</a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5" id="offer_letter_row">
                                            <?php if($datas['supervisor']->offer_letter != ''): ?>
                                           
                                            <a href="<?php echo e(asset('/image/'.$datas['supervisor']->offer_letter)); ?>" target="_blank" class="btn btn-primary" download="download">Download</a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-md-5" id="contract_row">
                                            <?php if($datas['supervisor']->contract != ''): ?>
                                           
                                            <a href="<?php echo e(asset('/image/'.$datas['supervisor']->contract)); ?>" target="_blank" class="btn btn-primary" download="download">Download</a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-md-5" id="id_proof_row">
                                            <?php if($datas['supervisor']->id_proof != ''): ?>
                                          
                                            <a href="<?php echo e(asset('/image/'.$datas['supervisor']->id_proof)); ?>" target="_blank" class="btn btn-primary" download="download">Download</a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
...
<script type="text/javascript">
  $('#education_level').on('change', function(){
        ...
        if (data != '') {
            $.ajax({
        type: 'POST',
        url: '<?php echo e(url("/supervisor/getfaculty")); ?>',
...
<script type="text/javascript">
    function deleteFile(id,title)
    {
        ...
        if (id != '' && title != '') {
             $.ajax({
                type: 'POST',
                url: '<?php echo e(url("/supervisor/deleteFile")); ?>',
...
<script type="text/javascript">
      $('#btn_change').on('click', function() {
        $('#upload_form').remove();
        var url = "<?php echo e(url('/supervisor/uploadimage')); ?>";
...
<script type="text/javascript" src="//maps.googleapis.com/maps/api/js?key=AIzaSyAoqaY2Xc_0pCgZdcoODLP5Qli-coBxnSI&v=3&libraries=panoramio&language=ne&region=NP"></script>
 <script type="text/javascript">
    ...
    <?php if($datas['supervisor']->home_location != ''): ?>
    <script type="text/javascript">
    $(document).ready(function(){
        var glocation = '<?php echo e($datas["supervisor"]->home_location); ?>';
        var data = glocation.split(',');
                //initialize(new google.maps.LatLng(data[0], data[1]));
                  initializeGMap(data[0], data[1]);
                     $('#body_map').fadeIn();
