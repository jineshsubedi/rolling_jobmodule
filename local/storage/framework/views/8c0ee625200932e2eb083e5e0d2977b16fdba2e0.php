...
<?php $__env->startSection('breadcrubm'); ?>
 <li><a href="<?php echo e(url('/staffs')); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="<?php echo e(url('/staffs/clientdetail')); ?>">Client Detail</a></li>
...
<div class="row">
    <div class="col-xs-12">
       ...
       <?php endif; ?>
                    <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(url('/staffs/clientdetail/save')); ?>">
                        <?php echo csrf_field(); ?>
