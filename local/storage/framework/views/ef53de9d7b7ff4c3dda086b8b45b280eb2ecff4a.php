...
<?php echo csrf_field(); ?>
 ...
 <div class="row">
    ...
    <div class="row">
            <div class="col-md-12">
                <a href="<?php echo e(url('branchadmin/attendance-handler/create')); ?>" class="btn btn-info pull-right">Generate Staff Attendance</a>
            </div>
        </div>
        <div class="box">
            <div class="heading text-center">
                <h4>Staff Manual Attendance Handler</h4>
                <form action="<?php echo e(route('branchadmin.exportExcel')); ?>" method="get">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-3">
                        <a class="btn btn-success" href="<?php echo e(url('/branchadmin/attendance-handler')); ?>">All</a>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        <td>
                          <span class="label <?php echo e($attendance['office_in_class']); ?>"><?php echo e($attendance['office_in'] .' '.$attendance['office_in_distance']); ?></span>
                          <button onclick="viewMap('<?php echo e($attendance["office_in_location"]); ?>','Duty Started in <?php echo e($attendance["office_in"]); ?>')"><i class="fa fa-map-marker"></i></button>
                            ...
                            <div class="modal fade" id="modal-out-away-location<?php echo e($attendance['id']); ?>">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <label>Late Clock Out Reason:</label>
                                        <p><?php echo e($attendance['out_time_reason']); ?></p>
                                        <?php endif; ?>
                                        <?php if($attendance['out_away_location']): ?>
                                        <label>Away Clock Out reason:</label>
                                        <p><?php echo e($attendance['out_away_location']); ?></p>
                                        <?php endif; ?>
                                        </div>
                                        <div class="modal-footer">
                                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="modal-update-attendance">
    ...
    <div class="modal-content">
        ...
        <span aria-hidden="true">&times;</span></button>
          ...
          <br>
          <form action="<?php echo e(route('branchadmin.attendancehandler.update')); ?>" method="post" class="form-horizontal">
            <?php echo csrf_field(); ?>
...
<script>
  ...
  $('.datepicker').datepicker({
      onSelect: function(date) {
        ...
        var url= "<?php echo e(url('/branchadmin/attendance-handler?')); ?>";
        if (filter_staff != '') {
...
<script type="text/javascript">
    ...
    $('#approveBtn').click(function(){
      ...
      var remarks = $('#remarks').val();
        ...
        $.ajax({
          type: 'POST',
          url: '<?php echo e(url("/branchadmin/attendance-handler/approve")); ?>',
