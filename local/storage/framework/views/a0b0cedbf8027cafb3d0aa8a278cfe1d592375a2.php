...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="box">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group" id="action_form_<?php echo e($question->id); ?>">
                        ...
                        <div class="form-input" style="border-bottom: 1px solid #eae2e2; padding: 10px;">
                            <?php $answer = \App\SurveyAnswer::getAnswerBranchadmin($question->id, $staffId); ?>
                            <?php if($answer): ?>
            ...
            <div class="box-header">
                <a href="<?php echo e(route('supervisor.surveysetup.showSurveyGivenList', $survey)); ?>" class="btn btn-sm btn-info"> Go Back</a>
            </div>
        </div>
    </div>
</div>
