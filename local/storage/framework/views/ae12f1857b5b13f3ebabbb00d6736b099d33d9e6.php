        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="pull-right">
                    <a href="<?php echo e(route('supervisor.resignation.create')); ?>" class="btn btn-info">Add Resignation</a>
                </div>
                <?php endif; ?>
            </div>
            <div class="box-body">
                    ...
                    <tbody>
                        ...
                        <tr <?php if(\App\DepartmentApproval::departmentApproval($staff->id,
                            ...
                            <td>
                                ...
                                auth()->guard('staffs')->user()->id || \App\BranchSetting::isHrHandler()) && $staff->supervisor_approval_status=='approved' &&
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <?php if(!$staff->supervisor_approval_status &&
                                        $staff->supervisor==auth()->guard('staffs')->user()->id): ?>
                                        <form action="<?php echo e(route('supervisor.resignation.updateSupervisorAction')); ?>"
                                            method="post">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <form action="<?php echo e(route('supervisor.resignation.updateHrAction')); ?>" method="post">
                                            <?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo e(route('supervisor.resignation.updateHrAction')); ?>" method="post">
                    <?php else: ?>
                    <form action="<?php echo e(route('supervisor.resignation.updateSupervisorAction')); ?>" method="post">
                        <?php endif; ?>
                        <?php echo csrf_field(); ?>
