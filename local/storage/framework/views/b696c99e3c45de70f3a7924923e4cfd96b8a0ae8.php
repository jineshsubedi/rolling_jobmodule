	  		...
	  		<div class="col-xs-12" >
			    ...
			    <div class="box" data-step='3' data-intro='Short Introduction to Organization!'>
			        ...
			        <div class="box-footer text-center">
			        	<p class="text-right">
							<input type="checkbox" name="step" value="1" class="stepCheckbox"> Complete This Section
			        	</p>
			        </div>
			    </div>
			    <br>
			    ...
			    <div class="box">
			    	...
			    	<div class="box-footer text-center">
			        	<p class="text-right">
							<input type="checkbox" name="step" value="2" class="stepCheckbox"> Complete This Section
			        	</p>
			        </div>
			    </div>
			    <br>
	    		...
	    		<div class="box" >
		            ...
		            <div class="box-footer text-center">
			        	<p class="text-right">
							<input type="checkbox" name="step" value="3" class="stepCheckbox"> Complete This Section
			        	</p>
			        </div>
		        </div>
		        <br>
		        ...
		        <div class="box" style="background-color: #e5e6e6">
		            ...
		            <div class="box-footer text-center">
			        	<p class="text-right">
							<input type="checkbox" name="step" value="4" class="stepCheckbox"> Complete This Section
			        	</p>
			        </div>
		        </div>
		        <br>
		        ...
		        <section id="OrgChart" data-step='13' data-intro='Organization Chart'>
		        	<div class="box">
			            ...
			            <div class="box-footer text-center">
			        	<p class="text-right">
							<input type="checkbox" name="step" value="5" class="stepCheckbox"> Complete This Section
			        	</p>
			        </div>
		        	</div>
		        	<br>
		        		...
		        		<div class="col-md-8 col-md-offset-2" data-step='14' data-intro='Tick the read document'>
		        			...
		        			<ul class="list-group">
			        			...
			        			<li class="list-group-item">
			        				<input type="checkbox" name="document" id="document_<?php echo e($document->id); ?>" value="<?php echo e($document->id); ?>" class="documentCheck">
...
<script>
        $('#profileForm').submit(function(event){
            ...
            $.ajax({
                url: "<?php echo e(route('supervisor.welcome.updateProfile')); ?>",
                data: formData,
                type: 'POST',
                dataType: 'JSON',
                processData: false,
...
<script>
	$(document).ready(function(){
        ...
        function privacyCheckOption(num)
        {
        	$.ajax({
		        type: 'POST',
		        url: '<?php echo e(route("supervisor.welcome.updatePrivacy")); ?>',
    ...
    $('#finishOnBoard').click(function(){
    	...
    	$.ajax({
	        type: 'POST',
	        url: '<?php echo e(route("supervisor.welcome.finishOnBoard")); ?>',
	        data: 'num='+num+'&_token='+token,
	        cache: false,
            success: function(data){
            	console.log(data)
...
<script type="text/javascript">
    $(function() {
        ...
        var token = $('input[name=\'_token\']').val();
        $.ajax({
            url: '<?php echo e(route("supervisor.orgchart.getChartData")); ?>',
            data: {'_token':token},
            type: 'GET',
            dataType: 'JSON',
            cache: false,
