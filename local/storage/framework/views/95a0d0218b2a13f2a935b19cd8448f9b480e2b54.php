  ...
  <div class="col-xs-12">
    <div class="box">
		...
		<div class="box-body">
			...
			<div class="right">
				<a href="<?php echo e(route('branchadmin.travel.planner.create')); ?>" class="btn btn-info">Make Planning</a>
				<a href="<?php echo e(route('branchadmin.travel.planner.edit', $planner->id)); ?>" class="btn btn-danger">Edit Planning</a>
			</div>
			<?php endif; ?>
			...
			<div class="row">
				...
				<div class="text-right">
					<a href="<?php echo e(route('branchadmin.travelExpense.create', $travel->id)); ?>" target="_blank" class="btn btn-info">Add Expense</a>
				</div>
				<?php endif; ?>
				<div>
					<div class="box-header">
					...
					<table class="table table-bordered" style="background-color: #e4e4e4">
						...
						<tr id="expense_data<?php echo e($e->id); ?>">
							...
							<?php if($travel->assigned_to == auth()->guard('staffs')->user()->id || $travel->assigned_from == auth()->guard('staffs')->user()->id): ?>
							<td>
								<form action="<?php echo e(route('branchadmin.travel.deleteExpense', $e->id)); ?>" method="post">
			                    <?php echo csrf_field(); ?>
						    ...
						    <div class="modal-dialog modal-lg">
						        <div class="modal-content">
						            ...
						            <div class="modal-body">
							            <form action="<?php echo e(route("branchadmin.travel.updateExpense")); ?>" role="form" method="post" class="form-horizontal">
						            	<div class="row">
							            	<?php echo csrf_field(); ?>
...
<script>
	...
	function updateExpense(id)
	{
		$.ajax({
	        type: 'POST',
	        url: '<?php echo e(route("branchadmin.travel.updateExpense")); ?>',
	        data: {
	        	_token : token,
	        	id : id,
