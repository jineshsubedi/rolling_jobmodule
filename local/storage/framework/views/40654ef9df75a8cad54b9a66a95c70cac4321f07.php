 ...
 <div class="row">
    <div class="col-xs-12">
      ...
      <div class="top-links btn-group">
        ...
        <a href="<?php echo e(url('/branchadmin/jobs/interview/'.$datas['job_id'])); ?>" class="btn btn-success">Final Interview (<?php echo e(\App\Employees::countInterview($datas['job_id'])); ?>)</a>
...
<?php /* <?php endif; ?> */ ?>
               ...
               <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(url('/branchadmin/jobs/update_interview')); ?>">
                <?php echo csrf_field(); ?>
