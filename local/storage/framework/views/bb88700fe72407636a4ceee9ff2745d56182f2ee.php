...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      ...
      <div class="box-body">
      <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(route('staffs.notice.store')); ?>">
        <?php echo csrf_field(); ?>
       ...
       <div class="row">
            <div class="col-md-10" id="multiCategory">
                <div class="form-group<?php echo e($errors->has('title') ? ' has-error' : ''); ?>" id="newform0">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="title" name="title" value="<?php echo e(old('title')); ?>" placeholder="Notice Title">
                ...
                <div class="form-group<?php echo e($errors->has('publish_date') ? ' has-error' : ''); ?>" id="newform0">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control datepicker" id="publish_date" name="publish_date" value="<?php echo e(old('publish_date')); ?>" placeholder="Notice publish_date" autocomplete="off">
                ...
                <div class="form-group<?php echo e($errors->has('to_date') ? ' has-error' : ''); ?>" id="newform0">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control datepicker" id="to_date" name="to_date" value="<?php echo e(old('to_date')); ?>" placeholder="Notice to_date" autocomplete="off">
