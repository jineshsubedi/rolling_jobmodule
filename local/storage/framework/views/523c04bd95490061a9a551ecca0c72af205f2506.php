...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      ...
      <div class="box-body">
      <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(route('branchadmin.training.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
       ...
       <div class="row">
            <div class="col-md-10" id="multiCategory">
                ...
                <div class="form-group<?php echo e($errors->has('description') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-8">
                        <textarea name="description" id="description" class="form-control" placeholder="training detail"><?php echo e(old('description')); ?></textarea>
