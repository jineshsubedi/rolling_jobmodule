...
Edit Onboarding Staff
<small>Detail of Edit Onboarding Staff</small>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrubm'); ?>
<li><a href="<?php echo e(url('/staffs')); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
<li><a href="<?php echo e(url('/staffs/on-boarding')); ?>">Onboarding Staffs</a></li>
<li class="active">Edit Onboarding Staff</li>
<?php $__env->stopSection(); ?>
  ...
  <div class="row justify-content-center">
      <div class="col-md-8">
          <div class="box">
              ...
              <div class="box-body">
              <form  method="POST" action="<?php echo e(url('/staffs/on-boarding/update')); ?>" enctype="multipart/form-data">
                   <?php echo csrf_field(); ?>
                  ...
                  <input type="hidden" name="id" value="<?php echo e($staff->id); ?>">
                   <div class="form-group <?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                      ...
                      <div class="input-group">
                          ...
                          <input name="name" type="text" class="form-control " value="<?php echo e($staff->name); ?>" placeholder="john doe" required>
                        </div>
                   ...
                   <div class="form-group <?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                      ...
                      <div class="input-group">
                          ...
                          <input name="email" type="email" class="form-control" placeholder="johndoe@mail.com" value="<?php echo e($staff->email); ?>" required>
                        </div>
                   ...
                   <div class="form-group <?php echo e($errors->has('department_id') ? ' has-error' : ''); ?>">
                      ...
                      <div class="input-group">
                          ...
                          <select name="department_id" id="department_id" class="form-control" required>
                            ...
                            <?php if($department->id == $staff->department_id): ?>
                   ...
                   <div id="supervisor" class="form-group <?php echo e($errors->has('supervisor') ? ' has-error' : ''); ?>">
                      ...
                      <div class="input-group">
                          ...
                          <select name="supervisor" class="form-control select2" style="width: 100%;">
                              ...
                              <?php if($staff->supervisor_id == $user->id): ?>
                          <option selected="selected" value="<?php echo e($user->id); ?>"><?php echo e($user->name); ?></option> 
                          <?php else: ?>
                   ...
                   <div id="staffType" class="form-group <?php echo e($errors->has('staffType') ? ' has-error' : ''); ?>">
                      ...
                      <div class="input-group">
                          ...
                          <select name="staffType" id="" class="form-control">
                            <option value="2" <?php if($staff->staffType==2): ?> selected <?php endif; ?>>Staff</option>
                            <option value="1" <?php if($staff->staffType==1): ?> selected <?php endif; ?>>Supervisor</option>
                            <option value="3" <?php if($staff->staffType==3): ?> selected <?php endif; ?>>Branchadmin</option>
                          </select>
                        </div>
                   ...
                   <div class="form-group <?php echo e($errors->has('nature_of_job') ? ' has-error' : ''); ?>">
                      ...
                      <div class="input-group">
                          ...
                          <select name="nature_of_job" class="form-control">
                            <option value="1" <?php if($staff->nature_of_job=='1'): ?> selected <?php endif; ?>>Full Time</option>
                            <option value="2" <?php if($staff->nature_of_job=='2'): ?> selected <?php endif; ?>>Part Time</option>
                          </select>
                        </div>
                   ...
                   <div class="form-group <?php echo e($errors->has('nature_of_employment') ? ' has-error' : ''); ?>">
                      ...
                      <div class="input-group">
                          ...
                          <select name="nature_of_employment" id="nature_of_employment" class="form-control" required>
                            <option value="Temporary" <?php if($staff->nature_of_employment=='Temporary'): ?> selected <?php endif; ?>>Temporary</option>
                            <option value="Permanent" <?php if($staff->nature_of_employment=='Permanent'): ?> selected <?php endif; ?>>Permanent</option>
                          </select>
                        </div>
                   ...
                   <div id="no_of_days" class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input name="no_of_days" type="number" class="form-control" value="<?php echo e($staff->no_of_days); ?>">
                      </div>
                   </div>
                   <div id="trail_start_date" class="form-group">
                      ...
                      <div class="input-group">
                          ...
                          <input name="trail_start_date" type="text" class="form-control datepicker" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask value="<?php echo e($staff->trail_start_day); ?>">
                        </div>
                   </div>
                   <div id="joining_date" class="form-group <?php echo e($errors->has('joining_date') ? ' has-error' : ''); ?>">
                      ...
                      <div class="input-group">
                          ...
                          <input name="joining_date" type="text" class="form-control datepicker" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask value="<?php echo e($staff->joining_date); ?>">
                      </div>
                   ...
                   <div class="form-group <?php echo e($errors->has('letter_accept_date') ? ' has-error' : ''); ?>">
                      ...
                      <div class="input-group">
                        ...
                        <input name="letter_accept_date" type="letter_accept_date" class="form-control datepicker" placeholder="letter accept date" value="<?php echo e($staff->letter_accept_date); ?>" required>
                      </div>
                   ...
                   <div class="form-group <?php echo e($errors->has('gross_salary') ? ' has-error' : ''); ?>">
                      ...
                      <div class="input-group">
                          ...
                          <input name="gross_salary" type="gross_salary" class="form-control" placeholder="20000" value="<?php echo e($staff->salary); ?>" required>
                        </div>
...
<script>
  ...
  $('#department_id').change(function(){
    ...
    $.ajax({
        url: "<?php echo e(url('/staffs/department/get_designation')); ?>",
        type: 'POST',
        data:{
            _token: CSRF_TOKEN,
            id: department
  ...
  {
    $('#designation_id').html('<option>Select Designation</option>');
    var designation = '<?php echo e($staff->designation_id); ?>'
    $.ajax({
        url: "<?php echo e(url('/staffs/department/get_designation')); ?>",
        type: 'POST',
        data:{
        ...
        success:function(data){
          ...
          if(value.id == designation){
            $('#designation_id').append('<option value="'+value.id+'" selected>'+value.title+'</option>')
          }else{
            $('#designation_id').append('<option value="'+value.id+'">'+value.title+'</option>')
          }
          })
