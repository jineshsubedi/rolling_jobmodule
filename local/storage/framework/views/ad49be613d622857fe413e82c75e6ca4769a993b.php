    ...
    <div class="box">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form method="POST" action="<?php echo e(url('/branchadmin/otstaff/update')); ?>" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group <?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input name="password_confirmation" class="form-control" value="" type="password" autocomplete="off">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" name="branch">
                                              <?php foreach($datas['branch'] as $branch): ?>
                                                <?php if($branch['id'] == $datas['staff']->branch): ?>
...
<script type="text/javascript">
    function deleteFile(id,title)
    {
        ...
        if (id != '' && title != '') {
             $.ajax({
                type: 'POST',
                url: '<?php echo e(url("/branchadmin/otstaff/deleteFile")); ?>',
...
function removeDataForm(index, staff_id)
{
    ...
    $.ajax({
        url: "<?php echo e(url('/branchadmin/otstaff/edit/removeDynamicFile')); ?>",
        type: 'POST',
        data:{
            _token: CSRF_TOKEN,
            index: index,
