...
Selected Application for Final Selection
            <small>List of Selected Application for Final Selection</small>
 ...
 <div class="row">
    <div class="col-xs-12">
      ...
      <div class="top-links btn-group">
          ...
          <a href="<?php echo e(url('/branchadmin/jobs/application/'.$datas['job_id'])); ?>" class="btn btn-default">All Application (<?php echo e(\App\Employees::countAllApplicant($datas['job_id'])); ?>)</a>
           <a href="<?php echo e(url('/branchadmin/jobs/verification/'.$datas['job_id'])); ?>" class="btn btn-default">Document Verification (<?php echo e(\App\Employees::countDocumentVerification($datas['job_id'])); ?>)</a>
        <a href="<?php echo e(url('/branchadmin/jobs/written/'.$datas['job_id'])); ?>" class="btn btn-default">Written Exam (<?php echo e(\App\Employees::countWrittenExam($datas['job_id'])); ?>)</a>
        <a href="<?php echo e(url('/branchadmin/jobs/discussion/'.$datas['job_id'])); ?>" class="btn btn-default">Group Discussion (<?php echo e(\App\Employees::countGroup($datas['job_id'])); ?>)</a>
        <a href="<?php echo e(url('/branchadmin/jobs/interview/'.$datas['job_id'])); ?>" class="btn btn-default">Final Interview (<?php echo e(\App\Employees::countInterview($datas['job_id'])); ?>)</a>
        <a href="<?php echo e(url('/branchadmin/jobs/selected/'.$datas['job_id'])); ?>" class="btn btn-success">Selected Candidates (<?php echo e(\App\Employees::countSelected($datas['job_id'])); ?>)</a>
    ...
    <div class="row">
      ...
      <div class="box box-info collapsed-box">
            ...
            <div class="box-body no-padding">
                ...
                <div class="row">
              <form class="form-horizontal" method="POST" accept-charset="UTF-8" enctype="multipart/form-data" action="<?php echo e(url('/branchadmin/jobs/upload_selected')); ?>">
...
<?php /* <?php endif; ?> */ ?>
                    ...
                    <tbody>
                      ...
                      <?php $i=1; 
                       ...
                       <td><?php echo e($row->tracking_code); ?></td>
                        ...
                        <td> <?php $strategic = \App\EmployeeExtraData::getStrategic($row->id);
  ...
  function filter(){
   ...
   var filter_symbol_no = $('#filter_symbol_no').val();
    ...
    var url= "<?php echo e(url('/branchadmin/jobs/selected/'.$datas['job_id'].'?')); ?>";
   if (filter_name != '') {
...
function confirm_delete(ids){
    if(confirm('Do You Want To Delete This Employee?')){
      var url= "<?php echo e(url('/branchadmin/jobs/selected/delete/')); ?>"+ids;
      location = url;
