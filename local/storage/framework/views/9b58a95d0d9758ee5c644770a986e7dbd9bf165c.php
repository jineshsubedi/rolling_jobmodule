...
<li class="active">Assignment Category Create</li>
<?php $__env->stopSection(); ?>
...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
        <div class="box-title">
            <h3>Assignment Category Create</h3>
        </div>
      <div class="box-body">
      <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(route('branchadmin.assignment_category.update', $type->id)); ?>">
        <?php echo csrf_field(); ?>
