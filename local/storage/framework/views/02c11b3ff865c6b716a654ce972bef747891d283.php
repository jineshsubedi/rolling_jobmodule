...
<div class="row">
  <div class="col-xs-12">
    <div class="box">
      ...
      <div class="box-body">
      <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(route('staffs.event.update', $event->id)); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
       ...
       <div class="row">
            <div class="col-md-10" id="multiCategory">
                <div class="form-group<?php echo e($errors->has('title') ? ' has-error' : ''); ?>" id="newform0">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="title" name="title" value="<?php echo e($event->title); ?>" placeholder="Event Title">
                ...
                <div class="form-group<?php echo e($errors->has('from') ? ' has-error' : ''); ?>" id="newform0">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control datepicker" id="from" name="from" value="<?php echo e($event->from); ?>" placeholder="event from" autocomplete="off">
                ...
                <div class="form-group<?php echo e($errors->has('to') ? ' has-error' : ''); ?>" id="newform0">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control datepicker" id="to" name="to" value="<?php echo e($event->to); ?>" placeholder="event to" autocomplete="off">
                ...
                <div class="form-group<?php echo e($errors->has('attachment') ? ' has-error' : ''); ?>" id="newform0">
                    ...
                    <div class="col-md-8">
                        ...
                        <a href="<?php echo e(asset('image/'.$event->attachment)); ?>" target="_blank"><img src="<?php echo e(asset('image/'.$event->attachment)); ?>" width="100px"></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
