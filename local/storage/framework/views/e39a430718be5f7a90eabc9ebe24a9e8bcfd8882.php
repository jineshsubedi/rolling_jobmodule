...
<div class="row">
  <div class="col-xs-12">
    <div class="row">
      <div class="col-md-12">
      <a href="<?php echo e(url('/staffs/achievement/summary')); ?>" class="btn btn-success right" style="padding: 4px 16px"><i class="fa fa-fw fa-eye"></i> Summary </a><a href="<?php echo e(url('/staffs/add_achievement')); ?>" class="btn refreshbtn right btm10m"><i class="fa fa-plus-circle"></i> Add Achievement </a>
    </div>
    </div>
        ...
        <div id="FilterDiv" class="filter-results rounded-item panel panel-default listing-filters">
          ...
          <div class="panel-body ">
            ...
            <div class="default-options-search">
              ...
              <div class="form-group col-md-2">
                <a class="btn btn-success btn-addon" href="<?php echo e(url('/staffs/achievements')); ?>" style="margin-top: 25px;"><i class="fa fa-check"></i> All</a>
  ...
  <script type="text/javascript">
    ...
    $('.datepicker').datepicker({
        onSelect: function(date) {
          ...
          var url = '<?php echo e(url("staffs/achievements")); ?>?';
          if (filter_staff != '') {
