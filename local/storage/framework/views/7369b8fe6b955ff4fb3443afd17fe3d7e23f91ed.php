...
<div class="row">
  <div class="col-xs-12">
    <div class="row">
      <div class="col-md-12">
        <a href="<?php echo e(route('staffs.training.trainer.create')); ?>" class="btn refreshbtn right btm10m"><i
      ...
      <div class="box-body">
        <table class="table table-borderd">
            ...
            <tr>
                ...
                <td>
                    <?php if($t->cv): ?>
                    <a href="<?php echo e(asset('image/'.$t->cv)); ?>" target="_blank">
                        <img src="<?php echo e(asset('image/ms-word.png')); ?>" width="50px">
                    </a>
                    <?php endif; ?>
                </td>
                <td>
                    <form action="<?php echo e(route('staffs.training.trainer.destroy', $t->id)); ?>" method="post">
                    <?php echo csrf_field(); ?>

                    <?php echo method_field('DELETE'); ?>

                        <a href="<?php echo e(route('staffs.training.trainer.edit', $t->id)); ?>" class="btn btn-info"><i class="fa fa-edit"></i></a>
