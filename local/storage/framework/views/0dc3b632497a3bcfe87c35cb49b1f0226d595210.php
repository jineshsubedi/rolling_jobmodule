...
<li class="active">Training Program Create</li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-xs-12">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Create Training Program</h3>
        </div>
      <div class="box-body">
      <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(route('staffs.training_program.store')); ?>">
        <?php echo csrf_field(); ?>
