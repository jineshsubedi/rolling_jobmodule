...
<div class="row">
  <div class="col-xs-8">
    <div class="box">
      ...
      <div class="box-body">
      <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(route('staffs.training.trainer.store')); ?>" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
       ...
       <div class="row">
            <div class="col-md-12" id="multiCategory">
                ...
                <div class="form-group<?php echo e($errors->has('rate') ? ' has-error' : ''); ?>" id="newform0">
                    ...
                    <div class="col-md-4">
                        <input type="text" class="form-control" id="rate" name="rate" value="<?php echo e(old('rate')); ?>" placeholder="0.00" value="<?php echo e(old('rate')); ?>">
                    ...
                    <div class="col-md-4">
                        <select name="charge_type" id="charge_type" class="form-control select2">
                            ...
                            <option value="1" <?php if(old('charge_type') == 1): ?> selected <?php endif; ?>>Per Training</option>
                            <option value="2" <?php if(old('charge_type') == 2): ?> selected <?php endif; ?>>Per Session</option>
                            <option value="3" <?php if(old('charge_type') == 3): ?> selected <?php endif; ?>>Per Hour</option>
                        </select>
