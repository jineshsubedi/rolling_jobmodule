 ...
 <div class="row">
    <div class="col-xs-12">
      ...
      <div class="top-links btn-group">
        ...
        <a href="<?php echo e(url('/branchadmin/jobs/selected/'.$datas['job_id'])); ?>" class="btn btn-success">Selected Candidates (<?php echo e(\App\Employee::countSelected($datas['job_id'])); ?>)</a>
                ...
                <form class="form-horizontal" role="form" id="meeting_zoom" method="POST" action="<?php echo e(url('/branchadmin/jobs/meeting_call')); ?>">
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tfoot>
                      ...
                      <?php endif; ?>
                       <tr>
                           <td colspan="9"><button type="button" id="for-meeting" onClick="confirm_meeting()" class="btn btn-black">Select for Group Meeting</button></td>
                       </tr>
                    </tfoot>
  ...
  <script type="text/javascript">
      ...
      function confirm_meeting(){
          ...
          if(confirm('Are you sure you want to Call for meeting to selected applicants ?')){
              ...
              $('#meeting_zoom').attr('action', action);
              $('#meeting_zoom').submit();
