...
<div class="row">
  <div class="col-xs-12">
    <div class="row">
      <div class="col-md-12">
        <a href="<?php echo e(route('supervisor.training.index')); ?>" class="btn refreshbtn right btm10m"><i
    ...
    <div class="box">
      <div class="box-body">
        ...
        <form action="<?php echo e(route('supervisor.training.saveFeedback', $training->id)); ?>" method="post">
        <?php echo csrf_field(); ?>
        ...
        <?php if($feedbacks): ?>
          ...
          <div>
            <a href="<?php echo e(route('supervisor.training_feedback.deleteFeedback', $feedback->id)); ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
          </div>
          </div>
          <?php endforeach; ?>
        <?php endif; ?>
