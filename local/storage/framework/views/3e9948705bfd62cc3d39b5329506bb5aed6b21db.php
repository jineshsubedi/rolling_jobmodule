...
<div class="row">
  <div class="col-xs-12">
    <div class="row">
      <a href="<?php echo e(url('/supervisor/clientdetail/addnew')); ?>" class="btn btn-primary right"><i class="fa fa-fw fa-plus"></i>New Client Detail</a>
    </div>
      ...
      <div class="box-body">
        <div class="panel-heading">
          <div class="top-links btn-group col-md-5">
            <a href="<?php echo e(url('/supervisor/clientdetail?filter_status=1')); ?>" class="btn <?php echo e($datas['filter_status'] == 1 ? 'btn-primary' : 'btn-default'); ?>">Active Client</a>
            <a href="<?php echo e(url('/supervisor/clientdetail?filter_status=4')); ?>" class="btn <?php echo e($datas['filter_status'] == 4 ? 'btn-primary' : 'btn-default'); ?>">Passed</a>
            <a href="<?php echo e(url('/supervisor/clientdetail?filter_status=2')); ?>" class="btn <?php echo e($datas['filter_status'] == 2 ? 'btn-primary' : 'btn-default'); ?>">On Process</a>
            <a href="<?php echo e(url('/supervisor/clientdetail?filter_status=3')); ?>" class="btn <?php echo e($datas['filter_status'] == 3 ? 'btn-primary' : 'btn-default'); ?>">Closed</a>
            
            <a href="<?php echo e(url('/supervisor/clientdetail')); ?>" class="btn <?php echo e($datas['filter_status'] == '' ? 'btn-primary' : 'btn-default'); ?>">All</a>
          </div>
          <div class="col-md-7">
        ...
        <table class="table table-bordered table-hover">
          ...
          <tbody>
            <tr>
              ...
              <td><input type="text" id="filter_staff" class="form-control" placeholder="Rolling Plans" value="<?php echo e($datas['filter_staff']); ?>"></td>
              ...
              <td><a href="<?php echo e(url('/supervisor/clientdetail')); ?>" class="btn btn-primary">All</a></td>
            </tr>
              ...
              <td>
                <div class="dropdown mobile-options">
                  ...
                  <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="<?php echo e(url('/supervisor/clientdetail/client_contact?client_id='.$client->id)); ?>" target="_blank" class="btn btn-default "><i class="fa fa-fw fa-users"></i> Contacts</a></li>
                    <li><a href="<?php echo e(url('/supervisor/clientdetail/client_history/'.$client->id)); ?>" target="_blank" class="btn btn-default"><i class="fa fa-fw fa-eye"></i> History</a></li>
                    ...
                    <li><a href="<?php echo e(url('/supervisor/clientdetail/edit/'.$client->id)); ?>" class="btn btn-default "><i class="fa fa-edit"></i> Edit</a></li>
                  </ul>
                </div>
  ...
  <div>
    ...
    var url= "<?php echo e(url('/supervisor/clientdetail/delete/')); ?>"+ids;
    location = url;
    ...
    $('#filter_name').autocomplete({
      source: '<?php echo e(url("supervisor/clientdetail/autocomplete_name/")); ?>',
      minlength:1,
      autoFocus:true,
      select:function(e,ui){
        ...
        var url = '<?php echo e(url("supervisor/clientdetail/")); ?>?';
    ...
    $('#filter_staff').autocomplete({
      source: '<?php echo e(url("supervisor/clientdetail/autocomplete_staff/")); ?>',
      minlength:1,
      autoFocus:true,
      select:function(e,ui){
      var filter_nature = $('#filter_nature').val();
    ...
    $('#filter_nature').autocomplete({
      source: '<?php echo e(url("supervisor/clientdetail/autocomplete_nature/")); ?>',
      minlength:1,
      autoFocus:true,
      select:function(e,ui){
      var filter_name = $('#filter_name').val();
    ...
    $('#filter_email').autocomplete({
      source: '<?php echo e(url("supervisor/clientdetail/autocomplete_email/")); ?>',
      minlength:1,
      autoFocus:true,
      select:function(e,ui){
      var filter_name = $('#filter_name').val();
    ...
    $('#filter_phone').autocomplete({
      source: '<?php echo e(url("supervisor/clientdetail/autocomplete_phone/")); ?>',
      minlength:1,
      autoFocus:true,
      select:function(e,ui){
      var filter_name = $('#filter_name').val();
    ...
    $('#filter_person').autocomplete({
      source: '<?php echo e(url("supervisor/clientdetail/autocomplete_person/")); ?>',
      minlength:1,
      autoFocus:true,
      select:function(e,ui){
      var filter_name = $('#filter_name').val();
    ...
    $('#filter_type').autocomplete({
      source: '<?php echo e(url("supervisor/clientdetail/autocomplete_type/")); ?>',
      minlength:1,
      autoFocus:true,
      select:function(e,ui){
      var filter_name = $('#filter_name').val();
    ...
    $('#contact_name').autocomplete({
      source: '<?php echo e(url("supervisor/clientdetail/autocomplete_person_name/")); ?>',
      minlength:1,
      autoFocus:true,
      select:function(e,ui){
      ...
      var url = '<?php echo e(url("supervisor/clientdetail/client_contact")); ?>?';
      url += 'filter_name='+ui.item.id;
    ...
    $('#contact_email').autocomplete({
      source: '<?php echo e(url("supervisor/clientdetail/autocomplete_person_email/")); ?>',
      minlength:1,
      autoFocus:true,
      select:function(e,ui){
    ...
    $('#contact_phone').autocomplete({
      source: '<?php echo e(url("supervisor/clientdetail/autocomplete_person_phone/")); ?>',
      minlength:1,
      autoFocus:true,
      select:function(e,ui){
