...
<?php echo csrf_field(); ?>
 ...
 <div class="row">
    <div class="col-xs-12">
      <div class="row">
            <div class="col-md-12">
                <a href="<?php echo e(url('supervisor/attendance-handler/create')); ?>" class="btn btn-info pull-right">Generate Staff Attendance</a>
            </div>
        </div>
        <div class="box">
            <div class="heading text-center">
                <h4>Staff Manual Attendance Handler</h4>
                <form action="<?php echo e(route('supervisor.exportExcel')); ?>" method="get">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-3">
                        <a class="btn btn-success" href="<?php echo e(url('/supervisor/attendance-handler')); ?>">All</a>
...
<div class="modal fade" id="modal-update-attendance">
    ...
    <div class="modal-content">
        ...
        <span aria-hidden="true">&times;</span></button>
          ...
          <br>
          <form action="<?php echo e(route('supervisor.attendancehandler.update')); ?>" method="post" class="form-horizontal">
            <?php echo csrf_field(); ?>
...
$('.datepicker').datepicker({
     onSelect: function(date) {
       ...
       var url= "<?php echo e(url('/supervisor/attendance-handler?')); ?>";
       if (filter_staff != '') {
...
<script type="text/javascript">
    ...
    $('#approveBtn').click(function(){
      ...
      var remarks = $('#remarks').val();
        ...
        $.ajax({
          type: 'POST',
          url: '<?php echo e(url("/supervisor/attendance-handler/approve")); ?>',
