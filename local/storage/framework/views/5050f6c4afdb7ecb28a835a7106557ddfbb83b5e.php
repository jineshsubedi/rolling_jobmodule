...
<?php $__env->startSection('breadcrubm'); ?>
 <li><a href="<?php echo e(url('/staffs')); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
          <li><a href="<?php echo e(url('/staffs/staffs')); ?>"><i class="fa fa-users"></i> Staffs</a></li>  
      ...
      <div class="box">
            ...
            <div class="tab-content">
              <div class="tab-pane <?php echo e($datas['tab'] == 'travel' ? 'active' : ''); ?>" id="travel">
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-12">
                    <a href="<?php echo e(url('/staffs/travel/create/')); ?>" class="btn btn-info pull-right" target="_blank"><i class="fa fa-plus">Travel Request</i></a>
              ...
              <div class="tab-pane <?php echo e($datas['tab'] == 'salary' ? 'active' : ''); ?>" id="salary">
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-12">
                    <a href="<?php echo e(url('/staffs/staff_salary/addsalary/'.$datas['staff_id'])); ?>" class="btn btn-info pull-right" target="_blank"><i class="fa fa-plus"> Add Salary</i></a>
                          ...
                          <table class="table table-bordered">
                            ...
                            <?php foreach($datas['contract'] as $k=>$contract): ?>
                              <tr>
                                ...
                                <th>
                                <form action="<?php echo e(url('staffs/otstaff/contract'.'/'.$datas['staff_id'].'/delete'.'/'.$contract->id)); ?>" method="post">
                                  <?php echo csrf_field(); ?>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="<?php echo e(url('/staffs/staff-survey/view/'.$survey->id)); ?>" class="btn btn-success left"><i class="fa fa-fw fa-eye"></i></a>
              </td>
          ...
          <table class="table table-bordered table-hover">
                    ...
                    <button type="button" class="btn btn-box-tool chat-button" data-toggle="tooltip" title="View Chat" onclick="viewChatModal('modal-message','<?php echo e($task->id); ?>')" data-original-title="Contacts"><i class="fa fa-comments"></i>Chat
                     <?php if($message > 0): ?>
                      ...
                      <a href="<?php echo e(url('/staffs/task/edit/'.$task->id)); ?>" type="button" class="btn btn-box-tool" data-original-title="Contacts">
  ...
  <div class="modal fade " id="modal-performance">
      <div class="modal-dialog" style="width: 900px;">
        <div class="modal-content">
          ...
          <form id="performance-form" method="POST" action="<?php echo e(url('/staffs/performance/save')); ?>" class="form-horizontal" enctype="multipart/form-data">
  ...
  <div class="modal fade" id="modal-helpcomplete">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form id="job-form" method="POST" action="<?php echo e(url('/staffs/help_desk/complete')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body">
  ...
  <div class="modal fade" id="modal-default">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form id="job-form" method="POST" action="<?php echo e(url('/staffs/task/saveJob')); ?>" class="form-horizontal" enctype="multipart/form-data">
...
<div class="modal fade" id="modal-add-skill">
          <div class="modal-dialog skill_add">
            <div class="modal-content">
              ...
              <form id="skill_form" method="POST" action="<?php echo e(url('/staffs/skill/add')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body">
  ...
  <div class="modal fade" id="modal-add-kra">
          <div class="modal-dialog kra_add">
            <div class="modal-content">
              ...
              <form id="kra_form" method="POST" action="<?php echo e(url('/staffs/kra/add')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body">
        ...
        <div class="modal fade" id="modal-add-kpi">
          <div class="modal-dialog kpi_add">
            <div class="modal-content">
              ...
              <form id="kpi_form" method="POST" action="<?php echo e(url('/staffs/kpi/add')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body">
...
function deleteSkill(id) {
  ...
  if (id != '') {
     $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/staffs/skill/delete")); ?>',
            data: 'id='+id+'&_token='+token,
            cache: false,
            success: function(html){
              var datas = html.split('|');
...
function deletekra(id) {
  ...
  if (id != '') {
     $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/staffs/kra/delete")); ?>',
            data: 'id='+id+'&_token='+token,
            cache: false,
            success: function(html){
              var datas = html.split('|');
...
function delKpi(id) {
  ...
  if (id != '') {
     $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/staffs/kpi/delete")); ?>',
            data: 'id='+id+'&_token='+token,
            cache: false,
            success: function(html){
              var datas = html.split('|');
...
<script type="text/javascript">
  function acceptHelp(id) {
      ...
      var url= "<?php echo e(url('/staffs/help_desk/accept/')); ?>/"+id;
      location = url;
...
<script type="text/javascript">
  function helpChatModal(div,help_id)
    ...
    $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/staffs/help_desk/getmessage")); ?>',
...
<script type="text/javascript">
  function sendHelpMessage() {
    ...
    if (message != '') {
      $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/staffs/help_desk/message")); ?>',
            data: 'message='+message+'&_token='+token+'&id='+id,
            cache: false,
            success: function(html){
              var datas = html.split('|');
...
<script type="text/javascript">
  ...
  timer = setInterval(function() {
    if ($('#form-upload #file').val() != '') {
      ...
      $.ajax({
        url: '<?php echo e(url("/staffs/help_desk/uploadchat/")); ?>',
        type: 'post',
...
<div class="modal fade" id="modal-add-kpa">
          <div class="modal-dialog kpa_add">
            <div class="modal-content">
              ...
              <form id="kpa_form" method="POST" action="<?php echo e(url('/staffs/kpa/save')); ?>" class="form-horizontal" enctype="multipart/form-data">
              <div class="modal-body">
...
<script type="text/javascript">
  ...
  if (id != '') {
     $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/staffs/kpa/delete")); ?>',
            data: 'id='+id+'&_token='+token,
            cache: false,
            success: function(html){
              var datas = html.split('|');
...
<script type="text/javascript">
  function editKra(id) {
    ...
    $('#kpa_edit_form').attr('action', '<?php echo e(url("/staffs/kra/update")); ?>');
   ...
   function editKPa(id) {
    ...
    $('#kpa_edit_form').attr('action', '<?php echo e(url("/staffs/kpa/update")); ?>');
    $('#modal-edit-kpa').modal('show');
  }
</script>
 <script type="text/javascript">
    ...
    var url= "<?php echo e(url('/staffs/performance/delete/')); ?>/"+id;
    location = url;
...
<script>
  $('select#filter_productivity_month').change(function(){
    ...
    var staff_id = '<?php echo e($datas["staff_id"]); ?>'
    var url = '<?php echo e(url("/staffs/report?staff=")); ?>'+staff_id+'&tab=productivity&filter_productivity_month='+filter_productivity_month+'&filter_productivity_year='+filter_productivity_year;
    location = url;
  });
  ...
  $('#exportProductivityBtn').click(function(){
    ...
    var filter_productivity_month = $('#filter_productivity_month').val();
    var staff_id = '<?php echo e($datas["staff_id"]); ?>'
    var url = '<?php echo e(url("/staffs/otstaff/reports/export")); ?>'+'/'+staff_id+'?tab=productivity&filter_productivity_month='+filter_productivity_month+'&filter_productivity_year='+filter_productivity_year;
    location = url;
  })
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body" id="contract-body">
          <form action="<?php echo e(url('/staffs/otstaff/contract/'.$datas['staff_id'])); ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body" id="contract-body">
          <form action="<?php echo e(url('/staffs/otstaff/contract/'.$datas['staff_id'].'/update')); ?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
...
<script>
  ...
  $('#terminationSubmit').click(function(){
    ...
    $.ajax({
      type: 'POST',
      url: '<?php echo e(url("/staffs/ajaxStaffTermination")); ?>',
      data: {
        _token : token,
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body" id="contract-body">
          <form action="<?php echo e(url('/staffs/saveServiceHistory')); ?>" method="post">
            <?php echo csrf_field(); ?>
