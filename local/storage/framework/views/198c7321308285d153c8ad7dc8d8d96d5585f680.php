...
<body class="hold-transition skin-blue sidebar-mini ">
  ...
  <div class="wrapper">
    <header class="main-header">
      <!-- Logo -->
      <a href="<?php echo e(url('/supervisor')); ?>" class="logo">
      ...
      <nav class="navbar navbar-static-top" role="navigation">
        ...
        <div class="navbar-custom-menu">
          <ul class="navbar-nav ml-auto">
            ...
            <?php ($contract = 0); ?>
            <?php endif; ?>
            <!-- <?php ($probation = \App\ProbationEvaluation::countStaffProbation()); ?> -->
              ...
              <ul class="dropdown-menu">
                ...
                <li>
                  ...
                  <ul class="menu">
                    ...
                    <li>
                      <a href="<?php echo e(url('supervisor/travel/request/waitingApproval')); ?>">
                    ...
                    <li>
                      <a href="<?php echo e(url('supervisor/travel_expense')); ?>">
                    ...
                    <!-- <li>
                      <a href="<?php echo e(url('/supervisor/probation_evaluation')); ?>">
                        <i class="fa fa-file-o text-red"></i> Evaluate Probation<span class="pull-right-container">
                          <small class="label pull-right bg-purple"><?php echo e($probation); ?></small>
                      </a>
                    </li> -->
                    <li>
            ...
            <div class="box box-success">
              ...
              <div class="box-body" style="height: 95px; overflow-y: auto;">
                <ul class="nav nav-stacked">
                  ...
                  <li><a href="<?php echo e(url('/supervisor/documents/view/'.$doc->id)); ?>" target="_blank"><?php echo e($doc->title); ?></a></li>
                  <?php endforeach; ?>
                </ul>
              </div>
            </div>
    ...
    <div class="modal fade" id="modal-sub-rating">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form id="kpi-rating-form" method="POST" action="<?php echo e(url('/supervisor/subrating')); ?>" class="form-horizontal"
  ...
  <div class="modal fade" id="modal-kpi-rating">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form id="kpi-rating-form" method="POST" action="<?php echo e(url('/supervisor/kpirating')); ?>" class="form-horizontal"
          enctype="multipart/form-data">
          <div class="modal-body">
            <?php echo csrf_field(); ?>
  ...
  <div class="modal fade" id="modal-other-rating">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="kpi-rating-form" method="POST" action="<?php echo e(url('/supervisor/otherrating')); ?>" class="form-horizontal"
          enctype="multipart/form-data">
          <div class="modal-body">
            <?php echo csrf_field(); ?>
  ...
  <div class="modal fade" id="modal-voting">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form method="POST" action="<?php echo e(url('/supervisor/vote/save')); ?>" class="form-horizontal"
          enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
  ...
  <script type="text/javascript">
    function loadlink(){
        $('.main-sidebar').load('<?php echo e(url("/supervisor/left_bar")); ?>',function () {
             $(this).unwrap();
        });
    }
      ...
      if(sup_check == '0')
        ...
        } else if(ocheck > 0 & other_rater > 0 & checko == 0)
        {
          ...
          var token = $('input[name=\'_token\']').val();
           $.ajax({
                type: 'POST',
                url: '<?php echo e(url("/supervisor/staff-survey/get-popup")); ?>',
    ...
    $('#kpi-staff').on('change', function(){
      ...
      $.ajax({
          type: 'POST',
          url: '<?php echo e(url("/supervisor/clientdetail/get-kpi")); ?>',
  ...
  <script>
    var token = $("input[name=\"_token\"]").val();
        ...
        function getReminder(){
          $.ajax({
            type: "GET",
            url: "<?php echo e(route('supervisor.getReminder')); ?>",
            data: {
              _token : token,
            },
            cache: false,
      ...
      function closeReminder(note_id)
      {
        $.ajax({
            type: "POST",
            url: "<?php echo e(route('supervisor.updateReminder')); ?>",
            data: {
              _token : token,
              note_id : note_id
            },
          ...
          <div class="model-body">
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                <form method="POST" action="<?php echo e(route('supervisor.diary.save')); ?>" class="form-horizontal" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
  ...
  <div class="modal fade" id="modal-subordinate-performance-rating">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="subordinate-performance-rating-form" method="POST" action="<?php echo e(url('supervisor/performance/save')); ?>" class="form-horizontal" enctype="multipart/form-data">
          <div class="modal-body">
            <?php echo csrf_field(); ?>

            <?php ($staffs = \App\Adjustment_staff::getPerfomanceSubordinate()); ?>
              <div class="form-group">
                <label class="col-md-12 required">Select Staff</label>
                <div class="col-md-12">
  ...
  $(document).ready(function(){
    ...
    $('#cancelPerformanceAll').click(function(){
      ...
      $.ajax({
        url: "<?php echo e(url('/supervisor/performance/cancelAll')); ?>",
        type: 'POST',
        data:{
            _token: CSRF_TOKEN,
        },
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php if($questions): ?>
        <form action=" <?php echo e(route('supervisor.survey.saveAction',$survey)); ?>" method="post" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
...
<script>
  $(document).ready(function($) {
    ...
    $(document).on('change', 'select', function () {
        ...
        if(extraValue == value){
            $.ajax({
                url: "<?php echo e(url('/supervisor/survey/getChildquestion')); ?>",
                type: 'POST',
                data:{
                    _token: CSRF_TOKEN,
          ...
          <div class="col-md-10 col-md-offset-1">
            <table class="table table-bordered">
              ...
              <tr>
                ...
                <td>
                  <a href="<?php echo e(url('supervisor/report?staff='.$contract->staff_id).'&tab=contract'); ?>" class="btn btn-info">Report</a>
                </td>
              </tr>
              <?php endforeach; ?>
            </table>
...
<script>
    $('#autocompleteStaffSearch').autocomplete({
        source: '<?php echo e(url("supervisor/getStaffList/")); ?>',
        minlength:1,
        autoFocus:true,
