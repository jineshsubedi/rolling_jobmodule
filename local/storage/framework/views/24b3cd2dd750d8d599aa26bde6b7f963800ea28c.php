 ...
 <div class="row">
    <div class="col-xs-12">
      ...
      <div class="top-links btn-group">
        <a href="<?php echo e(url('/branchadmin/jobs/application/'.$datas['job_id'])); ?>" class="btn btn-default">All Applicant (<?php echo e(\App\Employees::countAllApplicant($datas['job_id'])); ?>)</a>
        <a href="<?php echo e(url('/branchadmin/jobs/verification/'.$datas['job_id'])); ?>" class="btn btn-success">Document Verification (<?php echo e(\App\Employees::countDocumentVerification($datas['job_id'])); ?>)</a>
        ...
        <a href="<?php echo e(url('/branchadmin/jobs/selected/'.$datas['job_id'])); ?>" class="btn btn-default">Selected Candidates (<?php echo e(\App\Employees::countSelected($datas['job_id'])); ?>)</a>
                ...
                <input type="hidden" name="job_id" value="<?php echo e($datas['job_id']); ?>">
                  <table class="table table-bordered table-hover">
                    ...
                    <tfoot>
                      ...
                      <tr>
                        <td colspan="8"><button type="button" id="for-written" onClick="confirm_update()" class="btn btn-black">Select for Written Exam</button>
