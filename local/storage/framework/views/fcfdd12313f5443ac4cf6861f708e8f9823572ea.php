...
<?php $__env->startSection('breadcrubm'); ?>
 <li><a href="<?php echo e(url('/branchadmin')); ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
            <li><a href="<?php echo e(url('/branchadmin/otstaff')); ?>">Organization Branch</a></li>
        ...
        <div class="box">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" id="testform" method="POST" action="<?php echo e(url('/branchadmin/otstaff/salary/save')); ?>">
                        <?php echo csrf_field(); ?>
