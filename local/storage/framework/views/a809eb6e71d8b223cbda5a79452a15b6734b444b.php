    ...
    <div class="box">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form method="POST" action="<?php echo e(url('/supervisor/adjustment_staff/save')); ?>" class="form-horizontal" enctype="multipart/form-data">
                     <?php echo csrf_field(); ?>
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group <?php echo e($errors->has('joindate') ? ' has-error' : ''); ?>">
                                        ...
                                        <div class="col-md-3">
                                                ...
                                                <input class="form-control" name="joindate" onblur="getDate()" placeholder="2018-01-25" id="join_date" value="<?php echo e(old('joindate')); ?>" type="text">
