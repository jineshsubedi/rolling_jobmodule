    ...
    <div class="box">
        <div class="box-header with-border">
            <ul class="nav nav-tabs">
              <li class="nav-item">
                <a class="nav-link active" href="<?php echo e(route('supervisor.travel.index')); ?>">Travel Request</a>
              </li>
      ...
      <div class="box-body">
        <table class="table table-borderd">
            <tr>
                ...
                <th>Place</th>
                <th>Client</th>
                <th>Request Expense</th>
                <th>Action</th>
            </tr>
            <?php if(isset($waiting_sapproval)): ?>
            <?php foreach($waiting_sapproval as $k=>$travel): ?>
            <tr>
                <td><?php echo e(\App\Adjustment_staff::getName($travel->staff_id)); ?></td>
            ...
            <tr>
                ...
                <td>
                    <a href="<?php echo e(route('supervisor.travel.show', $travel->id)); ?>" class="btn btn-info" target="_blank"><i class="fa fa-eye"></i></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('supervisor.travel.supervisorApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="approveAccountModel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('supervisor.travel.accountApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="approveHrModel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('supervisor.travel.hrApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="approveChairmanModel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" action="<?php echo e(route('supervisor.travel.chairmanApproval')); ?>" role="form" id="testform" method="POST">
                    <?php echo csrf_field(); ?>
