...
<?php $__env->startSection('content'); ?>
 ...
 <div class="row">
    <div class="col-xs-12">
      <div class="row">
          <a href="<?php echo e(route('branchadmin.dropbox.create')); ?>" class="btn btn-primary right"><i class="fa fa-fw fa-plus"></i>Add New Document to File</a>
                        ...
                        <td><?php echo $i++ ;?></td>
                              <td>
                                  <?php if($row['.tag'] == 'folder'): ?>
                                      <a href='<?php echo e(url('filemanager'.$row['path_lower'])); ?>'><i class="fa fa-folder"></i> <?php echo e($row['name']); ?></a><br>
                                  <?php else: ?>
                                      <?php echo e($row['name']); ?>
