...
<span class="hidden-xs">Dashboard
<span class="blueclr">Detail of <span class="bold"> <?php echo e($data['user']->name); ?></span></span></span>
...
<?php echo csrf_field(); ?>
  ...
  <div class="row cm10-row">
    <div class="col-md-5 col-sm-12">
      <div class="box box-primary mb10m">
            ...
            <div class="col-md-12">
              ...
              <script>
                $(document).ready(function(){
                  ...
                  $.ajax({
                    type: "GET",
                    url: "<?php echo e(route('branchadmin.checkReminderForSticky')); ?>",
                    data: {
                      _token : token,
...
<div class="tp10m comnbg">
  <div class="title_bg">HR Metrics <i class="fa fa-tv greenclr"></i></div>
  <div class="row cm10-row">
    <div class="col-lg-12 col-xs-6">
      <div style="display: flex; overflow-x: scroll; flex-wrap: nowrap;">
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <div class="tp5p">
            <h3 class="common_title">Turnover Rate </h3>
            <div class="circle_rate green_one"><?php echo e(\App\Adjustment_staff::turnoverRate()); ?>%</div>
          </div>
        </div>
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <div class="tp5p">
            <h3 class="common_title">Average Tenure</h3>
            <div class="circle_rate green_two"><?php echo e(\App\Adjustment_staff::averageTenure()); ?> Months</div>
          </div>
        </div>
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <div class="tp5p">
            <h3 class="common_title">Job Satisfaction</h3>
            <div class="circle_rate green_three"><?php echo e(\App\Adjustment_staff::jobSatisfaction()); ?>%</div>
          </div>
        </div>
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <div class="tp5p">
            <h3 class="common_title">Employee NPS</h3>
            <div class="circle_rate blue_one"><?php echo e(\App\Adjustment_staff::employeeNPS()); ?>%</div>
          </div>
        </div>
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <!-- small box -->
          <div class="tp5p">
            <h3 class="common_title">OT Percentage</h3>
            <div class="circle_rate blue_two"><?php echo e(\App\Adjustment_staff::otPercentage()); ?>%</div>
          </div>
        </div>
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <!-- small box -->
          <div class="tp5p">
            <h3 class="common_title">HR to Employee Ratio</h3>
            <div class="circle_rate blue_three"><?php echo e(\App\Adjustment_staff::hrEmployeeRatio()); ?></div>
          </div>
        </div>
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <div class="tp5p">
            <h3 class="common_title">Hire Fail Rate</h3>
            <div class="circle_rate blue_one"><?php echo e(\App\Adjustment_staff::hireFailRate()); ?>%</div>
          </div>
        </div>
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <div class="tp5p">
            <h3 class="common_title">Ghost Rate</h3>
            <div class="circle_rate blue_one"><?php echo e(\App\Adjustment_staff::ghostRate()); ?>%</div>
          </div>
        </div>
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <div class="tp5p">
            <h3 class="common_title">Abseentism</h3>
            <div class="circle_rate blue_one"><?php echo e(\App\Adjustment_staff::abseentism()); ?>%</div>
          </div>
        </div>
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <div class="tp5p">
            <h3 class="common_title">Time Sheet Match</h3>
            <div class="circle_rate blue_one"><?php echo e(\App\Adjustment_staff::timeSheet()); ?>%</div>
          </div>
        </div>
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <div class="tp5p">
            <h3 class="common_title">Time Productivity</h3>
            <div class="circle_rate blue_one"><?php echo e(\App\Adjustment_staff::productivity()); ?>%</div>
          </div>
        </div>
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <div class="tp5p">
            <h3 class="common_title">Performer Ratio</h3>
            <div class="circle_rate blue_one"><?php echo e(\App\Adjustment_staff::performer()); ?>%</div>
          </div>
        </div>
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <div class="tp5p">
            <h3 class="common_title">Stay Interview Rate</h3>
            <div class="circle_rate blue_one"><?php echo e(\App\Adjustment_staff::interviewRate()); ?>%</div>
          </div>
        </div>
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <div class="tp5p">
            <h3 class="common_title">Revenue per employee</h3>
            <div class="circle_rate blue_one"><?php echo e(\App\Adjustment_staff::revenue()); ?></div>
          </div>
        </div>
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <div class="tp5p">
            <h3 class="common_title">Cost Per Employee</h3>
            <div class="circle_rate blue_one"><?php echo e(\App\Adjustment_staff::costPerEmployee()); ?></div>
          </div>
        </div>
        <div class="col-md-2 center" style="flex: 0 0 auto; padding-bottom: 5px;">
          <div class="tp5p">
            <h3 class="common_title">Grievance Handling Rate</h3>
            <div class="circle_rate blue_one"><?php echo e(\App\Adjustment_staff::grievance()); ?>%</div>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="box-body">
              <ul class="products-list product-list-in-box">
                ...
                <?php foreach($data['onboarding'] as $onboarding): ?>
                  <li class="item">
                    <div class="product-img">
                      <img src="<?php echo e(asset($data['placeholder'])); ?>" alt="Staff Image" class="img-circle">
                    </div>
                    <div class="product-info tp7p">
          ...
          <div class="box collapsed-box collapsed">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                <button type="button" class="btn addicon" data-widget="collapse"><i class="fa fa-plus"></i></button>
              </div>
            </div>
            <div class="box-body">
       ...
       <div class="col-md-3">
          <div class="box collapsed-box collapsed">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                <button type="button" class="btn addicon" data-widget="collapse"><i class="fa fa-plus"></i>
                    </button>
              </div>
            </div>
            <div class="box-body">
        ...
        <div class="row cm10-row">
              ...
              <div class="box-header with-border bold">Working Status</div>
                <div class="listpadding">
                  <span>
                    ...
                    <a href="<?php echo e(url('branchadmin/otstaff?filter_status=1')); ?>"> Working: <span class="bold"><?php echo e($data['currently_working']); ?></span></a>
                  </span>
                </div>
                <div class="listpadding">
                  <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('branchadmin/otstaff?filter_status=2')); ?>">Resigned: <span class="bold"><?php echo e($data['resigned']); ?></span></a></span>
                </div>
                <div class="listpadding">
                  <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('branchadmin/otstaff?filter_status=3')); ?>">Absconding: <span class="bold"><?php echo e($data['absconding']); ?></span></a></span>
                </div>
                <div class="listpadding">
                  <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('branchadmin/otstaff?filter_status=4')); ?>">Terminated: <span class="bold"><?php echo e($data['terminated']); ?></span></a></span>
                </div>
            </div>
          </div>  
          <div class="col-lg-3 col-xs-6">
          ...
          <div class="col-lg-3 col-xs-6">
            <div class="common_block">
              ...
              <div class="listpadding">
                <span><icon class="fa  fa-check-square-o greenclr"></icon><a href="<?php echo e(url('branchadmin/otstaff?filter_work_mode=1')); ?>"> Full time: <span class="bold"><?php echo e($data['staff_workmode']['full_time']); ?></span></a></span>
              </div>
              <div class="listpadding">
                <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('branchadmin/otstaff?filter_work_mode=2')); ?>">Part time: <span class="bold"><?php echo e($data['staff_workmode']['part_time']); ?></span></a></span>
              </div>
              <div class="listpadding">
                <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('branchadmin/otstaff?filter_work_mode=3')); ?>">Probation: <span class="bold"><?php echo e($data['staff_workmode']['probation']); ?></span></a></span>
              </div>
              <div class="listpadding">
                <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('branchadmin/otstaff?filter_work_mode=4')); ?>">Internship: <span class="bold"><?php echo e($data['staff_workmode']['intern']); ?></span></a></span>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-xs-6">
          ...
          <div class="col-md-6 col-xs-6">
            <div class="common_block">
                ...
                <div class="listpadding">
                  <span>
                    <icon class="fa  fa-check-square-o greenclr"></icon> 
                    <a href="<?php echo e(url('/branchadmin/tasks')); ?>"> Not Accepted: <span class="bold"><?php echo e($data['notaccepted_task']); ?></span></a>
                  </span>
                </div>
                <div class="listpadding">
                  <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('/branchadmin/tasks?status=0')); ?>">In Process: <span class="bold"><?php echo e($data['inprocess_task']); ?></span></a></span>
                </div>
                <div class="listpadding">
                  <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('/branchadmin/tasks?status=2')); ?>">Deadline Crossed: <span class="bold"><?php echo e($data['crossed_task']); ?></span></a></span>
                </div>
                <div class="listpadding">
                  <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('/branchadmin/tasks?status=1')); ?>">Completed: <span class="bold"><?php echo e($data['completed_task']); ?></span></a></span>
                </div>
              </div>
          </div>
          <div class="col-md-6 col-xs-6">
            <div class="common_block">
              ...
              <div class="listpadding">
                  <span>
                    <icon class="fa  fa-check-square-o greenclr"></icon> 
                    <a href="<?php echo e(url('/branchadmin/tasks')); ?>"> Not Accepted: <span class="bold"><?php echo e($data['notaccepted_help']); ?></span></a>
                  </span>
                </div>
                <div class="listpadding">
                  <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('/branchadmin/tasks?status=0')); ?>">In Process: <span class="bold"><?php echo e($data['inprocess_help']); ?></span></a></span>
                </div>
                <div class="listpadding">
                  <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('/branchadmin/tasks?status=2')); ?>">Deadline Crossed: <span class="bold"><?php echo e($data['crossed_help']); ?></span></a></span>
                </div>
                <div class="listpadding">
                  <span><icon class="fa  fa-check-square-o greenclr"></icon> <a href="<?php echo e(url('/branchadmin/tasks?status=1')); ?>">Completed: <span class="bold"><?php echo e($data['completed_help']); ?></span></a></span>
                </div>
            </div>
          </div>
        </div>
    ...
    <div class="modal fade" id="modal-meeting">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form id="decline_form" method="POST" action="<?php echo e(url('/branchadmin/attendance/meeting')); ?>" class="form-horizontal" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<script type="text/javascript">
    ...
    if(confirm('Do You Want To Delete This data?')){
      var url= "<?php echo e(url('/branchadmin/adjustment/delete/')); ?>"+ids;
      location = url;
    ...
    if(confirm('Do You Want To Approve This Request?')){
      var url= "<?php echo e(url('/branchadmin/adjustment/approve/')); ?>"+ids;
      location = url;
    ...
    if(confirm('Do You Want To Dismiss This Request?')){
      var url= "<?php echo e(url('/branchadmin/adjustment/dismiss/')); ?>"+ids;
      location = url;
  ...
  <script type="text/javascript">
    ...
    if(confirm('Do You Want To Delete This data?')){
      var url= "<?php echo e(url('/branchadmin/otrequest/delete/')); ?>"+ids;
      location = url;
  ...
  function confirmApprove(ids){
    if(confirm('Do You Want To Approve This Request?')){
      var url= "<?php echo e(url('/branchadmin/otrequest/approve/')); ?>"+ids;
      location = url;
    ...
    if(confirm('Do You Want To Dismiss This Request?')){
      var url= "<?php echo e(url('/branchadmin/otrequest/dismiss/')); ?>"+ids;
      location = url;
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
   function viewLeave(id) {
     var token = $('input[name=\'_token\']').val();
        $.ajax({
             type: 'POST',
                url: '<?php echo e(url("/branchadmin/leaverequest/getDetail")); ?>',
   ...
   function SUApprove(id){
    ...
    if(confirm('Are you sure you want to decline this?')){
     ...
     $('#filter_date').on('change', function(){
        ...
        var url = '<?php echo e(url("/branchadmin/")); ?>';
        if(filter_date != '')
        {
 ...
 <script type="text/javascript">
    ...
    $.ajax({
    type: 'POST',
    url: '<?php echo e(url("/branchadmin/attendance/intime")); ?>',
    ...
    $.ajax({
    type: 'POST',
    url: '<?php echo e(url("/branchadmin/attendance/lunch-start")); ?>',
    data: '_token='+token+'&location='+location,
    cache: false,
    success: function(html){
    if (html == 'Success') {
    ...
    $.ajax({
    type: 'POST',
    url: '<?php echo e(url("/branchadmin/attendance/lunch-end")); ?>',
    data: '_token='+token+'&location='+location,
    cache: false,
    success: function(html){
    if (html == 'Success') {
    ...
    function submitOuttime() {
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo e(url("/branchadmin/attendance/outtime")); ?>',
        data: '_token='+token+'&location='+location,
        cache: false,
        success: function(html){
        if (html == 'Success') {
     ...
     function submitOutMeeting() {
        ...
        var location = $('#geo_location').val();
          $.ajax({
            type: 'POST',
            url: '<?php echo e(url("/branchadmin/attendance/meeting-out")); ?>',
            data: '_token='+token+'&location='+location,
            cache: false,
            success: function(html){
              if (html == 'Success') {
    ...
    function submitInMeeting(id) {
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo e(url("/branchadmin/attendance/meeting-back")); ?>',
    ...
    function addSticker() {
      var token = $('input[name=\'_token\']').val(); 
            ...
            $.ajax({
              type: 'POST',
              url: '<?php echo e(url("/branchadmin/stikynote/save")); ?>',
              data: '_token='+token+'&detail='+detail,
              cache: false,
              success: function(id){
                  location.reload();
                // var html = '<div id="mydiv_'+id+'"  class="col-md-3 stickers"><div class="box box-success box-solid"><div class="box-header with-border"><h3></h3><button type="button" class="btn crossicon addsticker" style="" onclick="addSticker()"><i class="fa fa-plus"></i></button><div class="box-tools pull-right"><button type="button" class="btn crossicon" onclick="removeSticker('+id+')"><i class="fa fa-times"></i></button></div></div>';
    ...
    function removeSticker(id) {
      if(confirm('Do You Want To Delete This Sticker Note?')){
         ...
         $.ajax({
              type: 'POST',
              url: '<?php echo e(url("/branchadmin/stikynote/delete")); ?>',
              data: '_token='+token+'&id='+id,
              cache: false,
              success: function(id){
                $('#mydiv_'+id).remove();
    ...
    function updateSticker(id) {
       var token = $('input[name=\'_token\']').val();
        ...
        var detail = $('#sticker_'+id).val();
         $.ajax({
              type: 'POST',
              url: '<?php echo e(url("/branchadmin/stikynote/update")); ?>',
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
               ...
               <form id="time-edit-form" method="POST" action="<?php echo e(url('/branchadmin/daily-routine/save')); ?>" class="form-horizontal" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
              ...
              <div class="modal-body">
                <div id="timedate" >
                  <div class="form-group">
                          ...
                          <select class="form-control" name="kra" required="required" id="daily-kra">
...
<script type="text/javascript">
  ...
  $('.time-bar').on('click', function()
  {
    ...
    var from_date = '<?php echo e(date("Y-m-d")); ?>'
     ...
     $('#time-edit-form').attr('action','<?php echo e(url("/branchadmin/daily-routine/save")); ?>');
     $('#to_time').val('');
     $('#description').val('');
...
<script type="text/javascript">
  function deleteTimeData(id,type) {
    if(confirm('Do You Want To Delete This Work Plan?')){
     ...
     $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/branchadmin/daily-routine/task-delete/")); ?>',
  ...
  $('.time-box').on('click', function(){
    ...
    if (type == 'Daily') {
     ...
     $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/branchadmin/daily-routine/edit/")); ?>',
            data: '_token='+token+'&id='+id,
            cache: false,
            success: function(html){
             if (html != '') {
              ...
              $('#time-edit-form').attr('action','<?php echo e(url("/branchadmin/daily-routine/update")); ?>');
              $('#to_time').val(datas[3]);
...
<div class="modal fade bd-example-modal-lg" id="in_time_reason_model">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body" id="attendance-body">
        <form action="<?php echo e(url('/branchadmin/attendance/intimereason')); ?>" method="post">
          <?php echo csrf_field(); ?>
...
<div class="modal fade bd-example-modal-lg" id="out_time_reason_model">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body" id="attendance-body">
        <form action="<?php echo e(url('/branchadmin/attendance/outtimereason')); ?>" method="post">
          <?php echo csrf_field(); ?>
...
<script>
  $(document).ready(function(){
    ...
    $.ajax({
        type: 'GET',
        url: '<?php echo e(route("branchadmin.getSupervisorStaffs")); ?>',
        data: '_token='+token,
        cache: false,
        success: function(data){
          var users = data.msg
...
<script>
  ...
  function getMessageAjax(id){
    $.ajax({
      type: "GET",
      url: "<?php echo e(route('branchadmin.getMessageOnDailyTask')); ?>",
  ...
  function deletemessageBtn(id)
  {
    $.ajax({
      type: "POST",
      url: "<?php echo e(route('branchadmin.deleteMessageOnDailyTask')); ?>",
      data: "_token="+token+"&task_id="+id,
      cache: false,
      success: function(data){
        console.log(data)
  ...
  function approveTask(staff_id)
  {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo e(route('branchadmin.approveSelectedDailyTask')); ?>",
      ...
      success: function(data){
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo e(route('branchadmin.checkStaffsTask')); ?>",
            data: "_token="+token+"&staff_id="+staff_id,
            cache: false,
            success: function(data){
              console.log(data.msg)
...
<script>
  $(document).ready(function(){
      ...
      $.ajax({
          type: 'GET',
          url: '<?php echo e(route("branchadmin.staffgetStaffsTask")); ?>',
          data: '_token='+token,
          cache: false,
          success: function(data){
            var users = data.msg
...
<script>
  var token = $("input[name=\"_token\"]").val();
    ...
    function staffgetMessageAjax(id){
      $.ajax({
        type: "GET",
        url: "<?php echo e(route('branchadmin.staffgetMessageOnDailyTask')); ?>",
        data: "_token="+token+"&task_id="+id,
        cache: false,
        success: function(data){
          var tasks = data.msg;
    ...
    function staffdeletemessageBtn(id)
    {
      $.ajax({
        type: "POST",
        url: "<?php echo e(route('branchadmin.staffdeleteMessageOnDailyTask')); ?>",
        data: "_token="+token+"&task_id="+id,
        cache: false,
        success: function(data){
          console.log(data)
...
<?php /*  sticky note reminder   */ ?>
  ...
  <script>
    ...
    function saveReminder()
    {
      $.ajax({
        type: "POST",
        url: "<?php echo e(route('branchadmin.saveReminder')); ?>",
        data: {
          _token : token,
          note_id : $('#note_id').val(),
    ...
    function stickyUpdateTitle(id)
    {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo e(route('branchadmin.saveStickyTitle')); ?>",
        data: {
          _token : token,
          id : id,
  ...
  <div class="modal fade bd-example-modal-lg" id="in_away_location_model">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body" id="attendance-body">
          <form action="<?php echo e(url('/branchadmin/attendance/clockin/away')); ?>" method="post">
            <?php echo csrf_field(); ?>
  ...
  <div class="modal fade bd-example-modal-lg" id="out_away_location_model">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body" id="attendance-body">
          <form action="<?php echo e(url('/branchadmin/attendance/clockout/away')); ?>" method="post">
            <?php echo csrf_field(); ?>
  ...
  $(document).ready(function(){
    ...
    $('#task_to').on('change', function () {
      ...
      if (id != '') {
        $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/branchadmin/tasks/getKra")); ?>',
            data: '_token='+token+'&id='+id,
            cache: false,
            success: function(html){
             $('#kra').html(html);
    ...
    $('#task_form').click(function(){
      $.ajax({
        type: 'POST',
          url: '<?php echo e(url("branchadmin/dashboard/tasks/savetask")); ?>',
          data: {
            _token : token,
            task_to : $('#task_to').val(),
            kra : $('#kra').val(),
    ...
    <div class="modal-content">
      ...
      <div class="model-body">
        <div class="row">
          ...
          <form action="<?php echo e(url('/branchadmin/probation_evaluation/'.$staff->id.'/reply')); ?>" method="post">
          <?php echo csrf_field(); ?>
...
<?php
$newsfeed = \App\NewsFeed::where('to_staff', $nstaff->id)->latest()->first();

$comment = \App\NewsFeedComment::where('newsfeed_id', isset($newsfeed->id) ? $newsfeed->id : 0)->where('staff_id', auth()->guard('staffs')->user()->id)->first();
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body" id="welcome-staff-body">
          <form action="<?php echo e(url('/branchadmin/newstaff/welcome/comment')); ?>" method="post">
            <?php echo csrf_field(); ?>
            ...
            <input type="hidden" name="newsfeed" id="newstaff_newsfeed<?php echo e($nstaff->id); ?>" value="<?php echo e(isset($newsfeed->id)? $newsfeed->id : 0); ?>">
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <a href="javascript:void(0)" class="btn btn-warning right" onclick="cancelGreeting(<?php echo e(isset($newsfeed->id)? $newsfeed->id : 0); ?>)">Cancel</a>
            </div>
          </form>
        </div>
        <div class="modal-footer">
...
<script>
  ...
  function cancelGreeting(id)
  {
    ...
    var url = "<?php echo e(url('branchadmin/newsfeed')); ?>"+'/'+id;
...
<script>
  function submitGreeting(id)
  {
    ...
    $.ajax({
         type: 'POST',
            url: '<?php echo e(url("/branchadmin/newstaff/welcome/comment")); ?>',
            data: {
              _token: token,
