            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p>
                        ...
                        <img src="{{asset('/image/api/drive/1.png')}}" alt="1"  width="70%"><br>
                        <h4> Select Google Drive in App Library:<br></h4>
                        <img src="{{asset('/image/api/drive/2.png')}}" alt="2" width="70%"><br>
                        <h4>Create a project:<br></h4>
                        <img src="{{asset('/image/api/drive/3.png')}}" alt="3" width="60%"><br>
                        <img src="{{asset('/image/api/drive/4.png')}}" alt="4" width="60%"><br>
                        <h4>In the left menu (“API and Services”), click on “OAuth consent screen“.<br></h4>
                        <img src="{{asset('/image/api/drive/5.png')}}" alt="5" width="70%"><br>
                        ...
                        <img src="{{asset('/image/api/drive/9.png')}}" alt="9" width="70%"><br>
                    </p>
                </div>
            </div>
        </div>
