                        ...
                        <div class="row">
                         ...
                         <div class="col-md-10">
                            <div class="form-group{{ $errors->has('refresh_token') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="refresh_token" value="{{ old('refresh_token') }}">
                        ...
                        <div class="row">
                         <div class="col-md-10">
                            <div class="form-group{{ $errors->has('drive_folder_id') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" name="drive_folder_id" value="{{ old('drive_folder_id') }}">
