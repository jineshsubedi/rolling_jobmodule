...
@section('content')
 <div class="row">
    <div class="col-xs-12">
      <div class="row">
        <a href="{{ route('branchadmin.job_level.create') }}" class="btn btn-primary right"><i class="fa fa-fw fa-plus"></i>Add New Job Level</a>
      </div>
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php $i=1; 
                        ...
                        <td>
                          <form action="{{route('branchadmin.job_level.destroy', $row->id)}}" method="post">
                              {!! csrf_field() !!}
                              {!! method_field('DELETE') !!}
                              <a href="{{ url('/branchadmin/job_level/'.$row->id.'/edit/') }}" class="btn btn-primary left"><i class="fa fa-edit"></i></a>
