 ...
 <div class="row">
    <div class="col-xs-12">
      ...
      <div class="top-links btn-group">
        ...
        <a href="{{ url('/branchadmin/jobs/selected/'.$datas['job_id']) }}" class="btn btn-success">Selected Candidates ({{\App\Employee::countSelected($datas['job_id'])}})</a>
    ...
    <div class="row">
      ...
      <div class="box box-info collapsed-box">
            ...
            <div class="box-body no-padding">
                ...
                <div class="row">
              <form class="form-horizontal" method="POST" accept-charset="UTF-8" enctype="multipart/form-data" action="{{ url('/branchadmin/jobs/upload_selected') }}">
...
{{-- @endif --}}
  ...
  function filter(){
   ...
   var filter_symbol_no = $('#filter_symbol_no').val();
    ...
    var url= "{{ url('/branchadmin/jobs/selected/'.$datas['job_id'].'?') }}";
   if (filter_name != '') {
...
function confirm_delete(ids){
    if(confirm('Do You Want To Delete This Employee?')){
      var url= "{{ url('/branchadmin/jobs/selected/delete/') }}"+ids;
      location = url;
