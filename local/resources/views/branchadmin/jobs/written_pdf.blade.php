...
<p style="clear: both;"></p>
  <table style="border-collapse: collapse; border: 1px solid #036cd9; width: 100%; margin-bottom: 20px; position: relative;">
    ...
    <tbody>
                         ...
                         <tr>
                          <td style="font-size: 12px; font-weight: 700; border-right: 1px solid #036cd9; text-align: left; padding: 7px; width: 25%;">Symbol Number</td>
                          <td style="font-size: 12px; border-right: 1px solid #036cd9; text-align: left; padding: 7px;">{{$datas['employee']->symbol_no}}</td>
