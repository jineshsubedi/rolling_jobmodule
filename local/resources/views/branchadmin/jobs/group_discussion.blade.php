 ...
 <div class="row">
    <div class="col-xs-12">
      ...
      <div class="top-links btn-group">
        ...
        <a href="{{ url('/branchadmin/jobs/discussion/'.$datas['job_id']) }}" class="btn btn-success">Group Discussion ({{\App\Employee::countGroup($datas['job_id'])}})</a>
    ...
    <div class="row">
      ...
      <div class="box box-info collapsed-box">
            ...
            <div class="box-body no-padding">
                ...
                <div class="row">
              <form class="form-horizontal" method="POST" accept-charset="UTF-8" enctype="multipart/form-data" action="{{ url('/branchadmin/jobs/upload_discussion') }}">
...
{{-- @endif --}}
                    ...
                    <tbody>
                      ...
                      <?php $i=1; 
                       ...
                       <td>{{$row->tracking_code}}</td>
                        ...
                        <td> <a href="{{url('branchadmin/jobs/application/view/'.$row->id)}}" target="_blank" class="btn btn-primary">View</a>
 ...
 function confirm_delete(ids){
  ...
  if(confirm('Are you sure you want to Shortlisted selected applicants for Written Exam?')){
      var action = '{{ url('/branchadmin/jobs/update_discussion') }}';
  ...
  function filter(){
   ...
   var filter_symbol_no = $('#filter_symbol_no').val();
    ...
    var url= "{{ url('/emoployer/jobs/discussion/'.$datas['job_id'].'?') }}";
   if (filter_name != '') {
