 ...
 <div class="row">
    <div class="col-xs-12">
      ...
      <div class="top-links btn-group">
        <a href="{{ url('/branchadmin/jobs/application/'.$datas['job_id']) }}" class="btn btn-default">All Applicant ({{\App\Employee::countAllApplicant($datas['job_id'])}})</a>
        <a href="{{ url('/branchadmin/jobs/verification/'.$datas['job_id']) }}" class="btn btn-success">Document Verification ({{\App\Employee::countDocumentVerification($datas['job_id'])}})</a>
    ...
    <div class="row">
      ...
      <div class="box box-info collapsed-box">
            ...
            <div class="box-body no-padding">
                ...
                <div class="row">
              <form class="form-horizontal" method="POST" accept-charset="UTF-8" enctype="multipart/form-data" action="{{ url('/branchadmin/jobs/upload_verification') }}">
...
{{-- @endif --}}
        ...
        <form class="form-horizontal" role="form" id="testform_verification" method="POST" action="{{ url('/branchadmin/jobs/update_verification') }}">
                {!! csrf_field() !!}
                    ...
                    <tbody>
                      ...
                      <?php $i=1; 
                       ...
                       <td>{{$row->tracking_code}}</td>
                         <td>
                         <a href="{{url('branchadmin/jobs/verification/view/'.$row->id)}}" target="_blank">
            ...
            <li><a href="{{url('branchadmin/jobs/tab1/'.$datas['job_id'].'/callmeeting/'.$row->id)}}" class="btn btn-default btn-xs" title="Create Zoom Meeting"><i class="fa fa-file"></i>Create Meeting</a></li>

        <li><a href="{{url('branchadmin/jobs/verification/view/'.$row->id)}}" class="btn btn-default btn-xs" title="view"><i class="fa fa-eye"></i>View</a></li>
 ...
 function confirm_delete(ids){
    if(confirm('Do You Want To Delete This Employee?')){
      var url= "{{ url('/branchadmin/jobs/verification/delete/') }}"+ids;
      location = url;
  ...
  if(confirm('Are you sure you want to Shortlisted selected applicants for Written Exam?')){
      var action = '{{ url('/branchadmin/jobs/update_verification') }}';
      $('#testform_verification').attr('action', action);
      $('#testform_verification').submit();
  }
};
...
function filter(){
   ...
   var filter_id = $('#filter_id').val();
    ...
    var url= "{{ url('/branchadmin/jobs/verification/'.$datas['job_id'].'?') }}";
   if (filter_name != '') {
