 ...
 <div class="row">
    <div class="col-xs-12">
      ...
      <div class="top-links btn-group">
         <form class="form-horizontal" role="form" id="testform" method="POST" action="{{ url('/branchadmin/jobs/update_verification') }}" style="display: none;">
                {!! csrf_field() !!}
                            ...
                            <tbody>
                              <tr>
                                ...
                                <tr>
                                 ...
                                 @if($datas['employee']->citizenship != '')
                                <tr>
                                    <td><b> Citizenship</b></td>
                                    <td>{{$datas['employee']->citizenship}}</td>
                                </tr>
                                @endif
                               ...
                               @if($datas['employee']->home_phone != '')
                                  ...
                                  @endif
                                     @if($datas['employee']->edu_marks != '')
                                <tr>
                                    <td><b> Education Marks</b></td>
                                    <td>{{$datas['employee']->edu_marks}}</td>
                                </tr>
                                @endif
                                 @if($datas['employee']->exp_marks != '')
                                <tr>
                                    <td><b> Experience Marks</b></td>
                                    <td>{{$datas['employee']->exp_marks}}</td>
                                </tr>
                                @endif
                                  ...
                                  @foreach($datas['form_data'] as $formdata)
                                    ...
                                    @else
                                    <td class="medit" id="opv_{{$formdata->id}}"> <?php echo $formdata->f_description ?> <a href="javascript:void(0)" class="btn btn-primary right" onclick="editMarks('{{$formdata->id}}', '{{$formdata->marks}}', '{{$formdata->f_description}}')"><i class="fa fa-edit"></i></a><span class="right">Marks: {{$formdata->marks}} </span> </td> 
                                    @endif
                                     @if($formdata->extra_lable !='')
                                   <tr>
                                    <td><b>{{$formdata->extra_lable}}</b></td>
                                    <td>{{$formdata->extra_answer}}</td>
                                  ...
                                  @endforeach
                                  @endif
                                   @if($datas['employee']->total_marks != '')
                                <tr>
                                    <td><b> Total Marks</b></td>
                                    <td id="tmarks">{{$datas['employee']->total_marks}}</td>
                                </tr>
                                @endif
                            </tbody>
                          </table>
                           ...
                           <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                              ...
                              @foreach($datas['experience'] as $experience)
                                ...
                                <tr><td colspan="10">{{$experience->duties}}</td></tr>
                              @endforeach
