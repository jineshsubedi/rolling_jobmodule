 ...
 <div class="row">
    <div class="col-xs-12">
      ...
      <div class="top-links btn-group">
        ...
        <a href="{{ url('/admin/jobs/selected/makepdf/'.$datas['employee']->id) }}" class="btn btn-default btn-xs"><i class="fa fa-file-pdf-o"></i>PDF</a>
        <a href="{{ url('/admin/jobs/selected/printprofile/'.$datas['employee']->id) }}" target="_blank" class="btn btn-default btn-xs"><i class="fa fa-print"></i>Print</a>
