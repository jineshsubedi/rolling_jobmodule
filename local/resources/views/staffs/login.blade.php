        ...
        <div class="row cm10-row">
            <div class="col-md-12 col-lg-4">
                <div class="common_div loginform">
                    ...
                    <form class="tp20m" method="POST" action="{{ url('/staffs/login') }}">
                        {!! csrf_field() !!}
            ...
            <div class="col-md-12 col-lg-7 offset-lg-1 right-side">
                <div class="row ">
                    <div class="col-6 col-md-6 col-lg-3 ">
                        <div class="box1">
                            <div class="box-inner">
                                <img src="{{asset('image/login/icon1.png')}}" class="img-fluid">
                                <div class="des">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 ">
                        <div class="box2">
                            <div class="box-inner">
                                <img src="{{asset('image/login/icon2.png')}}" class="img-fluid">
                                <div class="des">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 ">
                        <div class="box3">
                            <div class="box-inner">
                                <img src="{{asset('image/login/icon3.png')}}" class="img-fluid">
                                <div class="des">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 ">
                        <div class="box4">
                            <div class="box-inner">
                                <img src="{{asset('image/login/icon4.png')}}" class="img-fluid">
                                <div class="des">
                                    Leave Management
                                </div>
                            </div>
                ...
                <div class="row mt-5">
                    <div class="col-6 col-md-6 col-lg-3 ">
                        <div class="box1">
                            <div class="box-inner">
                                <img src="{{asset('image/login/icon5.png')}}" class="img-fluid">
                                <div class="des">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 ">
                        <div class="box2">
                            <div class="box-inner">
                                <img src="{{asset('image/login/icon6.png')}}" class="img-fluid">
                                <div class="des">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 ">
                        <div class="box3">
                            <div class="box-inner">
                                <img src="{{asset('image/login/icon7.png')}}" class="img-fluid">
                                <div class="des">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 ">
                        <div class="box4">
                            <div class="box-inner">
                                <img src="{{asset('image/login/icon8.png')}}" class="img-fluid">
                                <div class="des">
                                    Payroll Management
                                </div>
                            </div>
                ...
                <div class="row mt-5">
                    <div class="col-6 col-md-6 col-lg-3 ">
                        <div class="box1">
                            <div class="box-inner">
                                <img src="{{asset('image/login/icon9.png')}}" class="img-fluid">
                                <div class="des">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 ">
                        <div class="box2">
                            <div class="box-inner">
                                <img src="{{asset('image/login/icon10.png')}}" class="img-fluid">
                                <div class="des">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 ">
                        <div class="box3">
                            <div class="box-inner">
                                <img src="{{asset('image/login/icon11.png')}}" class="img-fluid">
                                <div class="des">
                    ...
                    <div class="col-6 col-md-6 col-lg-3 ">
                        <div class="box4">
                            <div class="box-inner">
                                <img src="{{asset('image/login/icon12.png')}}" class="img-fluid">
                                <div class="des">
                                    Surveys & Polls
                                </div>
                            </div>
