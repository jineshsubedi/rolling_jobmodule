            ...
            s = function(t) {
                ...
                return i.__extends(e, t), e.prototype.updateDayTable = function() {
                    ...
                    var n = this,
                        ...
                        o = n.getDayClasses(t);
                    return o.unshift("fc-day", i.calendar.theme.getClass("widgetContent")), '<td onclick="addDayData($(this))" class="' + o.join(" ") + '"' + (r ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") + (e ? " " + e : "") + "></td>"
        ...
        var l = n(2),
            ...
            c = function(t) {
                ...
                return l.__extends(e, t), e.prototype.renderFgSegs = function(t) {
                    ...
                    return '<a  class="' + f.join(" ") + '"' + (d.url ? ' href="' + u.htmlEscape(d.url) + '"' : "") + (g ? ' style="' + g + '"' : "") + '><button type="button" onclick="deleteData($(this))" data-start="' + u.htmlEscape(r) + '" data-title="' + u.htmlEscape(d.title) + '" class="close close-button">×</button><div class="fc-content">' + (n ? '<div class="fc-time" data-start="' + u.htmlEscape(r) + '" data-full="' + u.htmlEscape(i) + '"><span>' + u.htmlEscape(n) + "</span></div>" : "") + (d.title ? '<div class="fc-title">' + u.htmlEscape(d.title) + "</div>" : "") + '</div>' + (h ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
